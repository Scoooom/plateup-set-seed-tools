var Me=Object.defineProperty;var Ne=(b,m,G)=>m in b?Me(b,m,{enumerable:!0,configurable:!0,writable:!0,value:G}):b[m]=G;var T=(b,m,G)=>Ne(b,typeof m!="symbol"?m+"":m,G);(function(){"use strict";var b=(t=>(t[t.Generic=0]="Generic",t[t.Dish=1]="Dish",t[t.PrimaryTheme=3]="PrimaryTheme",t[t.SecondaryTheme=4]="SecondaryTheme",t[t.Franchise=5]="Franchise",t[t.Special=6]="Special",t))(b||{}),m=(t=>(t[t.Base=0]="Base",t[t.Main=1]="Main",t[t.Extra=2]="Extra",t[t.Side=3]="Side",t[t.Starter=4]="Starter",t[t.Dessert=5]="Dessert",t[t.Null=6]="Null",t))(m||{}),G=`373996608,Ice Cream,1,,,,-1533430406,False,False,5,1,2\r
...
-2075899,Breakfast,1,-523839730:-1706154991,380220741:925796718,True,False,0,0,5\r
-1653221873,Stir Fry,1,2087693779:1972879238,-452101383:-1573812073:380220741:-1201769154:314862254,True,False,0,1,10\r
`;const R=G.trim().split(/\r?\n/).filter(t=>t).map(t=>{var x,O;const[e,r,s,a,n,i,l,u,c,o,F,p]=t.split(","),k=Number(e),h=Number(s),f=a!=null&&a.length?a.split(":").map(w=>Number(w)):[],d=n.length?n.split(":").map(w=>Number(w)):[],g=i!=null&&i.length?(x=i==null?void 0:i.split(":"))==null?void 0:x.map(w=>Number(w)):[],D=l!=null&&l.length?(O=l==null?void 0:l.split(":"))==null?void 0:O.map(w=>Number(w)):[],M=u==="True",y=c==="True",C=Number(o),P=Number(F),z=Number(p);return{ID:k,Name:r,UnlockGroup:h,Requires:f,BlockedBy:d,RequiredProcesses:g,IngredientProviders:D,isMain:M,isStarterOrSide:y,DishType:C,CustomerMultiplier:P,DishValue:z}});function v(t,e=!0){const r=e&&t.some(s=>s.Name==="Community"||s.Name==="Lake");return R.filter(s=>{if(t.some(a=>a.ID===s.ID)||s.BlockedBy.some(a=>t.some(n=>n.ID===a))||s.Requires.some(a=>!t.some(n=>n.ID===a)))return!1;if(s.isStarterOrSide)if(t.some(a=>a.isMain)){if(t.length&&t[0].DishType===m.Dessert)debugger}else return!1;return!(!r&&s.DishType===m.Base)}).sort((s,a)=>s.ID-a.ID)}const _=[...[{ID:447437163,Name:"Country",UnlockGroup:b.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:b.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:b.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null,CustomerMultiplier:0,DishValue:0},R.filter(t=>t.Name==="Community")[0],R.filter(t=>t.Name==="Couples")[0],{ID:1958825350,Name:"Turbo",UnlockGroup:b.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null,CustomerMultiplier:0,DishValue:0},R.filter(t=>t.Name==="Christmas Rush")[0],{ID:-1893039732,Name:"Lake",UnlockGroup:b.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:m.Null,CustomerMultiplier:0,DishValue:0}]].slice(3).sort((t,e)=>t.Name<e.Name?-1:1);["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(t=>R.filter(e=>e.Name===t)[0]);const $=X.trim().split(`\r
`).filter(t=>t).map(t=>{var y,C;const[e,r,s,a,n,i,l,u,c,o]=t.split(","),F=Number(e),p=Number(s),k=a!=null&&a.length?(y=a==null?void 0:a.split(":"))==null?void 0:y.map(P=>Number(P)):[],h=n!=null&&n.length?(C=n==null?void 0:n.split(":"))==null?void 0:C.map(P=>Number(P)):[],f=i==="True",d=l==="True",g=Number(u),D=Number(c),M=Number(o);return{ID:F,Name:r,UnlockGroup:p,Requires:[],BlockedBy:[],RequiredProcesses:k,IngredientProviders:h,isMain:f,isStarterOrSide:d,DishType:g,CustomerMultiplier:D,DishValue:M}}).sort((t,e)=>t.Name<e.Name?-1:1),I={};for(const t of R)I[t.Name]=t;for(const t of $)I[t.Name]=t;for(const t of _)I[t.Name]=t;I.Coffee=I["Black Coffee"],I.Community.AKA="Autumn",I["Christmas Rush"].AKA="North Pole",I.Couples.AKA="Romantic";class E{constructor(e,r){T(this,"fixedSeed");T(this,"instance");T(this,"random");typeof e=="string"&&(e=ee(e)),this.fixedSeed=e,this.instance=r,this.random=new A(e+Math.imul(124192293,r))}useSubcontext(e){return new E(this.fixedSeed,124192293*e+this.instance)}}class A{constructor(e){T(this,"seed");const r=l=>Math.imul(1812433253,l)+1>>0,s=e>>0,a=r(s),n=r(a),i=r(n);this.seed=[s,a,n,i]}get value(){let e=this.seed.shift(),r=this.seed[2];return e^=e<<11,e^=e>>>8,r^=r>>>19,r=(r^e)>>0,this.seed.push(r),r}range(e,r){return(this.value>>>0)%(r-e)+e}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(e){return e[this.range(0,e.length)]}}function ee(t){const r=new TextEncoder().encode(t);let s=5381,a=r.length;for(;a--;)s=(s<<5)+s+r[a];return s>>0}function j(t,e,r){return new E(r,t*1231231+e)}class q{constructor(){T(this,"encourageGroups",[b.Special])}GetOptions(e,r,s){const a=s.random;let n=0;for(r!==15&&(n=this.getPad(e,r));n--;)a.value;let i=this.sortCandidates(e,r,s.random);const[l,u]=this.getUnlockGroups(r);let c=null,o=null;for(const F of i)if(!(F.UnlockGroup!==l&&F.UnlockGroup!==u)&&(c===null||c.UnlockGroup!==l&&F.UnlockGroup===l?c=F:(o===null||o.UnlockGroup!==u&&F.UnlockGroup===u)&&(o=F),c&&c.UnlockGroup===l&&o&&o.UnlockGroup===u))break;return[c,o]}getPad(e,r){if(r===15)return 0;let s=v(e).length+1;return r===5&&(s*=2),s}getCandidates(e,r){return v(e)}sortCandidates(e,r,s){let a=this.getCandidates(e,r),n=H(a,s);return s.valueFloat<.5&&n.sort((l,u)=>{let c=0;return V(l)&&c--,V(u)&&c++,c}),n}getUnlockGroups(e){return e===15?[b.Franchise,b.Franchise]:e===5?[b.PrimaryTheme,b.PrimaryTheme]:[b.Dish,b.Generic]}}class se extends q{getPad(e,r){let s=v(e,!1).length+1;return r!==5&&(s*=2),s}sortCandidates(e,r,s){let a=this.getCandidates(e,r),n=H(a,s);return s.valueFloat<.1&&n.sort((u,c)=>{let o=0;return u.Requires.length&&o--,c.Requires.length&&o++,o}),n}}class K extends q{constructor(){super(...arguments);T(this,"ThanksgivingCards",["Turkey","Nut Roast"])}getPad(r,s){if(s===15)return 0;let a=v(r,!1).length+1;if(s===5){let n=v(r);a+=n.length+2}return a}getCandidates(r,s){return s===5||s===15?v(r,!1):v(r)}sortCandidates(r,s,a){let n=this.getCandidates(r,s),i=H(n,a);return a.valueFloat<.5&&i.sort((c,o)=>{let F=0;return V(c,!1)&&F--,V(o,!1)&&F++,F}),s!==5&&s!==15&&a.valueFloat<.25&&i.sort((o,F)=>{let p=0;return this.ThanksgivingCards.includes(o.Name)&&p++,this.ThanksgivingCards.includes(F.Name)&&p--,p}),i}getUnlockGroups(r){return r===15?[b.Franchise,b.Franchise]:r===5?[b.PrimaryTheme,b.PrimaryTheme]:[b.Dish,b.Dish]}}class re extends K{constructor(){super(...arguments);T(this,"ThanksgivingCards",["Dumplings","Mandarin Starter","Bamboo","Stir Fry"])}}function H(t,e){return t.map(s=>[s,e.valueFloat]).sort((s,a)=>s[1]-a[1]).map(s=>s[0])}class te{constructor(e){T(this,"cards");T(this,"unlockPack");T(this,"seed");this.cards=[],this.unlockPack=new q,this.seed=e}addCard(e){if(e!==void 0){switch(e.Name){case"Community":this.unlockPack=new K;break;case"Turbo":this.unlockPack=new se;break;case"Lake":this.unlockPack=new re;break}this.cards.push(e)}}getUnlockOptions(e){const s=j(848292,e,this.seed).useSubcontext(1);return this.unlockPack.GetOptions(this.cards,e,s)}getCustomers(e,r=1){return[]}getGroupSizeRange(e){if(this.cards.some(n=>n.Name==="Community")){const n=Math.floor((e-1)/3);return[n+1,n+2]}let s=1,a=2;return this.cards.some(n=>n.Name==="Individual Dining")?[1,1]:(this.cards.some(n=>n.Name==="Medium Groups")&&(s++,a+=2),this.cards.some(n=>n.Name==="Large Groups")&&(s+=2,a+=4),this.cards.some(n=>n.Name==="Flexible Groups")&&(s--,a++),[s,a])}}function V(t,e=!0){return t.UnlockGroup===b.Special||t.DishType===m.Main||t.DishType===m.Extra?!0:e?!!t.Requires.length:!1}function ae(t,e){return Math.floor(Math.random()*(e-t))+t}function Q(t,e){let r=t.length;for(;r-- >1;){let s=ae(0,r+1);[t[r],t[s]]=[t[s],t[r]]}return t}const ne="12345678",W="bdghjmqrtvwxy346789",ie="1c,1d,1e,1f,1g,1h,1i,1j,1k,1l,1m,1n,1o,1p,1q,1r,1s,1t,1u,1v,1w,1x,1y,1z,13,14,15,16,17,18,19,2c,2d,2e,2f,2g,2h,2i,2j,2k,2l,2m,2n,2o,2p,2q,2r,2s,2t,2u,2v,2w,2x,2y,2z,23,24,25,26,27,28,29,3c,3d,3e,3f,3g,3h,3i,3j,3k,3l,3m,3n,3o,3p,3q,3r,3s,3t,3u,3v,3w,3x,3y,3z,33,34,35,36,37,38,39,4c,4d,4e,4f,4g,4h,4i,4j,4k,4l,4m,4n,4o,4p,4q,4r,4s,4t,4u,4v,4w,4x,4y,4z,43,44,45,46,47,48,49,5c,5d,5e,5f,5g,5h,5i,5j,5k,5l,5m,5n,5o,5p,5q,5r,5s,5t,5u,5v,5w,5x,5y,5z,53,54,55,56,57,58,59,6c,6d,6e,6f,6g,6h,6i,6j,6k,6l,6m,6n,6o,6p,6q,6r,6s,6t,6u,6v,6w,6x,6y,6z,63,64,65,66,67,68,69,7c,7d,7e,7f,7g,7h,7i,7j,7k,7l,7m,7n,7o,7p,7q,7r,7s,7t,7u,7v,7w,7x,7y,7z,73,74,75,76,77,78,79,8c,8d,8e,8f,8g,8h,8i,8j,8k,8l,8m,8n,8o,8p,8q,8r,8s,8t,8u,8v,8w,8x,8y,8z,83,84,85,86,87,88,89".split(",");for(const t of ie);for(const t of ne);function le(){let t="";for(;t.length<8;)t+=W[Math.floor(Math.random()*W.length)];return t}function B(t){return t.length?t.reduce((e,r)=>e+r,0)/t.length:0}const L={};function U(t){const{starters:e,main:r,doubleOrderChance:s,desserts:a,sides:n,groupSizes:i}=t,l=[e,r,s,a,n,[...i].sort((h,f)=>h-f)].join("|");if(L[l])return L[l];let u=[0,0,0],c=[0,0,0,0],o=1-.75**n;if(e>0){u[0]=1;let h=1-.75**e;s===.5&&(h*=1.25,o*=1.25),c[0]=i.reduce((f,d)=>f+1+(d-1)*h,0)}const F=i.reduce((h,f)=>h+f);r&&(u[1]=1,c[1]=F),a>0&&(c[2]=F,r?(u[2]=1-.75**a,s===.5&&(u[2]*=1.25)):u[2]=1);let p=1;e>0&&(u[0]*=1+s,p*=1-s,c[0]*=u[0]),r&&(u[1]*=1+p*s,p*=1-s,c[1]*=u[1],c[3]=c[1]*o),a>0&&(u[2]*=1+p*s,p*=1-s,c[2]*=u[2]);const k=[u.map(h=>h*i.length),c];return L[l]=k,k}function oe(t){const{starters:e,main:r,doubleOrderChance:s,desserts:a,sides:n,groupSizes:i}=t;let l=[0,0,0],u=[0,0,0,0],c=1-.75**e,o=1-.75**a,F=1-.75**n;s===.5&&(c*=1.25,o*=1.25,F*=1.25);const p=d=>{l[0]++,u[0]++;for(let g=0;g<d-1;g++)Math.random()<c&&u[0]++},k=d=>{l[1]++,u[1]+=d;for(let g=0;g<d;g++)Math.random()<F&&u[3]++},h=d=>{l[2]++,u[2]+=d};for(const d of i){let g=!1;e>0&&(p(d),!g&&Math.random()<s&&(g=!0,p(d))),k(d),!g&&Math.random()<s&&(g=!0,k(d)),a>0&&Math.random()<o&&(h(d),!g&&Math.random()<s&&(g=!0,h(d)))}return[l,u]}const ue={"Diner (1)":1,"Small (2)":2,"Medium (2)":2,"Large (3)":3,"Huge (4)":4},Y={};["Morning Rush","Lunch Rush","Dinner Rush"].forEach(t=>Y[t]=!0);class ce{constructor(e,r=[],s=[]){T(this,"seed");T(this,"mapSize");T(this,"frontDoor");T(this,"startingCards");T(this,"cards");T(this,"playerCount");T(this,"turbo");T(this,"_actionInfoCacheByCards",{});T(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=r,this.cards=s,this.playerCount=ue[this.mapSize],this.turbo=this.startingCards.some(a=>{if(a===void 0){console.log({startingCards:r});debugger}return a.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const r=this.getCardsByDay(e),s=this.getGroupSizes(e);let a=!1,n=!1,i=0,l=[],u=[],c=0,o=[],F=0,p=[];for(const C of r)switch(C.Name==="All You Can Eat"&&(a=!0),C.Name==="Double Helpings"&&(n=!0),C.DishType){case m.Dessert:c++,C.DishValue&&o.push(C.DishValue);break;case m.Starter:C.DishValue&&l.push(C.DishValue),i++;break;case m.Side:C.DishValue&&p.push(C.DishValue),F++;break;case m.Main:case m.Base:C.Name==="Tacos"?(u.push(2),u.push(3)):C.DishValue&&u.push(C.DishValue)}let k=n?.5:a?.25:0,h=[0,0,0,0];if(h[0]=B(l),h[1]=B(u),h[2]=B(o),h[3]=B(p),n)for(let C=0;C<3;C++)h[C]&&(h[C]+=3);const[f,d]=U({starters:i,main:!!h[1],doubleOrderChance:k,desserts:c,sides:F,groupSizes:s});let g=0;for(let C=0;C<d.length;C++)g+=d[C]*h[C];const D=J(this.playerCount),M=this.getBookingDeskCount(e),y=this.getBookingDeskMoney(e);return Math.ceil(D*(g+M*y))}courseInfo(e){if(e===0)return[[0,0,0],[0,0,0,0]];const r=this.getCardsByDay(e),s=this.getGroupSizes(e);let a=!1,n=!1,i=0,l=[],u=[],c=0,o=[],F=0,p=[];for(const d of r)switch(d.Name==="All You Can Eat"&&(a=!0),d.Name==="Double Helpings"&&(n=!0),d.DishType){case m.Dessert:c++,d.DishValue&&o.push(d.DishValue);break;case m.Starter:d.DishValue&&l.push(d.DishValue),i++;break;case m.Side:d.DishValue&&p.push(d.DishValue),F++;break;case m.Main:case m.Base:if(!d.isMain){c++,d.DishValue&&o.push(d.DishValue);break}d.Name==="Tacos"?(u.push(2),u.push(3)):d.DishValue&&u.push(d.DishValue)}let k=n?.5:a?.25:0,h=[0,0,0,0];if(h[0]=B(l),h[1]=B(u),h[2]=B(o),h[3]=B(p),n)for(let d=0;d<3;d++)h[d]&&(h[d]+=3);return U({starters:i,main:!!h[1],doubleOrderChance:k,desserts:c,sides:F,groupSizes:s})}actionInfo(e){if(e===0)return 0;const r=this.getCardsByDay(e),s=e.toString()+":"+r.map(S=>S.Name).sort().join(","),a=this._actionInfoCacheByCards[s];if(a)return a;let n=0;const i={Breakfast:6,Dumplings:11.25,"Stir Fry":26/2,Steak:7};let l=0;for(let S=0;S<r.length;S++)if(r[S].DishType!==m.Null){const N=r[S].Name;l=i[N]??20;break}let u=-1,c=[1,1,1],o=[[],[l],[],[]],F=0;const p=this.getGroupSizes(e);let k=!1,h=!1,f=0,d=[],g=[],D=0,M=[],y=0,C=[],P=!1,z=!1;for(const S of r){switch(S.Name==="All You Can Eat"&&(k=!0),S.Name==="Double Helpings"&&(h=!0),S.Name){case"Picky Eaters":P=!0;break;case"Leisurely Eating":z=!0,F+=2;break;case"Instant Service":for(let N=0;N<3;N++)c[N]--;break;case"Ice Cream":o[2].push(5.125);break;case"Cheese Board":o[2].push(10);break;case"Cherry Pies":o[2].push(11);break;case"Apple Pies":o[2].push(15);break;case"Pumpkin Pies":o[2].push(16);break;case"Carrot Soup":case"Meat Soup":o[0].push(7);break;case"Tomato Soup":case"Pumpkin Soup":c[0]=4,o[0].push(8);break;case"Broccoli Cheese Soup":o[0].push(5),c[0]=4;break;case"Pumpkin Seed":o[0].push(3*8);break;case"Bread":o[0].push(5*3);break;case"Mandarin Starter":o[0].push(7*3);break;case"Mashed Potato":case"Broccoli":case"Bamboo":o[3].push(2);break;case"Onion Rings":o[3].push(8);break;case"Corn on the Cob":o[3].push(6);break;case"Chips":o[3].push(7);break;case"Roast Potato":o[3].push(4);break}switch(S.DishType){case m.Dessert:D++,S.DishValue&&M.push(S.DishValue);break;case m.Starter:S.DishValue&&d.push(S.DishValue),f++;break;case m.Side:S.DishValue&&C.push(S.DishValue),y++;break;case m.Main:case m.Base:S.Name==="Tacos"?(g.push(2),g.push(3)):S.DishValue&&g.push(S.DishValue);break;case m.Extra:S.Name==="Seaweed"?(o[1][0]+=1.75,u+=2):S.Name==="Dumpling - Soy Sauce"?o[1][0]+=.4:S.Name==="Breakfast Beans"?o[1][0]+=1+3/4:S.Name==="Breakfast Eggs"?o[1][0]+=6:S.Name==="Breakfast Extras"&&(u++,o[1][0]+=1.5*2),u++;break}}e>6&&(o[3]=[]),P&&(z&&!k||(o[1][0]+=2,u++));let x=h?.5:k?.25:0;n+=p.length*F;const[O,w]=U({starters:f,main:!0,doubleOrderChance:x,desserts:D,sides:y,groupSizes:p});O.forEach((S,N)=>n+=S*c[N]);for(const S of o)for(let N=0;N<S.length;N++)u>0&&(S[N]+=u),u+=1;return w.forEach((S,N)=>{var Z;if((Z=o[N])!=null&&Z.length){if(!N){const be=Math.ceil(S/o[N].length/3);n+=be*o[N].reduce((ye,Te)=>ye+Te,0);return}n+=S*B(o[N])}}),this._actionInfoCacheByCards[s]=n,n}simulateMoney(e){if(e===0)return this.turbo?30:0;const r=this.getCardsByDay(e),s=this.getGroupSizes(e);let a=!1,n=!1,i=[[],[],[],[]];for(const f of r)switch(f.Name==="All You Can Eat"&&(a=!0),f.Name==="Double Helpings"&&(n=!0),f.DishType){case m.Main:case m.Base:f.Name==="Tacos"?i[1].push(2.5):f.DishValue&&i[1].push(f.DishValue);break;case m.Dessert:f.DishValue&&i[2].push(f.DishValue);break;case m.Starter:f.DishValue&&i[0].push(f.DishValue);break;case m.Side:f.DishValue&&i[3].push(f.DishValue);break}let l=n?.5:a?.25:0,u=0;n&&(u+=3);const[c,o]=oe({starters:i[0].length,main:!!i[1].length,doubleOrderChance:l,desserts:i[2].length,sides:i[3].length,groupSizes:s});let F=0;for(let f=0;f<o.length;f++){let d=o[f];for(;d--;){f<3&&(F+=u);let g=i[f][Math.floor(Math.random()*i[f].length)];g%1&&(Math.random()<g%1?g=Math.ceil(g):g=Math.floor(g)),F+=g}}const p=J(this.playerCount),k=this.getBookingDeskCount(e),h=this.getBookingDeskMoney(e);return Math.ceil(p*(F+k*h))}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}clearCardsCache(){this._cardsByDay=[]}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let r;this.turbo?r=e-1:(r=Math.max(0,Math.floor((e-1)/3)),e>5&&r++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,r)]}return this._cardsByDay[e]}getBookingDeskCount(e,r=1){const s=Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e));if(this.getCardsByDay(e).some(c=>c.Name==="Herd Mentality"))return Math.min(s,3)+1;const a=[],n=this.getCardsByDay(e);let i=1;(this.turbo||n.some(c=>c.Name==="Morning Rush"))&&a.push(.2),(this.turbo||n.some(c=>c.Name==="Lunch Rush"))&&a.push(.5),(this.turbo||n.some(c=>c.Name==="Dinner Rush"))&&a.push(.8);const l=r/(this.playerCount||2)/this.getDayLength(e),u=.1/s;i+=s-1;for(let c=1;c<s;c++){const o=c/s,F=o-u-l,p=o+u+l;for(let k=a.length-1;k>=0;k--){const h=a[k];F<=h&&h<=p&&a.splice(k,1)}}return i+=a.length,i}getNonRushGroupCount(e){const r=this.getExpectedCustomers(e),s=this.getCardsByDay(e).filter(i=>i.Name==="Closing Time?").length*.2,a=this.getExpectedGroupSize(e),n=r*(1+s)/a;return Math.ceil(n)}getCustomerCount(e){return this.getGroupSizes(e).reduce((r,s)=>r+s,0)}getGroupSizes(e){const r=this.seed?j(1997821,e,this.seed).random:new A(Math.floor(Math.random()*4294967295)),s=this.getNonRushGroupCount(e),a=this.getCardsByDay(e).some(p=>p.Name==="Herd Mentality");let n=s,i=[],[l,u]=this.getGroupSizeRange(e);!this.seed||this.seed==="_min"?u=l:this.seed==="_max"&&(l=u);{let p=n-1;for(;p--;)r.value}for(;n--;)i.push(r.range(l,u+1)),!a&&n!==s-1&&r.value;let c=this.turbo?3:this.getCardsByDay(e).filter(p=>Y[p.Name]).length;const o=Math.ceil(Math.max(1,s*.15));let F=c*o;for(;F--;)i.push(r.range(l,u+1));if(!this.seed||this.seed[0]==="_"){let p=l;for(let k=0;k<i.length;k++)i[k]=p,p++,p>u&&(p=l)}return i}getExpectedGroupSize(e){const r=this.getGroupSizeRange(e);return(r[0]+r[1])/2}getGroupSizeRange(e){let r=1,s=2;for(const a of this.getCardsByDay(e))switch(a.Name){case"Individual Dining":s--;break;case"Medium Groups":r++,s+=2;break;case"Large Groups":r+=2,s+=2;break;case"Flexible Dining":r--,s++;break;case"Community":const n=Math.floor((e-1)/3);r+=n,s+=n;break}return[r,s]}getExpectedCustomers(e){const r=this.getReductions(e),s=this.getDayLength(e),a=this.getPlayerModifier(),n=this.getCourseModifier(e),i=this.getDayRate(e),l=this.getCustomersPerHour(e),u=this.getAdvertisingModifier(e);return .85**r*(s/25*i*a)/n*l*u}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(s=>s.Name==="Advertising").length}getDayRate(e){let r=1;switch(e){case 1:r=1.25;break;case 2:r=1.5;break;default:r=1.5+.15*(e-3);break}return e>15&&(r+=(this.turbo?.1:0)*(e-15)**1.5),r}getCourseModifier(e){let r=1;const s=this.getCardsByDay(e);return s.some(a=>a.DishType===m.Dessert||a.Name==="Black Coffee"||a.Name==="Cakes")&&(r+=.25),s.some(a=>a.DishType===m.Starter)&&(r+=.25),r}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let r=1;return this.turbo&&(r=1.5,r*=1+e/10),r}getReductions(e){return this.getCardsByDay(e).reduce((s,a)=>s+a.CustomerMultiplier,0)}getMapSize(){const r=new E(this.seed,5078598).useSubcontext(0).random.range(0,8);let s;switch(r){case 0:s="Small (2)";break;case 4:s="Medium (2)";break;case 1:case 5:s="Diner (1)";break;case 2:case 6:s="Large (3)";break;case 3:case 7:s="Huge (4)";break;default:throw new Error}return s}getLayoutInfo(){const r=new E(this.seed,5078598).useSubcontext(0).random.range(0,8);let s,a;switch(r){case 0:a=70,s=2;break;case 4:a=84,s=2;break;case 1:case 5:a=60,s=1;break;case 2:case 6:a=9*13,s=3;break;case 3:case 7:a=12*16,s=4;break;default:throw new Error}return[s,a]}getDoorInfo(){if(this.mapSize!=="Diner (1)")return-1;let e=new A(new E(this.seed,98234234).useSubcontext(0).random.value),r=23;for(;r--;)e.value;return e.range(0,4)}}function J(t){switch(t){case 1:return 1.25;case 2:return 1.1;default:return 1}}_.filter(t=>t.Name==="Community")[0],R.filter(t=>t.Name==="Salad")[0];const he=[3,5,6,9,12],de=self;de.onmessage=t=>{let{n:e,data:{allowedTables:r,startingDishes:s,mapSettings:a}}=t.data;a=a.filter(i=>i.Name!=="Turbo"),Q(a),Q(s);let n=[...s];for(;e--;){n.length||(n=[...s],a.shift());const i=a[0];if(!i)break;const l=n.pop();fe(t.data.type,i,l,r)}};function fe(t,e,r,s){let a;switch(t){case"strict":a=ge;break;case"flex":a=me;break;case"priorityModel":let n=!1;(e.Name==="Community"||e.Name==="Lake")&&(n=!0),n?a=Ce:a=ke;break;default:throw new Error}for(;;){const n=le(),i=new ce(n).getMapSize();if(!s.includes(i))continue;let l=new te(n);if(l.addCard(e),l.addCard(r),a(l,he)){Fe({seed:n,mapSize:i,startingDish:r.Name,setting:e.AKA??e.Name});return}}}function Fe(t){pe({type:"result",data:t})}function pe(t){postMessage(t)}function ge(t,e){let r=[t.cards];for(let s=0;s<e.length;s++){const a=new Set;let n=[];for(const i of r){t.cards=i;const l=t.getUnlockOptions(e[s]);if(a.add(l[0].Name),a.add(l[1].Name),a.size>2)return!1;n.push([...i,l[0]]),n.push([...i,l[1]])}r=n}return!0}function me(t,e){let r=[t.cards];const s=new Set;for(let a=0;a<e.length;a++){let n=[];for(const i of r){t.cards=i;const l=t.getUnlockOptions(e[a]);if(s.add(l[0].Name),s.add(l[1].Name),s.size>10)return!1;n.push([...i,l[0]]),n.push([...i,l[1]])}r=n}return!0}function ke(t,e){let s=[t.cards],a={};for(let n=0;n<e.length;n++){let i=[[[]],[[]]],l=[new Set,new Set],u=[new Map,new Map],c=[];for(let o=0;o<s.length;o++){const F=s[o];t.cards=F;const p=e[n],k=t.getUnlockOptions(p);if(p===5){for(const h of[0,1]){l[0].add(k[h].ID);const f=[...F,k[h]],d=f.map(g=>g.ID).sort((g,D)=>g-D).join(",");a[d]||(a[d]=!0,c.push(f))}if(l[0].size>2)return!1;continue}for(let h=0;h<=1;h++){const f=k[h],d=[...F,f],g=d.map(D=>D.ID).sort((D,M)=>D-M).join(",");if(a[g]?console.log("prevented dupe path"):(a[g]=!0,c.push(d)),u[h].set(F,f),!l[h].has(f.ID)){l[h].add(f.ID),i[h]=i[h].flatMap(D=>{let M=[];for(let y=0;y<=D.length;y++){const C=[...D];C.splice(y,0,f),M.push(C)}return M});for(let D=0;D<i[h].length;D++){const M=i[h][D];let y=!0;for(let C=0;C<=o;C++){const P=s[C],z=Se(t,p,P,M),x=u[h].get(P);if((x==null?void 0:x.ID)!==z.ID){y=!1;break}}y||(i[h].splice(D,1),D--)}if(!i[h].length)return!1}}}s=c}return!0}function Ce(t,e){let s=[t.cards];for(let a=0;a<e.length;a++){let n=[[]],i=new Set,l=new Map,u=[];for(let c=0;c<s.length;c++){const o=s[c];t.cards=o;const F=e[a],p=t.getUnlockOptions(F);l.set(o,p);for(let k=0;k<=1;k++){const h=p[k];u.push([...o,h]),!i.has(h.ID)&&(i.add(h.ID),n=n.flatMap(f=>{let d=[];for(let g=0;g<=f.length;g++){const D=[...f];D.splice(g,0,h),d.push(D)}return d}))}for(let k=0;k<n.length;k++){const h=n[k];let f=!0;for(let d=0;d<=c;d++){const g=s[d],D=De(t,F,g,h),M=l.get(g);if(!D.some(y=>y.ID===M[0].ID)||!D.some(y=>y.ID===M[1].ID)){f=!1;break}}f||(n.splice(k,1),k--)}if(!n.length)return!1}s=u}return!0}function Se(t,e,r,s){const a=t.unlockPack.getCandidates(r,e);for(const n of s)if(a.some(i=>i.ID===n.ID))return n;throw new Error("no valid options")}function De(t,e,r,s){const a=t.unlockPack.getCandidates(r,e),n=[];for(const i of s)if(a.some(l=>l.ID===i.ID)&&(n.push(i),n.length===2))return n;throw new Error("not enough valid options")}})();
