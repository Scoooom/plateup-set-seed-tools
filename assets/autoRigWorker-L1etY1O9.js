var Ls=Object.defineProperty;var $s=(ae,oe,be)=>oe in ae?Ls(ae,oe,{enumerable:!0,configurable:!0,writable:!0,value:be}):ae[oe]=be;var B=(ae,oe,be)=>$s(ae,typeof oe!="symbol"?oe+"":oe,be);(function(){"use strict";class ae{constructor(e,a){B(this,"array");B(this,"objectiveFunctions");this.array=oe(e,a),this.objectiveFunctions=a}clear(){this.array=[]}add(e){let a=this.array.length;for(;a--;){let{better:l,worse:r}=be(e,this.array[a],this.objectiveFunctions);if(r)return!1;l&&this.array.splice(a,1)}return this.array.push(e),!0}}function oe(s,e){if(!s.length)return s;const a=[...s];let l=[];l.push(a.pop());e:for(;a.length;){const r=a.pop();let n=l.length;for(;n--;){let{better:u,worse:g}=be(r,l[n],e);if(g)continue e;u&&l.splice(n,1)}l.push(r)}return l}function be(s,e,a){let l=!0,r=!0,n=0;for(;(l||r)&&n<a.length;){const u=a[n](s,e);u<0?r=!1:u>0&&(l=!1),n++}return{better:l,worse:r}}var is=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False,False,60\r
...
-2075899,Breakfast,1,-523839730:-1706154991,380220741:925796718,True,False,0,0,5\r
-1653221873,Stir Fry,1,2087693779:1972879238,-452101383:-1573812073:380220741:-1201769154:314862254,True,False,0,1,10\r
`;const Be=ys.trim().split(/\r?\n/).filter(s=>s).map(s=>{var ge,ke;const[e,a,l,r,n,u,g,F,c,h,k,m]=s.split(","),t=Number(e),o=Number(l),b=r!=null&&r.length?r.split(":").map(q=>Number(q)):[],f=n.length?n.split(":").map(q=>Number(q)):[],C=u!=null&&u.length?(ge=u==null?void 0:u.split(":"))==null?void 0:ge.map(q=>Number(q)):[],z=g!=null&&g.length?(ke=g==null?void 0:g.split(":"))==null?void 0:ke.map(q=>Number(q)):[],J=F==="True",_=c==="True",D=Number(h),G=Number(k),le=Number(m);return{ID:t,Name:a,UnlockGroup:o,Requires:b,BlockedBy:f,RequiredProcesses:C,IngredientProviders:z,isMain:J,isStarterOrSide:_,DishType:D,CustomerMultiplier:G,DishValue:le}}),Je=[...[{ID:447437163,Name:"Country",UnlockGroup:Se.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:Se.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:Se.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0},Be.filter(s=>s.Name==="Community")[0],Be.filter(s=>s.Name==="Couples")[0],{ID:1958825350,Name:"Turbo",UnlockGroup:Se.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0},Be.filter(s=>s.Name==="Christmas Rush")[0],{ID:-1893039732,Name:"Lake",UnlockGroup:Se.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0}]].slice(3).sort((s,e)=>s.Name<e.Name?-1:1);["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(s=>Be.filter(e=>e.Name===s)[0]);const Ds=Ps.trim().split(`\r
`).filter(s=>s).map(s=>{var _,D;const[e,a,l,r,n,u,g,F,c,h]=s.split(","),k=Number(e),m=Number(l),t=r!=null&&r.length?(_=r==null?void 0:r.split(":"))==null?void 0:_.map(G=>Number(G)):[],o=n!=null&&n.length?(D=n==null?void 0:n.split(":"))==null?void 0:D.map(G=>Number(G)):[],b=u==="True",f=g==="True",C=Number(F),z=Number(c),J=Number(h);return{ID:k,Name:a,UnlockGroup:m,Requires:[],BlockedBy:[],RequiredProcesses:t,IngredientProviders:o,isMain:b,isStarterOrSide:f,DishType:C,CustomerMultiplier:z,DishValue:J}}).sort((s,e)=>s.Name<e.Name?-1:1),X={};for(const s of Be)X[s.Name]=s;for(const s of Ds)X[s.Name]=s;for(const s of Je)X[s.Name]=s;X.Coffee=X["Black Coffee"],X.Community.AKA="Autumn",X["Christmas Rush"].AKA="North Pole",X.Couples.AKA="Romantic",X["Cherry Pie"]=X["Cherry Pies"],X["Mushroom Pie"]=X["Mushroom Pies"];const Ms=[7,8,8,8,8,10,10,8,9,9,9,10,9,10,10],Bs=[122,143,159,169,169,215,215,218,240,252,252,288,263,300,300],ve={};function de(s){if(ve[s]===void 0)switch(ve[s]=ue.filter(e=>e.Name===s)[0],s){case"Display Stand":ve[s].PurchaseCost=120*2;break}if(ve[s]===void 0){console.error(`Could not find ${s} appliance`);debugger}return ve[s]}const Rs=[(s,e)=>s[0]-e[0],(s,e)=>s[1]-e[1]];function Ne(s){let e=0;return(s==null?void 0:s.deskTime)!==void 0&&(e+=s.deskTime),e+=s.actionHistory.length,e}function Ge(s,e){return(a,l)=>{const r=a.achieved[e],n=l.achieved[e],u=Math.min(r.goalsPurchased,s);let F=Math.min(n.goalsPurchased,s)-u;return F===0?r.goalsPurchased>=s||r.goalsPurchased+r.substitutesPurchased>=s&&n.goalsPurchased+n.substitutesPurchased>=s?r.goalsPurchased+r.substitutesPurchased-(n.goalsPurchased+n.substitutesPurchased):n.substitutesPurchased-r.substitutesPurchased:F}}const vs={"Copying Desk":3,"Metal Table":4,"Power Sink":4,"Dish Washer":4,"Wash Basin":4,"Soaking Sink":4,"Heated Mixer":3,"Conveyor Mixer":3,"Rapid Mixer":3,"Danger Hob":2,"Safety Hob":2,"Grabber - Rotating":2,Grabber:0,"Smart Grabber":3,Freezer:2,Bin:0,Conveyor:0},Ns=[6,6,7,4,6,6,7,8,11,8,7,11,10,7,11];function ws(s,e,a,l,r=!0,n=Bs,u=Ms,g=Ns,F=()=>{},c=15){var as,ls,rs,Fs;let h={},k=[];const m=[],t=new Array(l.length).fill(0).map(()=>({})),o={};let b=0,f=0;const C={},z=e.some(T=>T.Name==="Turbo"),J=e.some(T=>T.Name==="Lake"),_=[];let D=[],G=0;const le={};for(const T of l){for(const p of T){const{goal:N,number:O,substitutes:$,skipMissing:A=!1}=p;for(const R of $)o[R]||(o[R]=[]),o[R].push(N),R==="Flower Pot"&&console.log({substitutesToGoalMap:o});le[N]?A||(le[N].number+=O):(le[N]={...p},A&&(le[N].number=0));for(let R=0;R<=G;R++){if(t[R]===void 0)debugger;t[R][N]?t[R][N].number+=O:t[R][N]={...p}}for(let R=G+1;R<t.length;R++){if(t[R]===void 0)debugger;t[R][N]||(t[R][N]={...p,number:0})}A||(f+=O*Math.ceil(de(N).PurchaseCost*(z?.5:J?.75:1)))}try{m.push(JSON.parse(JSON.stringify(le)))}catch{console.log(t),console.log(t[0]);debugger}G++}const ge=t[0],ke=Object.values(ge).sort((T,p)=>de(T.goal).PurchaseCost-de(p.goal).PurchaseCost).map(T=>T.goal);h=m.shift();for(const T of Object.values(ge)){const{goal:p,number:N}=T;C[p]={...T,substitutesPurchased:0,goalsPurchased:0},T.goal!=="Starter Bin"&&(_.push(Ge(N,p)),D.push(Ge(N,p)))}const q=new ae([],[..._,(T,p)=>p.money-T.money,(T,p)=>Ne(T)-Ne(p),(T,p)=>T.actionHistory.length-p.actionHistory.length,(T,p)=>T.cumulativeRerolls-p.cumulativeRerolls]),y=z?7:5,V=[{spawnInside:!0,blueprintCount:y},{spawnInside:!1,playerInside:!1,blueprintCount:y}];r||V.push({spawnInside:!1,playerInside:!0,blueprintCount:y});const Ee=[{spawnInside:!0,blueprintCount:y},{spawnInside:!1,playerInside:!0,blueprintCount:y},{spawnInside:!1,playerInside:!1,blueprintCount:y}];function Le(T,p,N){const O={...T};for(const $ of Object.values(p)){const A=$.goal;O[A]={...O[A]},A==="Copying Desk"&&(O[A].goalsPurchased+=O[A].substitutesPurchased,O[A].substitutesPurchased=0),O[A].goalsPurchased+=$.goalsPurchased,O[A].substitutesPurchased+=$.substitutesPurchased}return O}let ye=[];function Oe(T,p,N,O=!1){var A,R,Fe,fe,E;const $=p.fodderUsed;e:for(const S of T){let H=1+(S.achieved["Copying Desk"].goalsPurchased?1:0);const d=S.upgradesInProgress.filter(P=>P.appliance==="").length;let i=d;if(i*=H,i<0||i<$)continue;let M=[...S.upgradesInProgress];(es||S.achieved["Research Desk"].goalsPurchased)&&(M=M.map(P=>P.upgradeTurnTimer<=1?{appliance:"",cost:0,upgradeTurnTimer:0}:{...P,upgradeTurnTimer:P.upgradeTurnTimer-1}));let U=0;{let P=p.actionHistory.length,I=!1;for(;P--;)if(p.actionHistory[P]==="buy Blueprint Cabinet")U++;else if(p.actionHistory[P].includes(" for ")){I||(U=0);break}else p.actionHistory[P].includes("reroll")&&(I=!0)}for(let P=0;P<p.achieved["Blueprint Cabinet"].goalsPurchased-U;P++)M.push({appliance:"",cost:0,upgradeTurnTimer:0});let w=S.cumulativeRerolls+p.cumulativeRerolls;if(w>De)continue;let L=w*(w+1)/2*10+S.applianceCosts;const W=p.actionHistory.length?Le(S.achieved,p.achieved):S.achieved,ee=structuredClone(W);for(const P of M)P.appliance&&(ee[P.appliance]=structuredClone(ee[P.appliance]),ee[P.appliance].goalsPurchased--);if(p.cumulativeRerolls&&L>K)continue;let te=[],j=0,pe=1;const Ue=M.filter(P=>!P.appliance).length,Ie=(((A=S.achieved["Discount Desk"])==null?void 0:A.goalsPurchased)??0)+(((R=S.achieved["Discount Desk"])==null?void 0:R.substitutesPurchased)??0)?.5:1;{let P=K-L;for(const I of ke){const Q=p.achieved[I],me=Math.ceil(de(Q.goal).PurchaseCost*(z?.5:J?.75:1)*Ie);if(P-=(Q.goalsPurchased+Q.substitutesPurchased)*me,Q.substitutesPurchased){let ie=vs[Q.goal]??1;if(Q.goal==="Grabber"&&p.actionHistory.some(Y=>Y.includes("Conveyor for Grabber"))&&(ie=1),Q.goal!=="Freezer"){if(Q.goal==="Dish Washer"){const Y=(Fe=p.actionHistory.filter(Re=>Re.includes(" for Dish Washer"))[0].match(/buy (.*) for Dish Washer/))==null?void 0:Fe[1];if(!Y)throw"nope";ie=["Dish Washer","Wash Basin","Power Sink","Soaking Sink","Sink"].indexOf(Y),ie===4&&(ie=3)}}if(ie)for(let Y=0;Y<Q.substitutesPurchased;Y++)P+=me,te.push({appliance:Q.goal,cost:me,upgradeTurnTimer:ie}),j+=ie}}if(te.length>Ue)continue e;for(const I of te)I.appliance&&(ee[I.appliance]=structuredClone(ee[I.appliance]),ee[I.appliance].goalsPurchased--)}let se;try{se=Is(h,ee)}catch{continue}if(re<=0&&se>0)continue;L+=p.applianceCosts*Ie;let Me=0;{let P="",I=S.actionHistory.length,Q=!0;for(;I--;){const Y=S.actionHistory[I].match(/^(?:spawn|reroll) (..?)/);if(!Y){S.actionHistory[I].match(/^day ..? spawn/)&&(Q=!0);continue}if(Q){Q=!1;continue}P=Y[1][0]}let me=0,ie=!0;for(let Y=0;Y<p.actionHistory.length;Y++){Me+=me,me=0;const Re=p.actionHistory[Y].match(/^(?:spawn|reroll) (..?)/);if(!Re){const ns=p.actionHistory[Y].match(/take (\d+) out/);ns&&(Me+=parseInt(ns[1])/3+1);continue}Me++;const Vs=Re[1][0],ts=ie?"":Re[1][1];ie=!1,P&&(P[0]!==Vs&&(me+=3),P[1]&&ts&&P[1]!==ts&&(me+=10)),P=Re[1]}}let We=S.deskTime+(pe-1)*20+Math.max(0,$-d)*5*((fe=S.achieved["Clipboard Stand"])!=null&&fe.goalsPurchased?.5:1)+(j*pe*5+(u[p.day]??u.at(-1)??0))*((E=W["Clipboard Stand"])!=null&&E.goalsPurchased?.5:1)+Me+p.cumulativeRerolls*2;{let P=0;for(const I of te){for(;M[P].appliance;)P++;M[P]=I}for(let I=0;I<U;I++)M.push({appliance:"",cost:0,upgradeTurnTimer:0})}const ne={...p,rerollConfigs:[...S.rerollConfigs,p.rerollConfigs],achieved:W,money:K-L,actionHistory:[...S.actionHistory,...p.actionHistory],upgradesInProgress:M,cumulativeRerolls:S.cumulativeRerolls+p.cumulativeRerolls,applianceCosts:S.applianceCosts+p.applianceCosts*Ie,deskTime:We};if(!(ne.money<-ne.upgradesInProgress.reduce((P,I)=>P+I.cost,0))&&!(L>540)&&!(te.length>Ue)){if(ne.money>=0||ne.money+ne.upgradesInProgress.reduce((P,I)=>P+I.cost,0)>=0&&m.length){if(se<re&&(re=se,console.log(`best so far missing ${se} pieces `+xe(ne,K))),se<=0){if(q.add(ne)){if(ss(),q.array[0].deskTime<-1e4*60){console.log("uh, can I quit from this function?");break}continue}}else if(re<=0)continue}if(i>b&&(b=i),O){const P=S.cumulativeRerolls;for(let I=0;I<=i;I++)ye[I]===void 0&&(ye[I]=new ae([],Rs)),ye[I].add([P,L]);continue}N.add(ne)}}return re}const $e={...C};$e["Blueprint Cabinet"]={...$e["Blueprint Cabinet"],goalsPurchased:1};const we=new ae([{achieved:$e,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,rerollConfigs:[],upgradesInProgress:[{appliance:"",cost:0,upgradeTurnTimer:0}],day:0,numFloor:0,money:0,fodderAvailable:0,deskTime:0}],[..._,(T,p)=>T.applianceCosts-p.applianceCosts,(T,p)=>T.cumulativeRerolls-p.cumulativeRerolls]);let re=1/0,x=0,K=0;const Z=new Ss(s),He=["Research Desk","Plates"];let es=!1,Pe=[];{const T=["Booking Desk","Blueprint Cabinet"];ue.filter(p=>T.includes(p.Name)).forEach(p=>Z.OwnedAppliances.push(p))}for(const T of e)Z.addCard(T);function qs(T,p,N){var Fe,fe;let O=[{...T}],$=[],A=[];const R=JSON.parse(JSON.stringify(T.achieved));for(const E of p){if(!E)continue;let S=E.Name,H=R[S],d=!1,i=H&&x>3&&H.goal==="Research Desk";if(!H||H.goalsPurchased>=(((Fe=t[0][S])==null?void 0:Fe.number)??0)||i||(fe=o[E.Name])!=null&&fe.some(M=>R[M]&&R[M].goalsPurchased+R[M].substitutesPurchased<t[0][M].number)&&Math.random()<.5){const M=o[E.Name],U=M&&E.Name==="Research Desk"?x>6?"Copying Desk":"Discount Desk":M==null?void 0:M[Math.floor(Math.random()*M.length)];if(H=R[U],!H)continue;d=!0,S=U}if(d&&H.goalsPurchased+H.substitutesPurchased>=t[0][S].number&&(H=R["Starter Bin"],S="Starter Bin"),!H)debugger;if(H.goalsPurchased>=(t[0][S]?t[0][S].number:9)){H=R["Starter Bin"],S="Starter Bin",d=!0;continue}S==="Table - Fancy Cloth"&&(d=!1),E.ThemeRequired&&(d=!1),d?H.substitutesPurchased++:H.goalsPurchased++;{const M=U=>{const w={...U};if(w.achieved={...w.achieved},w.numFloor--,w.achieved[S])w.achieved[S]={...w.achieved[S],goalsPurchased:w.achieved[S].goalsPurchased+(d?0:1),substitutesPurchased:w.achieved[S].substitutesPurchased+(d?1:0)};else if(w.achieved[S]={...H,goalsPurchased:d?0:1,substitutesPurchased:d?1:0},Number.isNaN(w.achieved[S].goalsPurchased))debugger;const L=S==="Starter Bin"||S==="Table - Fancy Cloth"?de(E.Name).PurchaseCost:Math.max(de(E.Name).PurchaseCost,de(S).PurchaseCost);return d?w.applianceCosts+=Math.ceil(L*(z?.5:1)):w.applianceCosts+=Math.ceil(L*(z?.5:J?.75:1)),w.actionHistory=[...w.actionHistory,`buy ${E.Name}`+(d?` for ${S}`:"")],S==="Starter Bin"&&(w.fodderPurchases=[...w.fodderPurchases],w.fodderPurchases[1]++,w.achieved[S].substitutesPurchased--),w};if(S!=="Starter Bin"){const U=O.map(M),w=$.map(M),L=A.map(M);O=U.concat(O),$=w.concat($),A=L.concat(A),U.forEach(N)}else $=$.concat(A),A=(A.length?A:O).map(M)}}return O.concat($).concat(A)}let De=-1;{let T=n.slice(0,c).reduce((p,N)=>p+N)-f;for(;T>0;)De++,T-=10*De;console.log({maxCumulativeRerolls:De,money:T,expectedMoneyByDay:n,gearMoney:f})}for(De=1/0,Number.isFinite(c)||(De=3);re;){let T=we.array;if(!T.length)return F("No Solutions"),0;we.clear();const p=new ae([],[...D,(d,i)=>d.cumulativeRerolls-i.cumulativeRerolls,(d,i)=>d.applianceCosts-i.applianceCosts]);if(K+=n[x]??n.at(-1)??0,x++,x>=c)break;if(x>14&&(z||!a.length)){debugger;break}if(x>1&&T.length===0){debugger;break}T.sort((d,i)=>Ne(d)-Ne(i)),console.log(`fastest so far: ${xe(T[0],K)}`),T.every(d=>d.achieved["Copying Desk"].goalsPurchased)&&(k=k.map(d=>d-1),k=k.filter(d=>d>0));let N=2;switch(x){default:N=Math.min(De+1);break}N=5,x<=9&&(N=5);let O=.5*60*1e3;const $=Math.min(N-1,1/0);if(K>=f){const d=Math.sqrt((K-f)/10*2);console.log(`Have ${K} on day ${x}, need ${f} to buy everything. Allows for ~${d} rerolls across all days`)}x%5||(N=1);let A;(z||x===5||!(x%3))&&(A=a.shift());const R=Be.filter(d=>d.Name===A)[0];Z.handleNewCardSpawnEffects(R);const Fe=Z.getAppliances([{spawnInside:!0,blueprintCount:y}],x);let fe=[];if(He.length)for(let d=He.length-1;d>=0;d--){let i=Fe.length;for(;i--;){const M=Fe[i];if(M.Name===He[d]){if(console.log(`buying ${M.Name} on day ${x}`),K-T.reduce((w,L)=>Math.min(w,L.applianceCosts+10/2*(L.cumulativeRerolls+1)*L.cumulativeRerolls),1/0)<M.PurchaseCost*(z?.5:J?.75:1)){console.log("not enough money-- skip for now");continue}Pe.push(M),He.splice(d,1),K-=M.PurchaseCost*(z?.5:J?.75:1),Fe.splice(i,1);break}}fe=Pe.map(M=>`Buy ${M.Name}`)}let E=new ae([{day:x,rerollConfigs:[],achieved:{...C},numFloor:y,fodderAvailable:b,fodderUsed:0,money:K,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,fodderPurchases:[0,0]}],[(d,i)=>Z.getPrngAdvancements(d.rerollConfigs,x)-Z.getPrngAdvancements(i.rerollConfigs,x),(d,i)=>-Z.getPrngAdvancements(d.rerollConfigs,x)+Z.getPrngAdvancements(i.rerollConfigs,x),...D,(d,i)=>d.cumulativeRerolls-i.cumulativeRerolls,(d,i)=>d.applianceCosts-i.applianceCosts,(d,i)=>i.numFloor+i.fodderAvailable-d.numFloor+d.fodderAvailable,(d,i)=>d.numFloor-i.numFloor]);Oe(T,E.array[0],we,!0);let S=1/0;const H=ye.map(d=>d.array.reduce((i,[M,U])=>Math.min(i,U+E.array[0].rerollConfigs.length*(M+1)*10),1/0));e:for(;N--&&(Pe.length&&((ls=(as=E.array[0])==null?void 0:as.rerollConfigs)==null?void 0:ls.length)===1&&(Pe.some(i=>i.Name==="Research Desk")&&(es=!0),Z.OwnedAppliances.push(...Pe),Pe=[],fe=[]),S=Date.now()+O,E.array[0]!==void 0);){console.log(`Seed ${s} Day ${x} Reroll ${E.array[0].rerollConfigs.length} expanding ${E.array.length} states`),console.log({minSpentMoneyByExtraBlueprints:H});const d=E.array;if(!m.length&&re<=0){const i=d[0].rerollConfigs.length;if(i*((i+1)/2)*10+f>K){console.log("get me outta here!");break}}E.clear();for(const i of d){if(Date.now()>S){E.array.sort((ee,te)=>-1*(ee.applianceCosts-te.applianceCosts));continue e}if(i.numFloor+i.fodderAvailable===0||i.money<i.rerollConfigs.length*10)continue;let M=0;if(H[0]>i.money)continue;for(let W=1;W<H.length;W++)if(M++,H[W]>i.money){M=W-1;break}let U=$<i.rerollConfigs.length?i.numFloor:i.rerollConfigs.length?i.numFloor+Math.min(i.fodderAvailable,M-i.fodderUsed):y;{let W=i.actionHistory.length;for(;W--&&!i.actionHistory[W].includes("reroll");)if(i.actionHistory[W].includes("Starter Bin")){U=i.numFloor;break}}const w=$<i.rerollConfigs.length?i.numFloor:i.rerollConfigs.length?Math.max(1,i.numFloor):y;let L;i.rerollConfigs.length===0?L=Ee:$<i.rerollConfigs.length?L=[i.rerollConfigs.at(-1)]:L=V,Z.getAppliances([...i.rerollConfigs,{spawnInside:!0,blueprintCount:U}],i.day);for(const W of L){const ee=j=>{if(!E.add(j)||!p.add(j))return;j.fodderPurchases[0]+j.fodderPurchases[1]||Oe(T,j,we)},te=[w];for(let j=U;j>w;j--)te.push(j);for(const j of te){const pe=[...i.rerollConfigs,{...W,blueprintCount:j}],Ie=[...pe.length===1?Fe:Z.getAppliances(pe,i.day)].sort((We,ne)=>We.PurchaseCost-ne.PurchaseCost),se=j-i.numFloor;if(se>i.fodderAvailable)debugger;const Me={...i,fodderPurchases:[i.fodderPurchases[1],0],money:i.money-i.rerollConfigs.length*10,rerollConfigs:pe,numFloor:pe.length===1?j-Pe.length:j,fodderAvailable:i.fodderAvailable-se,fodderUsed:i.fodderUsed+se,cumulativeRerolls:i.rerollConfigs.length?i.cumulativeRerolls+1:0,actionHistory:i.rerollConfigs.length?[...i.actionHistory,`${se?`take ${se} out, `:""}reroll ${W.spawnInside?"I":W.playerInside?"OI":"OO"}`]:[`day ${i.day} spawn`,`spawn ${W.spawnInside?"I":W.playerInside?"OI":"OO"}`,...fe]};if(ee(Me),qs(Me,Ie,ee),Date.now()>S)break}}}}if(Z.addCard(R),re<=0){if(!m.length){q.array.sort((d,i)=>d.deskTime-i.deskTime),F((re<=0?`full build on ${s} by day ${x}: 
`:"")+q.array.map(d=>xe(d,K)).join(`
`));break}{const d=(((rs=m[0]["Blueprint Cabinet"])==null?void 0:rs.number)??0)-(((Fs=h["Blueprint Cabinet"])==null?void 0:Fs.number)??0);if(d+k.length>2)debugger;for(let i=0;i<d;i++)k.push(15)}for(const d of Object.values(h))d.number&&Z.OwnedAppliances.push(de(d.goal));h=m.shift(),t.shift(),D=[];for(const{goal:d,number:i}of Object.values(t[0]))D.push(Ge(i,d));re=1/0,ye=[],ss(!0),we.array=q.array,q.clear(),q.objectiveFunctions}}return x;function ss(T=!1){(Math.random()<.001||T)&&q.array.sort((p,N)=>p.deskTime-N.deskTime),F(`tier ${l.length-m.length-(T?1:0)} build on ${s} by day ${x}${T?"":" (Partial)"}: 
`+q.array.slice(0,100).map(p=>xe(p,K)).join(`
`))}}function Is(s,e){let a=0;for(const l of Object.values(s)){const n=l.number-e[l.goal].goalsPurchased-e[l.goal].substitutesPurchased;a+=Math.max(0,n)}return a}function xe(s,e){const a=s.cumulativeRerolls*(s.cumulativeRerolls+1)/2*10+s.applianceCosts;return`${s.day}: ${Ne(s)} total rerolls: ${s.cumulativeRerolls}, appliance costs: ${s.applianceCosts} (money spent: ${a}/${e}), `+s.actionHistory.join(", ")+JSON.stringify(s.upgradesInProgress)}const qe={};function Ve(s){const{starters:e,main:a,doubleOrderChance:l,desserts:r,sides:n,groupSizes:u}=s,g=[e,a,l,r,n,[...u].sort((o,b)=>o-b)].join("|");if(qe[g])return qe[g];let F=[0,0,0],c=[0,0,0,0],h=1-.75**n;if(e>0){F[0]=1;let o=1-.75**e;l===.5&&(o*=1.25,h*=1.25),c[0]=u.reduce((b,f)=>b+1+(f-1)*o,0)}const k=u.reduce((o,b)=>o+b);a&&(F[1]=1,c[1]=k),r>0&&(c[2]=k,a?(F[2]=1-.75**r,l===.5&&(F[2]*=1.25)):F[2]=1);let m=1;e>0&&(F[0]*=1+l,m*=1-l,c[0]*=F[0]),a&&(F[1]*=1+m*l,m*=1-l,c[1]*=F[1],c[3]=c[1]*h),r>0&&(F[2]*=1+m*l,m*=1-l,c[2]*=F[2]);const t=[F.map(o=>o*u.length),c];return qe[g]=t,t}function As(s){const{starters:e,main:a,doubleOrderChance:l,desserts:r,sides:n,groupSizes:u}=s;let g=[0,0,0],F=[0,0,0,0],c=1-.75**e,h=1-.75**r,k=1-.75**n;l===.5&&(c*=1.25,h*=1.25,k*=1.25);const m=f=>{g[0]++,F[0]++;for(let C=0;C<f-1;C++)Math.random()<c&&F[0]++},t=f=>{g[1]++,F[1]+=f;for(let C=0;C<f;C++)Math.random()<k&&F[3]++},o=f=>{g[2]++,F[2]+=f};for(const f of u){let C=!1;e>0&&(m(f),!C&&Math.random()<l&&(C=!0,m(f))),t(f),!C&&Math.random()<l&&(C=!0,t(f)),r>0&&Math.random()<h&&(o(f),!C&&Math.random()<l&&(C=!0,o(f)))}return[g,F]}const xs={"Diner (1)":1,"Small (2)":2,"Medium (2)":2,"Large (3)":3,"Huge (4)":4},Qe={};["Morning Rush","Lunch Rush","Dinner Rush"].forEach(s=>Qe[s]=!0);class Es{constructor(e,a=[],l=[]){B(this,"seed");B(this,"mapSize");B(this,"frontDoor");B(this,"startingCards");B(this,"cards");B(this,"playerCount");B(this,"turbo");B(this,"_actionInfoCacheByCards",{});B(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=a,this.cards=l,this.playerCount=xs[this.mapSize],this.turbo=this.startingCards.some(r=>{if(r===void 0){console.log({startingCards:a});debugger}return r.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let r=!1,n=!1,u=0,g=[],F=[],c=0,h=[],k=0,m=[];for(const D of a)switch(D.Name==="All You Can Eat"&&(r=!0),D.Name==="Double Helpings"&&(n=!0),D.DishType){case v.Dessert:c++,D.DishValue&&h.push(D.DishValue);break;case v.Starter:D.DishValue&&g.push(D.DishValue),u++;break;case v.Side:D.DishValue&&m.push(D.DishValue),k++;break;case v.Main:case v.Base:D.Name==="Tacos"?(F.push(2),F.push(3)):D.DishValue&&F.push(D.DishValue)}let t=n?.5:r?.25:0,o=[0,0,0,0];if(o[0]=he(g),o[1]=he(F),o[2]=he(h),o[3]=he(m),n)for(let D=0;D<3;D++)o[D]&&(o[D]+=3);const[b,f]=Ve({starters:u,main:!!o[1],doubleOrderChance:t,desserts:c,sides:k,groupSizes:l});let C=0;for(let D=0;D<f.length;D++)C+=f[D]*o[D];const z=Ze(this.playerCount),J=this.getBookingDeskCount(e),_=this.getBookingDeskMoney(e);return Math.ceil(z*(C+J*_))}courseInfo(e){if(e===0)return[[0,0,0],[0,0,0,0]];const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let r=!1,n=!1,u=0,g=[],F=[],c=0,h=[],k=0,m=[];for(const f of a)switch(f.Name==="All You Can Eat"&&(r=!0),f.Name==="Double Helpings"&&(n=!0),f.DishType){case v.Dessert:c++,f.DishValue&&h.push(f.DishValue);break;case v.Starter:f.DishValue&&g.push(f.DishValue),u++;break;case v.Side:f.DishValue&&m.push(f.DishValue),k++;break;case v.Main:case v.Base:if(!f.isMain){c++,f.DishValue&&h.push(f.DishValue);break}f.Name==="Tacos"?(F.push(2),F.push(3)):f.DishValue&&F.push(f.DishValue)}let t=n?.5:r?.25:0,o=[0,0,0,0];if(o[0]=he(g),o[1]=he(F),o[2]=he(h),o[3]=he(m),n)for(let f=0;f<3;f++)o[f]&&(o[f]+=3);return Ve({starters:u,main:!!o[1],doubleOrderChance:t,desserts:c,sides:k,groupSizes:l})}actionInfo(e){if(e===0)return 0;const a=this.getCardsByDay(e),l=e.toString()+":"+a.map(y=>y.Name).sort().join(","),r=this._actionInfoCacheByCards[l];if(r)return r;let n=0;const u={Breakfast:6,Dumplings:11.25,"Stir Fry":26/2,Steak:7};let g=0;for(let y=0;y<a.length;y++)if(a[y].DishType!==v.Null){const V=a[y].Name;g=u[V]??20;break}let F=-1,c=[1,1,1],h=[[],[g],[],[]],k=0;const m=this.getGroupSizes(e);let t=!1,o=!1,b=0,f=[],C=[],z=0,J=[],_=0,D=[],G=!1,le=!1;for(const y of a){switch(y.Name==="All You Can Eat"&&(t=!0),y.Name==="Double Helpings"&&(o=!0),y.Name){case"Picky Eaters":G=!0;break;case"Leisurely Eating":le=!0,k+=2;break;case"Instant Service":for(let V=0;V<3;V++)c[V]--;break;case"Ice Cream":h[2].push(5.125);break;case"Cheese Board":h[2].push(10);break;case"Cherry Pies":h[2].push(11);break;case"Apple Pies":h[2].push(15);break;case"Pumpkin Pies":h[2].push(16);break;case"Carrot Soup":case"Meat Soup":h[0].push(7);break;case"Tomato Soup":case"Pumpkin Soup":c[0]=4,h[0].push(8);break;case"Broccoli Cheese Soup":h[0].push(5),c[0]=4;break;case"Pumpkin Seed":h[0].push(3*8);break;case"Bread":h[0].push(5*3);break;case"Mandarin Starter":h[0].push(7*3);break;case"Mashed Potato":case"Broccoli":case"Bamboo":h[3].push(2);break;case"Onion Rings":h[3].push(8);break;case"Corn on the Cob":h[3].push(6);break;case"Chips":h[3].push(7);break;case"Roast Potato":h[3].push(4);break}switch(y.DishType){case v.Dessert:z++,y.DishValue&&J.push(y.DishValue);break;case v.Starter:y.DishValue&&f.push(y.DishValue),b++;break;case v.Side:y.DishValue&&D.push(y.DishValue),_++;break;case v.Main:case v.Base:y.Name==="Tacos"?(C.push(2),C.push(3)):y.DishValue&&C.push(y.DishValue);break;case v.Extra:y.Name==="Seaweed"?(h[1][0]+=1.75,F+=2):y.Name==="Dumpling - Soy Sauce"?h[1][0]+=.4:y.Name==="Breakfast Beans"?h[1][0]+=1+3/4:y.Name==="Breakfast Eggs"?h[1][0]+=6:y.Name==="Breakfast Extras"&&(F++,h[1][0]+=1.5*2),F++;break}}e>6&&(h[3]=[]),G&&(le&&!t||(h[1][0]+=2,F++));let ge=o?.5:t?.25:0;n+=m.length*k;const[ke,q]=Ve({starters:b,main:!0,doubleOrderChance:ge,desserts:z,sides:_,groupSizes:m});ke.forEach((y,V)=>n+=y*c[V]);for(const y of h)for(let V=0;V<y.length;V++)F>0&&(y[V]+=F),F+=1;return q.forEach((y,V)=>{var Ee;if((Ee=h[V])!=null&&Ee.length){if(!V){const Le=Math.ceil(y/h[V].length/3);n+=Le*h[V].reduce((ye,Oe)=>ye+Oe,0);return}n+=y*he(h[V])}}),this._actionInfoCacheByCards[l]=n,n}simulateMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let r=!1,n=!1,u=[[],[],[],[]];for(const b of a)switch(b.Name==="All You Can Eat"&&(r=!0),b.Name==="Double Helpings"&&(n=!0),b.DishType){case v.Main:case v.Base:b.Name==="Tacos"?u[1].push(2.5):b.DishValue&&u[1].push(b.DishValue);break;case v.Dessert:b.DishValue&&u[2].push(b.DishValue);break;case v.Starter:b.DishValue&&u[0].push(b.DishValue);break;case v.Side:b.DishValue&&u[3].push(b.DishValue);break}let g=n?.5:r?.25:0,F=0;n&&(F+=3);const[c,h]=As({starters:u[0].length,main:!!u[1].length,doubleOrderChance:g,desserts:u[2].length,sides:u[3].length,groupSizes:l});let k=0;for(let b=0;b<h.length;b++){let f=h[b];for(;f--;){b<3&&(k+=F);let C=u[b][Math.floor(Math.random()*u[b].length)];C%1&&(Math.random()<C%1?C=Math.ceil(C):C=Math.floor(C)),k+=C}}const m=Ze(this.playerCount),t=this.getBookingDeskCount(e),o=this.getBookingDeskMoney(e);return Math.ceil(m*(k+t*o))}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}clearCardsCache(){this._cardsByDay=[]}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let a;this.turbo?a=e-1:(a=Math.max(0,Math.floor((e-1)/3)),e>5&&a++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,a)]}return this._cardsByDay[e]}getBookingDeskCount(e,a=1){const l=Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e));if(this.getCardsByDay(e).some(c=>c.Name==="Herd Mentality"))return Math.min(l,3)+1;const r=[],n=this.getCardsByDay(e);let u=1;(this.turbo||n.some(c=>c.Name==="Morning Rush"))&&r.push(.2),(this.turbo||n.some(c=>c.Name==="Lunch Rush"))&&r.push(.5),(this.turbo||n.some(c=>c.Name==="Dinner Rush"))&&r.push(.8);const g=a/(this.playerCount||2)/this.getDayLength(e),F=.1/l;u+=l-1;for(let c=1;c<l;c++){const h=c/l,k=h-F-g,m=h+F+g;for(let t=r.length-1;t>=0;t--){const o=r[t];k<=o&&o<=m&&r.splice(t,1)}}return u+=r.length,u}getNonRushGroupCount(e){const a=this.getExpectedCustomers(e),l=this.getCardsByDay(e).filter(u=>u.Name==="Closing Time?").length*.2,r=this.getExpectedGroupSize(e),n=a*(1+l)/r;return Math.ceil(n)}getCustomerCount(e){return this.getGroupSizes(e).reduce((a,l)=>a+l,0)}getGroupSizes(e,a=0){const l=this.seed?Ke(1997821,e,this.seed).random:new ze(Math.floor(Math.random()*4294967295)),r=this.getNonRushGroupCount(e),n=this.getCardsByDay(e).some(t=>t.Name==="Herd Mentality");let u=r,g=[],[F,c]=this.getGroupSizeRange(e);!this.seed||this.seed==="_min"?c=F:this.seed==="_max"&&(F=c);{let t=u-1;for(;t--;)l.value}for(;u--;)g.push(l.range(F,c+1)),!n&&u!==r-1&&l.value;let h=this.turbo?3:this.getCardsByDay(e).filter(t=>Qe[t.Name]).length,k;switch(a){case 0:k=Math.ceil(Math.max(1,r*.15));break;case 1:k=Math.ceil(Math.max(1,this.getExpectedCustomers(e)*.15));break;case 2:k=Math.ceil(Math.max(1,r*.15*1.5))}let m=h*k;for(;m--;)g.push(l.range(F,c+1));if(!this.seed||this.seed[0]==="_"){let t=F;for(let o=0;o<g.length;o++)g[o]=t,t++,t>c&&(t=F)}return g}getExpectedGroupSize(e){const a=this.getGroupSizeRange(e);return(a[0]+a[1])/2}getGroupSizeRange(e){let a=1,l=2;for(const r of this.getCardsByDay(e))switch(r.Name){case"Individual Dining":l--;break;case"Medium Groups":a++,l+=2;break;case"Large Groups":a+=2,l+=2;break;case"Flexible Dining":a--,l++;break;case"Community":const n=Math.floor((e-1)/3);a+=n,l+=n;break}return[a,l]}getExpectedCustomers(e){const a=this.getReductions(e),l=this.getDayLength(e),r=this.getPlayerModifier(),n=this.getCourseModifier(e),u=this.getDayRate(e),g=this.getCustomersPerHour(e),F=this.getAdvertisingModifier(e);return .85**a*(l/25*u*r)/n*g*F}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(l=>l.Name==="Advertising").length}getDayRate(e){let a=1;switch(e){case 1:a=1.25;break;case 2:a=1.5;break;default:a=1.5+.15*(e-3);break}return e>15&&(a+=(this.turbo?.1:0)*(e-15)**1.5),a}getCourseModifier(e){let a=1;const l=this.getCardsByDay(e);return l.some(r=>r.DishType===v.Dessert||r.Name==="Black Coffee"||r.Name==="Cakes")&&(a+=.25),l.some(r=>r.DishType===v.Starter)&&(a+=.25),a}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let a=1;return this.turbo&&(a=1.5,a*=1+e/10),a}getReductions(e){return this.getCardsByDay(e).reduce((l,r)=>l+r.CustomerMultiplier,0)}getMapSize(){const a=new Ce(this.seed,5078598).useSubcontext(0).random.range(0,8);let l;switch(a){case 0:l="Small (2)";break;case 4:l="Medium (2)";break;case 1:case 5:l="Diner (1)";break;case 2:case 6:l="Large (3)";break;case 3:case 7:l="Huge (4)";break;default:throw new Error}return l}getLayoutInfo(){const a=new Ce(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,r;switch(a){case 0:r=70,l=2;break;case 4:r=84,l=2;break;case 1:case 5:r=60,l=1;break;case 2:case 6:r=9*13,l=3;break;case 3:case 7:r=12*16,l=4;break;default:throw new Error}return[l,r]}getDoorInfo(){if(this.mapSize!=="Diner (1)")return-1;let e=new ze(new Ce(this.seed,98234234).useSubcontext(0).random.value),a=23;for(;a--;)e.value;return e.range(0,4)}}function Ze(s){switch(s){case 1:return 1.25;case 2:return 1.1;default:return 1}}function Os(s,e,a,l){let r=[],n=[],u=[];const g=s.cards.slice(e);let F=new Es(s.seed,a,g);F.playerCount=l;for(let c=1;c<=15;c++)u.push(F.getCustomerCount(c)),r.push(F.guessMoney(c)),n.push(F.getBookingDeskCount(c));return r[0]+=F.guessMoney(0),{expectedMoneyByDay:r,expectedBookingDesksByDay:n,expectedCustomersByDay:u}}var Xe=self;function Hs(s){Xe.postMessage(s)}const zs=["Blueprint Cabinet","Clipboard Stand"],Gs=[{goal:"Copying Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Blueprint Cabinet",number:8,substitutes:[],skipMissing:!0},{goal:"Clipboard Stand",number:1,substitutes:[],skipMissing:!0},{goal:"Research Desk",number:0,substitutes:[],skipMissing:!0},{goal:"Dining Table",number:3,substitutes:[],skipMissing:!0},{goal:"Starter Bin",number:999,substitutes:ue.filter(s=>!s.ThemeRequired&&!zs.includes(s.Name)).map(s=>s.Name),skipMissing:!0}];Xe.onmessage=s=>{let{config:e,tiers:a,playerCount:l,maxDay:r=15}=s.data;for(const t of a)for(const o of t){const b=ue.filter(f=>f.Name===o.goal)[0];b.ThemeRequired&&(o.substitutes=ue.filter(f=>f.ThemeRequired===b.ThemeRequired).map(f=>f.Name))}for(;!a.at(-1).length;)a.pop();const n=[...Gs],u=a.flatMap(t=>t.flatMap(o=>[o.goal,...o.substitutes])),g=n.length-1;n[g].substitutes=n[g].substitutes.filter(t=>!u.some(o=>t===o)),a[a.length-1].push(...n);const F=e.cards.filter(t=>Je.some(o=>o.Name===t.Name)).length+1,c=e.cards.slice(0,F);let{expectedMoneyByDay:h,expectedBookingDesksByDay:k,expectedCustomersByDay:m}=Os(e,F,c,l);ws(e.seed,c,e.cards.slice(F).map(t=>t.Name),a,e.solo,h,k,m,Hs,r)}})();
