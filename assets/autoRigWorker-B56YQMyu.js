var Ls=Object.defineProperty;var $s=(ae,ie,be)=>ie in ae?Ls(ae,ie,{enumerable:!0,configurable:!0,writable:!0,value:be}):ae[ie]=be;var B=(ae,ie,be)=>$s(ae,typeof ie!="symbol"?ie+"":ie,be);(function(){"use strict";class ae{constructor(e,a){B(this,"array");B(this,"objectiveFunctions");this.array=ie(e,a),this.objectiveFunctions=a}clear(){this.array=[]}add(e){let a=this.array.length;for(;a--;){let{better:l,worse:r}=be(e,this.array[a],this.objectiveFunctions);if(r)return!1;l&&this.array.splice(a,1)}return this.array.push(e),!0}}function ie(s,e){if(!s.length)return s;const a=[...s];let l=[];l.push(a.pop());e:for(;a.length;){const r=a.pop();let t=l.length;for(;t--;){let{better:o,worse:g}=be(r,l[t],e);if(g)continue e;o&&l.splice(t,1)}l.push(r)}return l}function be(s,e,a){let l=!0,r=!0,t=0;for(;(l||r)&&t<a.length;){const o=a[t](s,e);o<0?r=!1:o>0&&(l=!1),t++}return{better:l,worse:r}}var is=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False,False,60\r
...
-2075899,Breakfast,1,-523839730:-1706154991,380220741:925796718,True,False,0,0,5\r
-1653221873,Stir Fry,1,2087693779:1972879238,-452101383:-1573812073:380220741:-1201769154:314862254,True,False,0,1,10\r
`;const Be=ys.trim().split(`\r
`).filter(s=>s).map(s=>{var ge,ye;const[e,a,l,r,t,o,g,F,h,c,P,p]=s.split(","),n=Number(e),u=Number(l),T=r!=null&&r.length?r.split(":").map(G=>Number(G)):[],f=t.length?t.split(":").map(G=>Number(G)):[],C=o!=null&&o.length?(ge=o==null?void 0:o.split(":"))==null?void 0:ge.map(G=>Number(G)):[],z=g!=null&&g.length?(ye=g==null?void 0:g.split(":"))==null?void 0:ye.map(G=>Number(G)):[],J=F==="True",K=h==="True",M=Number(c),q=Number(P),le=Number(p);return{ID:n,Name:a,UnlockGroup:u,Requires:T,BlockedBy:f,RequiredProcesses:C,IngredientProviders:z,isMain:J,isStarterOrSide:K,DishType:M,CustomerMultiplier:q,DishValue:le}}),Je=[...[{ID:447437163,Name:"Country",UnlockGroup:ke.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:ke.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:ke.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0},Be.filter(s=>s.Name==="Community")[0],Be.filter(s=>s.Name==="Couples")[0],{ID:1958825350,Name:"Turbo",UnlockGroup:ke.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0},Be.filter(s=>s.Name==="Christmas Rush")[0],{ID:-1893039732,Name:"Lake",UnlockGroup:ke.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:v.Null,CustomerMultiplier:0,DishValue:0}]].slice(3).sort((s,e)=>s.Name<e.Name?-1:1);["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey"].map(s=>Be.filter(e=>e.Name===s)[0]);const Ds=Ps.trim().split(`\r
`).filter(s=>s).map(s=>{var K,M;const[e,a,l,r,t,o,g,F,h,c]=s.split(","),P=Number(e),p=Number(l),n=r!=null&&r.length?(K=r==null?void 0:r.split(":"))==null?void 0:K.map(q=>Number(q)):[],u=t!=null&&t.length?(M=t==null?void 0:t.split(":"))==null?void 0:M.map(q=>Number(q)):[],T=o==="True",f=g==="True",C=Number(F),z=Number(h),J=Number(c);return{ID:P,Name:a,UnlockGroup:p,Requires:[],BlockedBy:[],RequiredProcesses:n,IngredientProviders:u,isMain:T,isStarterOrSide:f,DishType:C,CustomerMultiplier:z,DishValue:J}}).sort((s,e)=>s.Name<e.Name?-1:1),fe={};for(const s of Be)fe[s.Name]=s;for(const s of Ds)fe[s.Name]=s;for(const s of Je)fe[s.Name]=s;fe.Coffee=fe["Black Coffee"],fe.Community.AKA="Autumn",fe["Christmas Rush"].AKA="North Pole",fe.Couples.AKA="Romantic";const Ms=[7,8,8,8,8,10,10,8,9,9,9,10,9,10,10],Bs=[122,143,159,169,169,215,215,218,240,252,252,288,263,300,300],Ae={};function de(s){if(Ae[s]===void 0&&(Ae[s]=oe.filter(e=>e.Name===s)[0]),Ae[s]===void 0){console.error(`Could not find ${s} appliance`);debugger}return Ae[s]}const Rs=[(s,e)=>s[0]-e[0],(s,e)=>s[1]-e[1]];function ve(s){let e=0;return(s==null?void 0:s.deskTime)!==void 0&&(e+=s.deskTime),e+=s.actionHistory.length,e}function qe(s,e){return(a,l)=>{const r=a.achieved[e],t=l.achieved[e],o=Math.min(r.goalsPurchased,s);let F=Math.min(t.goalsPurchased,s)-o;return F===0?r.goalsPurchased>=s||r.goalsPurchased+r.substitutesPurchased>=s&&t.goalsPurchased+t.substitutesPurchased>=s?r.goalsPurchased+r.substitutesPurchased-(t.goalsPurchased+t.substitutesPurchased):t.substitutesPurchased-r.substitutesPurchased:F}}const vs={"Copying Desk":3,"Metal Table":4,"Power Sink":4,"Dish Washer":4,"Wash Basin":4,"Soaking Sink":4,"Heated Mixer":3,"Conveyor Mixer":3,"Rapid Mixer":3,"Danger Hob":2,"Safety Hob":2,"Grabber - Rotating":2,"Smart Grabber":3,Freezer:2,Bin:0,Conveyor:0},Ns=[6,6,7,4,6,6,7,8,11,8,7,11,10,7,11];function ws(s,e,a,l,r=!0,t=Bs,o=Ms,g=Ns,F=()=>{},h=15){var as,ls,rs,Fs;let c={},P=[];const p=[],n=new Array(l.length).fill(0).map(()=>({})),u={};let T=0,f=0;const C={},z=e.some(b=>b.Name==="Turbo"),J=e.some(b=>b.Name==="Lake"),K=[];let M=[],q=0;const le={};for(const b of l){for(const m of b){const{goal:w,number:O,substitutes:$,skipMissing:I=!1}=m;for(const R of $)u[R]||(u[R]=[]),u[R].push(w),R==="Flower Pot"&&console.log({substitutesToGoalMap:u});le[w]?I||(le[w].number+=O):(le[w]={...m},I&&(le[w].number=0));for(let R=0;R<=q;R++){if(n[R]===void 0)debugger;n[R][w]?n[R][w].number+=O:n[R][w]={...m}}for(let R=q+1;R<n.length;R++){if(n[R]===void 0)debugger;n[R][w]||(n[R][w]={...m,number:0})}I||(f+=O*Math.ceil(de(w).PurchaseCost*(z?.5:J?.75:1)))}try{p.push(JSON.parse(JSON.stringify(le)))}catch{console.log(n),console.log(n[0]);debugger}q++}const ge=n[0],ye=Object.values(ge).sort((b,m)=>de(b.goal).PurchaseCost-de(m.goal).PurchaseCost).map(b=>b.goal);c=p.shift();for(const b of Object.values(ge)){const{goal:m,number:w}=b;C[m]={...b,substitutesPurchased:0,goalsPurchased:0},b.goal!=="Starter Bin"&&(K.push(qe(w,m)),M.push(qe(w,m)))}const G=new ae([],[...K,(b,m)=>m.money-b.money,(b,m)=>ve(b)-ve(m),(b,m)=>b.actionHistory.length-m.actionHistory.length,(b,m)=>b.cumulativeRerolls-m.cumulativeRerolls]),k=z?7:5,V=[{spawnInside:!0,blueprintCount:k},{spawnInside:!1,playerInside:!1,blueprintCount:k}];r||V.push({spawnInside:!1,playerInside:!0,blueprintCount:k});const Ee=[{spawnInside:!0,blueprintCount:k},{spawnInside:!1,playerInside:!0,blueprintCount:k},{spawnInside:!1,playerInside:!1,blueprintCount:k}];function Le(b,m,w){const O={...b};for(const $ of Object.values(m)){const I=$.goal;O[I]={...O[I]},I==="Copying Desk"&&(O[I].goalsPurchased+=O[I].substitutesPurchased,O[I].substitutesPurchased=0),O[I].goalsPurchased+=$.goalsPurchased,O[I].substitutesPurchased+=$.substitutesPurchased}return O}let Pe=[];function Oe(b,m,w,O=!1){var I,R,te,he,E;const $=m.fodderUsed;e:for(const S of b){let H=1+(S.achieved["Copying Desk"].goalsPurchased?1:0);const d=S.upgradesInProgress.filter(y=>y.appliance==="").length;let i=d;if(i*=H,i<0||i<$)continue;let D=[...S.upgradesInProgress];if((es||S.achieved["Research Desk"].goalsPurchased)&&(D=D.map(y=>y.upgradeTurnTimer<=1?{appliance:"",cost:0,upgradeTurnTimer:0}:{...y,upgradeTurnTimer:y.upgradeTurnTimer-1})),S.achieved.Plates.goalsPurchased+m.achieved.Plates.goalsPurchased>=2)for(let y=0;y<D.length;y++)D[y].appliance==="Plates"&&(D[y]={appliance:"",cost:0,upgradeTurnTimer:0});let U=0;{let y=m.actionHistory.length,A=!1;for(;y--;)if(m.actionHistory[y]==="buy Blueprint Cabinet")U++;else if(m.actionHistory[y].includes(" for ")){A||(U=0);break}else m.actionHistory[y].includes("reroll")&&(A=!0)}for(let y=0;y<m.achieved["Blueprint Cabinet"].goalsPurchased-U;y++)D.push({appliance:"",cost:0,upgradeTurnTimer:0});let N=S.cumulativeRerolls+m.cumulativeRerolls;if(N>pe)continue;let W=N*(N+1)/2*10+S.applianceCosts;const L=m.actionHistory.length?Le(S.achieved,m.achieved):S.achieved,X=structuredClone(L);for(const y of D)y.appliance&&(X[y.appliance]=structuredClone(X[y.appliance]),X[y.appliance].goalsPurchased--);if(m.cumulativeRerolls&&W>Y)continue;let re=[],j=0,me=1;const Ue=D.filter(y=>!y.appliance).length,we=(((I=S.achieved["Discount Desk"])==null?void 0:I.goalsPurchased)??0)+(((R=S.achieved["Discount Desk"])==null?void 0:R.substitutesPurchased)??0)?.5:1;{let y=Y-W;for(const A of ye){const _=m.achieved[A],ne=Math.ceil(de(_.goal).PurchaseCost*(z?.5:J?.75:1)*we);if(y-=(_.goalsPurchased+_.substitutesPurchased)*ne,_.substitutesPurchased){let se=vs[_.goal]??1;if(_.goal!=="Freezer"){if(_.goal==="Dish Washer"){const Z=(te=m.actionHistory.filter(Re=>Re.includes(" for Dish Washer"))[0].match(/buy (.*) for Dish Washer/))==null?void 0:te[1];if(!Z)throw"nope";se=["Dish Washer","Wash Basin","Power Sink","Soaking Sink","Sink"].indexOf(Z),se===4&&(se=3)}}if(se)for(let Z=0;Z<_.substitutesPurchased;Z++)y+=ne,re.push({appliance:_.goal,cost:ne,upgradeTurnTimer:se}),j+=se}if(y<0||_.goal==="Plates"&&L.Plates.goalsPurchased<2)for(let se=0;se<_.goalsPurchased;se++)y+=ne,re.push({appliance:_.goal,cost:ne,upgradeTurnTimer:_.goal==="Plates"?999:0})}if(re.length>Ue)continue e;for(const A of re)A.appliance&&(X[A.appliance]=structuredClone(X[A.appliance]),X[A.appliance].goalsPurchased--)}let ee;try{ee=Is(c,X)}catch{continue}if(Fe<=0&&ee>0)continue;W+=m.applianceCosts*we;let Me=0;{let y="",A=S.actionHistory.length,_=!0;for(;A--;){const Z=S.actionHistory[A].match(/^(?:spawn|reroll) (..?)/);if(!Z){S.actionHistory[A].match(/^day ..? spawn/)&&(_=!0);continue}if(_){_=!1;continue}y=Z[1][0]}let ne=0,se=!0;for(let Z=0;Z<m.actionHistory.length;Z++){Me+=ne,ne=0;const Re=m.actionHistory[Z].match(/^(?:spawn|reroll) (..?)/);if(!Re){const ns=m.actionHistory[Z].match(/take (\d+) out/);ns&&(Me+=parseInt(ns[1])/3+1);continue}Me++;const Vs=Re[1][0],ts=se?"":Re[1][1];se=!1,y&&(y[0]!==Vs&&(ne+=3),y[1]&&ts&&y[1]!==ts&&(ne+=10)),y=Re[1]}}let We=S.deskTime+(me-1)*20+Math.max(0,$-d)*5*((he=S.achieved["Clipboard Stand"])!=null&&he.goalsPurchased?.5:1)+(j*me*5+(o[m.day]??o.at(-1)??0))*((E=L["Clipboard Stand"])!=null&&E.goalsPurchased?.5:1)+Me+m.cumulativeRerolls*2;{let y=0;for(const A of re){for(;D[y].appliance;)y++;D[y]=A}for(let A=0;A<U;A++)D.push({appliance:"",cost:0,upgradeTurnTimer:0})}const Te={...m,rerollConfigs:[...S.rerollConfigs,m.rerollConfigs],achieved:L,money:Y-W,actionHistory:[...S.actionHistory,...m.actionHistory],upgradesInProgress:D,cumulativeRerolls:S.cumulativeRerolls+m.cumulativeRerolls,applianceCosts:S.applianceCosts+m.applianceCosts*we,deskTime:We};if(!(re.length>Ue)){if(Te.money>=0||Te.money+Te.upgradesInProgress.reduce((y,A)=>y+A.cost,0)>=0&&p.length){if(ee<Fe&&(Fe=ee,console.log(`best so far missing ${ee} pieces `+xe(Te,Y))),ee<=0){if(G.add(Te)){if(ss(),G.array[0].deskTime<-1e4*60){console.log("uh, can I quit from this function?");break}continue}}else if(Fe<=0)continue}if(i>T&&(T=i),O){const y=S.cumulativeRerolls;for(let A=0;A<=i;A++)Pe[A]===void 0&&(Pe[A]=new ae([],Rs)),Pe[A].add([y,W]);continue}w.add(Te)}}return Fe}const $e={...C};$e["Blueprint Cabinet"]={...$e["Blueprint Cabinet"],goalsPurchased:1};const Ne=new ae([{achieved:$e,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,rerollConfigs:[],upgradesInProgress:[{appliance:"",cost:0,upgradeTurnTimer:0}],day:0,numFloor:0,money:0,fodderAvailable:0,deskTime:0}],[...K,(b,m)=>b.applianceCosts-m.applianceCosts,(b,m)=>b.cumulativeRerolls-m.cumulativeRerolls]);let Fe=1/0,x=0,Y=0;const Q=new Ss(s),He=[];let es=!1,De=[];{const b=["Booking Desk","Blueprint Cabinet"];oe.filter(m=>b.includes(m.Name)).forEach(m=>Q.OwnedAppliances.push(m))}for(const b of e)Q.addCard(b);function Gs(b,m,w){var te,he;let O=[{...b}],$=[],I=[];const R=JSON.parse(JSON.stringify(b.achieved));for(const E of m){if(!E)continue;let S=E.Name,H=R[S],d=!1,i=H&&x>3&&H.goal==="Research Desk";if(!H||H.goalsPurchased>=(((te=n[0][S])==null?void 0:te.number)??0)||i||(he=u[E.Name])!=null&&he.some(D=>R[D]&&R[D].goalsPurchased+R[D].substitutesPurchased<n[0][D].number)&&Math.random()<.5){const D=u[E.Name],U=D&&E.Name==="Research Desk"?x>6?"Copying Desk":"Discount Desk":D==null?void 0:D[Math.floor(Math.random()*D.length)];if(H=R[U],!H)continue;d=!0,S=U}if(d&&H.goalsPurchased+H.substitutesPurchased>=n[0][S].number&&(H=R["Starter Bin"],S="Starter Bin"),!H)debugger;if(H.goalsPurchased>=(n[0][S]?n[0][S].number:9)){H=R["Starter Bin"],S="Starter Bin",d=!0;continue}S==="Table - Fancy Cloth"&&(d=!1),E.ThemeRequired&&(d=!1),d?H.substitutesPurchased++:H.goalsPurchased++;{const D=U=>{const N={...U};if(N.achieved={...N.achieved},N.numFloor--,N.achieved[S])N.achieved[S]={...N.achieved[S],goalsPurchased:N.achieved[S].goalsPurchased+(d?0:1),substitutesPurchased:N.achieved[S].substitutesPurchased+(d?1:0)};else if(N.achieved[S]={...H,goalsPurchased:d?0:1,substitutesPurchased:d?1:0},Number.isNaN(N.achieved[S].goalsPurchased))debugger;const W=S==="Starter Bin"||S==="Table - Fancy Cloth"?de(E.Name).PurchaseCost:Math.max(de(E.Name).PurchaseCost,de(S).PurchaseCost);return d?N.applianceCosts+=Math.ceil(W*(z?.5:1)):N.applianceCosts+=Math.ceil(W*(z?.5:J?.75:1)),N.actionHistory=[...N.actionHistory,`buy ${E.Name}`+(d?` for ${S}`:"")],S==="Starter Bin"&&(N.fodderPurchases=[...N.fodderPurchases],N.fodderPurchases[1]++,N.achieved[S].substitutesPurchased--),N};if(S!=="Starter Bin"){const U=O.map(D),N=$.map(D),W=I.map(D);O=U.concat(O),$=N.concat($),I=W.concat(I),U.forEach(w)}else $=$.concat(I),I=(I.length?I:O).map(D)}}return O.concat($).concat(I)}let pe=-1;{let b=t.slice(0,h).reduce((m,w)=>m+w)-f;for(;b>0;)pe++,b-=10*pe;console.log({maxCumulativeRerolls:pe,money:b,expectedMoneyByDay:t,gearMoney:f})}for(pe=Math.min(pe,3),Number.isFinite(h)||(pe=3);Fe;){let b=Ne.array;if(!b.length)return F("No Solutions"),0;Ne.clear();const m=new ae([],[...M,(d,i)=>d.cumulativeRerolls-i.cumulativeRerolls,(d,i)=>d.applianceCosts-i.applianceCosts]);if(Y+=t[x]??t.at(-1)??0,x++,x>=h)break;if(x>14&&(z||!a.length)){debugger;break}if(x>1&&b.length===0){debugger;break}b.sort((d,i)=>ve(d)-ve(i)),console.log(`fastest so far: ${xe(b[0],Y)}`),b.every(d=>d.achieved["Copying Desk"].goalsPurchased)&&(P=P.map(d=>d-1),P=P.filter(d=>d>0));let w=2;switch(x){default:w=Math.min(3,pe+1);break}let O=.5*60*1e3;const $=Math.min(w-1,1/0);if(Y>=f){const d=Math.sqrt((Y-f)/10*2);console.log(`Have ${Y} on day ${x}, need ${f} to buy everything. Allows for ~${d} rerolls across all days`)}x%5||(w=1);let I;(z||x===5||!(x%3))&&(I=a.shift());const R=Be.filter(d=>d.Name===I)[0];Q.handleNewCardSpawnEffects(R);const te=Q.getAppliances([{spawnInside:!0,blueprintCount:k}],x);let he=[];if(He.length)for(let d=He.length-1;d>=0;d--){let i=te.length;for(;i--;){const D=te[i];if(D.Name===He[d]){if(console.log(`buying ${D.Name} on day ${x}`),Y-b.reduce((N,W)=>Math.min(N,W.applianceCosts+10/2*(W.cumulativeRerolls+1)*W.cumulativeRerolls),1/0)<D.PurchaseCost*(z?.5:J?.75:1)){console.log("not enough money-- skip for now");continue}De.push(D),He.splice(d,1),Y-=D.PurchaseCost*(z?.5:J?.75:1),te.splice(i,1);break}}he=De.map(D=>`Buy ${D.Name}`)}let E=new ae([{day:x,rerollConfigs:[],achieved:{...C},numFloor:k,fodderAvailable:T,fodderUsed:0,money:Y,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,fodderPurchases:[0,0]}],[(d,i)=>Q.getPrngAdvancements(d.rerollConfigs,x)-Q.getPrngAdvancements(i.rerollConfigs,x),(d,i)=>-Q.getPrngAdvancements(d.rerollConfigs,x)+Q.getPrngAdvancements(i.rerollConfigs,x),...M,(d,i)=>d.cumulativeRerolls-i.cumulativeRerolls,(d,i)=>d.applianceCosts-i.applianceCosts,(d,i)=>i.numFloor+i.fodderAvailable-d.numFloor+d.fodderAvailable,(d,i)=>d.numFloor-i.numFloor]);Oe(b,E.array[0],Ne,!0);let S=1/0;const H=Pe.map(d=>d.array.reduce((i,[D,U])=>Math.min(i,U+E.array[0].rerollConfigs.length*(D+1)*10),1/0));e:for(;w--&&(De.length&&((ls=(as=E.array[0])==null?void 0:as.rerollConfigs)==null?void 0:ls.length)===1&&(De.some(i=>i.Name==="Research Desk")&&(es=!0),Q.OwnedAppliances.push(...De),De=[],he=[]),S=Date.now()+O,E.array[0]!==void 0);){console.log(`Seed ${s} Day ${x} Reroll ${E.array[0].rerollConfigs.length} expanding ${E.array.length} states`),console.log({minSpentMoneyByExtraBlueprints:H});const d=E.array;if(!p.length&&Fe<=0){const i=d[0].rerollConfigs.length;if(i*((i+1)/2)*10+f>Y){console.log("get me outta here!");break}}E.clear();for(const i of d){if(Date.now()>S){E.array.sort((X,re)=>-1*(X.applianceCosts-re.applianceCosts));continue e}if(i.numFloor+i.fodderAvailable===0||i.money<i.rerollConfigs.length*10)continue;let D=0;if(H[0]>i.money)continue;for(let L=1;L<H.length;L++)if(D++,H[L]>i.money){D=L-1;break}let U=$<i.rerollConfigs.length?i.numFloor:i.rerollConfigs.length?i.numFloor+Math.min(i.fodderAvailable,D-i.fodderUsed):k;{let L=i.actionHistory.length;for(;L--&&!i.actionHistory[L].includes("reroll");)if(i.actionHistory[L].includes("Starter Bin")){U=i.numFloor;break}}const N=$<i.rerollConfigs.length?i.numFloor:i.rerollConfigs.length?Math.max(1,i.numFloor):k;let W;i.rerollConfigs.length===0?W=Ee:$<i.rerollConfigs.length?W=[i.rerollConfigs.at(-1)]:W=V,Q.getAppliances([...i.rerollConfigs,{spawnInside:!0,blueprintCount:U}],i.day);for(const L of W){const X=j=>{if(!E.add(j)||!m.add(j))return;j.fodderPurchases[0]+j.fodderPurchases[1]||Oe(b,j,Ne)},re=[N];for(let j=U;j>N;j--)re.push(j);for(const j of re){const me=[...i.rerollConfigs,{...L,blueprintCount:j}],we=[...me.length===1?te:Q.getAppliances(me,i.day)].sort((We,Te)=>We.PurchaseCost-Te.PurchaseCost),ee=j-i.numFloor;if(ee>i.fodderAvailable)debugger;const Me={...i,fodderPurchases:[i.fodderPurchases[1],0],money:i.money-i.rerollConfigs.length*10,rerollConfigs:me,numFloor:me.length===1?j-De.length:j,fodderAvailable:i.fodderAvailable-ee,fodderUsed:i.fodderUsed+ee,cumulativeRerolls:i.rerollConfigs.length?i.cumulativeRerolls+1:0,actionHistory:i.rerollConfigs.length?[...i.actionHistory,`${ee?`take ${ee} out, `:""}reroll ${L.spawnInside?"I":L.playerInside?"OI":"OO"}`]:[`day ${i.day} spawn`,`spawn ${L.spawnInside?"I":L.playerInside?"OI":"OO"}`,...he]};if(X(Me),Gs(Me,we,X),Date.now()>S)break}}}}if(Q.addCard(R),Fe<=0){if(!p.length){G.array.sort((d,i)=>d.deskTime-i.deskTime),F((Fe<=0?`full build on ${s} by day ${x}: 
`:"")+G.array.map(d=>xe(d,Y)).join(`
`));break}{const d=(((rs=p[0]["Blueprint Cabinet"])==null?void 0:rs.number)??0)-(((Fs=c["Blueprint Cabinet"])==null?void 0:Fs.number)??0);if(d+P.length>2)debugger;for(let i=0;i<d;i++)P.push(15)}for(const d of Object.values(c))d.number&&Q.OwnedAppliances.push(de(d.goal));c=p.shift(),n.shift(),M=[];for(const{goal:d,number:i}of Object.values(n[0]))M.push(qe(i,d));Fe=1/0,Pe=[],ss(!0),Ne.array=G.array,G.clear(),G.objectiveFunctions}}return x;function ss(b=!1){(Math.random()<.001||b)&&G.array.sort((m,w)=>m.deskTime-w.deskTime),F(`tier ${l.length-p.length-(b?1:0)} build on ${s} by day ${x}${b?"":" (Partial)"}: 
`+G.array.slice(0,100).map(m=>xe(m,Y)).join(`
`))}}function Is(s,e){let a=0;for(const l of Object.values(s)){const t=l.number-e[l.goal].goalsPurchased-e[l.goal].substitutesPurchased;a+=Math.max(0,t)}return a}function xe(s,e){const a=s.cumulativeRerolls*(s.cumulativeRerolls+1)/2*10+s.applianceCosts;return`${s.day}: ${ve(s)} total rerolls: ${s.cumulativeRerolls}, appliance costs: ${s.applianceCosts} (money spent: ${a}/${e}), `+s.actionHistory.join(", ")+JSON.stringify(s.upgradesInProgress)}const Ge={};function Ve(s){const{starters:e,main:a,doubleOrderChance:l,desserts:r,sides:t,groupSizes:o}=s,g=[e,a,l,r,t,[...o].sort((u,T)=>u-T)].join("|");if(Ge[g])return Ge[g];let F=[0,0,0],h=[0,0,0,0],c=1-.75**t;if(e>0){F[0]=1;let u=1-.75**e;l===.5&&(u*=1.25,c*=1.25),h[0]=o.reduce((T,f)=>T+1+(f-1)*u,0)}const P=o.reduce((u,T)=>u+T);a&&(F[1]=1,h[1]=P),r>0&&(h[2]=P,a?(F[2]=1-.75**r,l===.5&&(F[2]*=1.25)):F[2]=1);let p=1;e>0&&(F[0]*=1+l,p*=1-l,h[0]*=F[0]),a&&(F[1]*=1+p*l,p*=1-l,h[1]*=F[1],h[3]=h[1]*c),r>0&&(F[2]*=1+p*l,p*=1-l,h[2]*=F[2]);const n=[F.map(u=>u*o.length),h];return Ge[g]=n,n}function As(s){const{starters:e,main:a,doubleOrderChance:l,desserts:r,sides:t,groupSizes:o}=s;let g=[0,0,0],F=[0,0,0,0],h=1-.75**e,c=1-.75**r,P=1-.75**t;l===.5&&(h*=1.25,c*=1.25,P*=1.25);const p=f=>{g[0]++,F[0]++;for(let C=0;C<f-1;C++)Math.random()<h&&F[0]++},n=f=>{g[1]++,F[1]+=f;for(let C=0;C<f;C++)Math.random()<P&&F[3]++},u=f=>{g[2]++,F[2]+=f};for(const f of o){let C=!1;e>0&&(p(f),!C&&Math.random()<l&&(C=!0,p(f))),n(f),!C&&Math.random()<l&&(C=!0,n(f)),r>0&&Math.random()<c&&(u(f),!C&&Math.random()<l&&(C=!0,u(f)))}return[g,F]}const xs={"Diner (1)":1,"Small (2)":2,"Medium (2)":2,"Large (3)":3,"Huge (4)":4},Qe={};["Morning Rush","Lunch Rush","Dinner Rush"].forEach(s=>Qe[s]=!0);class Es{constructor(e,a=[],l=[]){B(this,"seed");B(this,"mapSize");B(this,"frontDoor");B(this,"startingCards");B(this,"cards");B(this,"playerCount");B(this,"turbo");B(this,"_actionInfoCacheByCards",{});B(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=a,this.cards=l,this.playerCount=xs[this.mapSize],this.turbo=this.startingCards.some(r=>{if(r===void 0){console.log({startingCards:a});debugger}return r.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let r=!1,t=!1,o=0,g=[],F=[],h=0,c=[],P=0,p=[];for(const M of a)switch(M.Name==="All You Can Eat"&&(r=!0),M.Name==="Double Helpings"&&(t=!0),M.DishType){case v.Dessert:h++,M.DishValue&&c.push(M.DishValue);break;case v.Starter:M.DishValue&&g.push(M.DishValue),o++;break;case v.Side:M.DishValue&&p.push(M.DishValue),P++;break;case v.Main:case v.Base:M.Name==="Tacos"?(F.push(2),F.push(3)):M.DishValue&&F.push(M.DishValue)}let n=t?.5:r?.25:0,u=[0,0,0,0];if(u[0]=ce(g),u[1]=ce(F),u[2]=ce(c),u[3]=ce(p),t)for(let M=0;M<3;M++)u[M]&&(u[M]+=3);const[T,f]=Ve({starters:o,main:!!u[1],doubleOrderChance:n,desserts:h,sides:P,groupSizes:l});let C=0;for(let M=0;M<f.length;M++)C+=f[M]*u[M];const z=Ze(this.playerCount),J=this.getBookingDeskCount(e),K=this.getBookingDeskMoney(e);return Math.ceil(z*(C+J*K))}courseInfo(e){if(e===0)return[[0,0,0],[0,0,0,0]];const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let r=!1,t=!1,o=0,g=[],F=[],h=0,c=[],P=0,p=[];for(const f of a)switch(f.Name==="All You Can Eat"&&(r=!0),f.Name==="Double Helpings"&&(t=!0),f.DishType){case v.Dessert:h++,f.DishValue&&c.push(f.DishValue);break;case v.Starter:f.DishValue&&g.push(f.DishValue),o++;break;case v.Side:f.DishValue&&p.push(f.DishValue),P++;break;case v.Main:case v.Base:if(!f.isMain){h++,f.DishValue&&c.push(f.DishValue);break}f.Name==="Tacos"?(F.push(2),F.push(3)):f.DishValue&&F.push(f.DishValue)}let n=t?.5:r?.25:0,u=[0,0,0,0];if(u[0]=ce(g),u[1]=ce(F),u[2]=ce(c),u[3]=ce(p),t)for(let f=0;f<3;f++)u[f]&&(u[f]+=3);return Ve({starters:o,main:!!u[1],doubleOrderChance:n,desserts:h,sides:P,groupSizes:l})}actionInfo(e){if(e===0)return 0;const a=this.getCardsByDay(e),l=e.toString()+":"+a.map(k=>k.Name).sort().join(","),r=this._actionInfoCacheByCards[l];if(r)return r;let t=0;const o={Breakfast:6,Dumplings:11.25,"Stir Fry":26/2,Steak:7};let g=0;for(let k=0;k<a.length;k++)if(a[k].DishType!==v.Null){const V=a[k].Name;g=o[V]??20;break}let F=-1,h=[1,1,1],c=[[],[g],[],[]],P=0;const p=this.getGroupSizes(e);let n=!1,u=!1,T=0,f=[],C=[],z=0,J=[],K=0,M=[],q=!1,le=!1;for(const k of a){switch(k.Name==="All You Can Eat"&&(n=!0),k.Name==="Double Helpings"&&(u=!0),k.Name){case"Picky Eaters":q=!0;break;case"Leisurely Eating":le=!0,P+=2;break;case"Instant Service":for(let V=0;V<3;V++)h[V]--;break;case"Ice Cream":c[2].push(5.125);break;case"Cheese Board":c[2].push(10);break;case"Cherry Pie":c[2].push(11);break;case"Apple Pies":c[2].push(15);break;case"Pumpkin Pies":c[2].push(16);break;case"Carrot Soup":case"Meat Soup":c[0].push(7);break;case"Tomato Soup":case"Pumpkin Soup":h[0]=4,c[0].push(8);break;case"Broccoli Cheese Soup":c[0].push(5),h[0]=4;break;case"Pumpkin Seed":c[0].push(3*8);break;case"Bread":c[0].push(5*3);break;case"Mandarin Starter":c[0].push(7*3);break;case"Mashed Potato":case"Broccoli":case"Bamboo":c[3].push(2);break;case"Onion Rings":c[3].push(8);break;case"Corn on the Cob":c[3].push(6);break;case"Chips":c[3].push(7);break;case"Roast Potato":c[3].push(4);break}switch(k.DishType){case v.Dessert:z++,k.DishValue&&J.push(k.DishValue);break;case v.Starter:k.DishValue&&f.push(k.DishValue),T++;break;case v.Side:k.DishValue&&M.push(k.DishValue),K++;break;case v.Main:case v.Base:k.Name==="Tacos"?(C.push(2),C.push(3)):k.DishValue&&C.push(k.DishValue);break;case v.Extra:k.Name==="Seaweed"?(c[1][0]+=1.75,F+=2):k.Name==="Dumpling - Soy Sauce"?c[1][0]+=.4:k.Name==="Breakfast Beans"?c[1][0]+=1+3/4:k.Name==="Breakfast Eggs"?c[1][0]+=6:k.Name==="Breakfast Extras"&&(F++,c[1][0]+=1.5*2),F++;break}}e>6&&(c[3]=[]),q&&(le&&!n||(c[1][0]+=2,F++));let ge=u?.5:n?.25:0;t+=p.length*P;const[ye,G]=Ve({starters:T,main:!0,doubleOrderChance:ge,desserts:z,sides:K,groupSizes:p});ye.forEach((k,V)=>t+=k*h[V]);for(const k of c)for(let V=0;V<k.length;V++)F>0&&(k[V]+=F),F+=1;return G.forEach((k,V)=>{var Ee;if((Ee=c[V])!=null&&Ee.length){if(!V){const Le=Math.ceil(k/c[V].length/3);t+=Le*c[V].reduce((Pe,Oe)=>Pe+Oe,0);return}t+=k*ce(c[V])}}),this._actionInfoCacheByCards[l]=t,t}simulateMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let r=!1,t=!1,o=[[],[],[],[]];for(const T of a)switch(T.Name==="All You Can Eat"&&(r=!0),T.Name==="Double Helpings"&&(t=!0),T.DishType){case v.Main:case v.Base:T.Name==="Tacos"?o[1].push(2.5):T.DishValue&&o[1].push(T.DishValue);break;case v.Dessert:T.DishValue&&o[2].push(T.DishValue);break;case v.Starter:T.DishValue&&o[0].push(T.DishValue);break;case v.Side:T.DishValue&&o[3].push(T.DishValue);break}let g=t?.5:r?.25:0,F=0;t&&(F+=3);const[h,c]=As({starters:o[0].length,main:!!o[1].length,doubleOrderChance:g,desserts:o[2].length,sides:o[3].length,groupSizes:l});let P=0;for(let T=0;T<c.length;T++){let f=c[T];for(;f--;){T<3&&(P+=F);let C=o[T][Math.floor(Math.random()*o[T].length)];C%1&&(Math.random()<C%1?C=Math.ceil(C):C=Math.floor(C)),P+=C}}const p=Ze(this.playerCount),n=this.getBookingDeskCount(e),u=this.getBookingDeskMoney(e);return Math.ceil(p*(P+n*u))}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}clearCardsCache(){this._cardsByDay=[]}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let a;this.turbo?a=e-1:(a=Math.max(0,Math.floor((e-1)/3)),e>5&&a++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,a)]}return this._cardsByDay[e]}getBookingDeskCount(e,a=1){const l=Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e));if(this.getCardsByDay(e).some(h=>h.Name==="Herd Mentality"))return Math.min(l,3)+1;const r=[],t=this.getCardsByDay(e);let o=1;(this.turbo||t.some(h=>h.Name==="Morning Rush"))&&r.push(.2),(this.turbo||t.some(h=>h.Name==="Lunch Rush"))&&r.push(.5),(this.turbo||t.some(h=>h.Name==="Dinner Rush"))&&r.push(.8);const g=a/(this.playerCount||2)/this.getDayLength(e),F=.1/l;o+=l-1;for(let h=1;h<l;h++){const c=h/l,P=c-F-g,p=c+F+g;for(let n=r.length-1;n>=0;n--){const u=r[n];P<=u&&u<=p&&r.splice(n,1)}}return o+=r.length,o}getNonRushGroupCount(e){const a=this.getExpectedCustomers(e),l=this.getCardsByDay(e).filter(o=>o.Name==="Closing Time?").length*.2,r=this.getExpectedGroupSize(e),t=a*(1+l)/r;return Math.ceil(t)}getCustomerCount(e){return this.getGroupSizes(e).reduce((a,l)=>a+l,0)}getGroupSizes(e){const a=this.seed?Ke(1997821,e,this.seed).random:new ze(Math.floor(Math.random()*4294967295)),l=this.getNonRushGroupCount(e),r=this.getCardsByDay(e).some(p=>p.Name==="Herd Mentality");let t=l,o=[],[g,F]=this.getGroupSizeRange(e);!this.seed||this.seed==="_min"?F=g:this.seed==="_max"&&(g=F);{let p=t-1;for(;p--;)a.value}for(;t--;)o.push(a.range(g,F+1)),!r&&t!==l-1&&a.value;let h=this.turbo?3:this.getCardsByDay(e).filter(p=>Qe[p.Name]).length;const c=Math.ceil(Math.max(1,this.getExpectedCustomers(e)*.15));let P=h*c;for(;P--;)o.push(a.range(g,F+1));if(!this.seed||this.seed[0]==="_"){let p=g;for(let n=0;n<o.length;n++)o[n]=p,p++,p>F&&(p=g)}return o}getExpectedGroupSize(e){const a=this.getGroupSizeRange(e);return(a[0]+a[1])/2}getGroupSizeRange(e){let a=1,l=2;for(const r of this.getCardsByDay(e))switch(r.Name){case"Individual Dining":l--;break;case"Medium Groups":a++,l+=2;break;case"Large Groups":a+=2,l+=2;break;case"Flexible Dining":a--,l++;break;case"Community":const t=Math.floor((e-1)/3);a+=t,l+=t;break}return[a,l]}getExpectedCustomers(e){const a=this.getReductions(e),l=this.getDayLength(e),r=this.getPlayerModifier(),t=this.getCourseModifier(e),o=this.getDayRate(e),g=this.getCustomersPerHour(e),F=this.getAdvertisingModifier(e);return .85**a*(l/25*o*r)/t*g*F}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(l=>l.Name==="Advertising").length}getDayRate(e){let a=1;switch(e){case 1:a=1.25;break;case 2:a=1.5;break;default:a=1.5+.15*(e-3);break}return e>15&&(a+=(this.turbo?.1:0)*(e-15)**1.5),a}getCourseModifier(e){let a=1;const l=this.getCardsByDay(e);return l.some(r=>r.DishType===v.Dessert||r.Name==="Black Coffee"||r.Name==="Cakes")&&(a+=.25),l.some(r=>r.DishType===v.Starter)&&(a+=.25),a}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let a=1;return this.turbo&&(a=1.5,a*=1+e/10),a}getReductions(e){return this.getCardsByDay(e).reduce((l,r)=>l+r.CustomerMultiplier,0)}getMapSize(){const a=new Se(this.seed,5078598).useSubcontext(0).random.range(0,8);let l;switch(a){case 0:l="Small (2)";break;case 4:l="Medium (2)";break;case 1:case 5:l="Diner (1)";break;case 2:case 6:l="Large (3)";break;case 3:case 7:l="Huge (4)";break;default:throw new Error}return l}getLayoutInfo(){const a=new Se(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,r;switch(a){case 0:r=70,l=2;break;case 4:r=84,l=2;break;case 1:case 5:r=60,l=1;break;case 2:case 6:r=9*13,l=3;break;case 3:case 7:r=12*16,l=4;break;default:throw new Error}return[l,r]}getDoorInfo(){if(this.mapSize!=="Diner (1)")return-1;let e=new ze(new Se(this.seed,98234234).useSubcontext(0).random.value),a=23;for(;a--;)e.value;return e.range(0,4)}}function Ze(s){switch(s){case 1:return 1.25;case 2:return 1.1;default:return 1}}function Os(s,e,a,l){let r=[],t=[],o=[];const g=s.cards.slice(e);let F=new Es(s.seed,a,g);F.playerCount=l;for(let h=1;h<=15;h++)o.push(F.getCustomerCount(h)),r.push(F.guessMoney(h)),t.push(F.getBookingDeskCount(h));return r[0]+=F.guessMoney(0),{expectedMoneyByDay:r,expectedBookingDesksByDay:t,expectedCustomersByDay:o}}var Xe=self;function Hs(s){Xe.postMessage(s)}const zs=["Copying Desk","Blueprint Cabinet","Clipboard Stand","Research Desk"],qs=[{goal:"Copying Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Blueprint Cabinet",number:8,substitutes:[],skipMissing:!0},{goal:"Clipboard Stand",number:1,substitutes:[],skipMissing:!0},{goal:"Research Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Dining Table",number:3,substitutes:[],skipMissing:!0},{goal:"Dish Rack",number:1,substitutes:[],skipMissing:!0},{goal:"Starter Bin",number:999,substitutes:oe.filter(s=>!s.ThemeRequired&&!zs.includes(s.Name)).map(s=>s.Name),skipMissing:!0}];Xe.onmessage=s=>{let{config:e,tiers:a,playerCount:l,maxDay:r=15}=s.data;for(const n of a)for(const u of n){const T=oe.filter(f=>f.Name===u.goal)[0];T.ThemeRequired&&(u.substitutes=oe.filter(f=>f.ThemeRequired===T.ThemeRequired).map(f=>f.Name))}for(;!a.at(-1).length;)a.pop();const t=[...qs],o=a.flatMap(n=>n.flatMap(u=>[u.goal,...u.substitutes])),g=t.length-1;t[g].substitutes=t[g].substitutes.filter(n=>!o.some(u=>n===u)),a[a.length-1].push(...t);const F=e.cards.filter(n=>Je.some(u=>u.Name===n.Name)).length+1,h=e.cards.slice(0,F);let{expectedMoneyByDay:c,expectedBookingDesksByDay:P,expectedCustomersByDay:p}=Os(e,F,h,l);ws(e.seed,h,e.cards.slice(F).map(n=>n.Name),a,e.solo,c,P,p,Hs,r)}})();
