var Ws=Object.defineProperty;var Ks=(J,ee,ue)=>ee in J?Ws(J,ee,{enumerable:!0,configurable:!0,writable:!0,value:ue}):J[ee]=ue;var C=(J,ee,ue)=>Ks(J,typeof ee!="symbol"?ee+"":ee,ue);(function(){"use strict";class J{constructor(e,a){C(this,"array");C(this,"objectiveFunctions");this.array=ee(e,a),this.objectiveFunctions=a}clear(){this.array=[]}add(e){let a=this.array.length;for(;a--;){let{better:l,worse:F}=ue(e,this.array[a],this.objectiveFunctions);if(F)return!1;l&&this.array.splice(a,1)}return this.array.push(e),!0}}function ee(s,e){if(!s.length)return s;const a=[...s];let l=[];l.push(a.pop());e:for(;a.length;){const F=a.pop();let t=l.length;for(;t--;){let{better:n,worse:h}=ue(F,l[t],e);if(h)continue e;n&&l.splice(t,1)}l.push(F)}return l}function ue(s,e,a){let l=!0,F=!0,t=0;for(;(l||F)&&t<a.length;){const n=a[t](s,e);n<0?F=!1:n>0&&(l=!1),t++}return{better:l,worse:F}}var fs=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False,False,60
...
`;const gs=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing","AllowRefreshes","PurchaseCost"],ps=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean","boolean","number"],Se=fs.trim().split(/\r\n|\n/).map(s=>{const e=s.split(",");let a={};for(let l=0;l<e.length;l++){let F;switch(ps[l]){case"number":F=Number(e[l]);break;case"boolean":F=e[l]==="True";break;case"number[]":e[l]===""?F=[]:F=e[l].split(":").map(t=>Number(t));break;default:F=e[l]}a[gs[l]]=F}return a});class ms{constructor(e){C(this,"Staple");C(this,"Tags");C(this,"StapleWhenMissing");C(this,"Appliance");C(this,"IsRemoved");C(this,"Filter");C(this,"DecorationRequired");C(this,"SellAsUpgrade");this.Appliance=e,this.Tags=e.ShoppingTags,this.DecorationRequired=e.ThemeRequired,this.SellAsUpgrade=e.IsPurchasableAsUpgrade,this.Filter=e.ShopRequirementFilter,this.StapleWhenMissing=e.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(e){return e&1?this.Staple!==0:e&this.Tags?this.Staple===0:!1}}var se=(s=>(s[s.NonStaple=0]="NonStaple",s[s.FixedStaple=1]="FixedStaple",s[s.BonusStaple=2]="BonusStaple",s[s.WhenMissing=3]="WhenMissing",s))(se||{}),ce=(s=>(s[s.None=0]="None",s[s.Basic=1]="Basic",s[s.Decoration=2]="Decoration",s[s.Technology=4]="Technology",s[s.FrontOfHouse=8]="FrontOfHouse",s[s.Plumbing=16]="Plumbing",s[s.Cooking=32]="Cooking",s[s.Automation=64]="Automation",s[s.Christmas=128]="Christmas",s[s.Misc=256]="Misc",s[s.Office=512]="Office",s[s.BlueprintUpgrader=1024]="BlueprintUpgrader",s[s.BlueprintStore=2048]="BlueprintStore",s[s.Halloween=4096]="Halloween",s[s.SpecialEvent=8192]="SpecialEvent",s))(ce||{});const Ye={DefaultShoppingTag:892};var Je=(s=>(s[s.None=0]="None",s[s.RefreshableProvider=1]="RefreshableProvider",s))(Je||{}),Re=(s=>(s[s.Null=0]="Null",s[s.Exclusive=1]="Exclusive",s[s.Affordable=2]="Affordable",s[s.Charming=4]="Charming",s[s.Formal=8]="Formal",s[s.Kitchen=16]="Kitchen",s))(Re||{}),Ts="39";const bs=Number(Ts);function Cs(s,e){return Math.floor(Math.random()*(e-s))+s}function Ss(s,e){let a=s.length;for(;a-- >1;){let l=e===void 0?Cs(0,a+1):e.range(0,a+1);[s[a],s[l]]=[s[l],s[a]]}return s}const ys="1c,1d,1e,1f,1g,1h,1i,1j,1k,1l,1m,1n,1o,1p,1q,1r,1s,1t,1u,1v,1w,1x,1y,1z,13,14,15,16,17,18,19,2c,2d,2e,2f,2g,2h,2i,2j,2k,2l,2m,2n,2o,2p,2q,2r,2s,2t,2u,2v,2w,2x,2y,2z,23,24,25,26,27,28,29,3c,3d,3e,3f,3g,3h,3i,3j,3k,3l,3m,3n,3o,3p,3q,3r,3s,3t,3u,3v,3w,3x,3y,3z,33,34,35,36,37,38,39,4c,4d,4e,4f,4g,4h,4i,4j,4k,4l,4m,4n,4o,4p,4q,4r,4s,4t,4u,4v,4w,4x,4y,4z,43,44,45,46,47,48,49,5c,5d,5e,5f,5g,5h,5i,5j,5k,5l,5m,5n,5o,5p,5q,5r,5s,5t,5u,5v,5w,5x,5y,5z,53,54,55,56,57,58,59,6c,6d,6e,6f,6g,6h,6i,6j,6k,6l,6m,6n,6o,6p,6q,6r,6s,6t,6u,6v,6w,6x,6y,6z,63,64,65,66,67,68,69,7c,7d,7e,7f,7g,7h,7i,7j,7k,7l,7m,7n,7o,7p,7q,7r,7s,7t,7u,7v,7w,7x,7y,7z,73,74,75,76,77,78,79,8c,8d,8e,8f,8g,8h,8i,8j,8k,8l,8m,8n,8o,8p,8q,8r,8s,8t,8u,8v,8w,8x,8y,8z,83,84,85,86,87,88,89".split(",");for(const s of ys);function we(s){return s.length?s.reduce((e,a)=>e+a,0)/s.length:0}class he{constructor(e,a){C(this,"fixedSeed");C(this,"instance");C(this,"random");typeof e=="string"&&(e=ks(e)),this.fixedSeed=e,this.instance=a,this.random=new Qe(e+Math.imul(124192293,a))}useSubcontext(e){return new he(this.fixedSeed,124192293*e+this.instance)}}class Qe{constructor(e){C(this,"seed");const a=h=>Math.imul(1812433253,h)+1>>0,l=e>>0,F=a(l),t=a(F),n=a(t);this.seed=[l,F,t,n]}get value(){let e=this.seed.shift(),a=this.seed[2];return e^=e<<11,e^=e>>>8,a^=a>>>19,a=(a^e)>>0,this.seed.push(a),a}range(e,a){return(this.value>>>0)%(a-e)+e}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(e){return e[this.range(0,e.length)]}}function ks(s){const a=new TextEncoder().encode(s);let l=5381,F=a.length;for(;F--;)l=(l<<5)+l+a[F];return l>>0}function Ze(s,e,a){return new he(a,s*1231231+e)}var de=(s=>(s[s.Generic=0]="Generic",s[s.Dish=1]="Dish",s[s.PrimaryTheme=3]="PrimaryTheme",s[s.SecondaryTheme=4]="SecondaryTheme",s[s.Franchise=5]="Franchise",s[s.Special=6]="Special",s))(de||{}),x=(s=>(s[s.Base=0]="Base",s[s.Main=1]="Main",s[s.Extra=2]="Extra",s[s.Side=3]="Side",s[s.Starter=4]="Starter",s[s.Dessert=5]="Dessert",s[s.Null=6]="Null",s))(x||{});const Ps=["Sink","Plates","Dish Rack","Dish Washer","Power Sink","Soaking Sink","Auto Plater"],Xe={};for(const s of Ps)Xe[s]=!0;const vs=Se.filter(s=>s.IsPurchasable||s.IsPurchasableAsUpgrade).length;class Ds{constructor(e,a=0,l=!1){C(this,"seed");C(this,"mapSize");C(this,"numTiles");C(this,"baseUpgradeChance");C(this,"januaryRedEnvelopes");C(this,"OwnedAppliances");C(this,"Cards");C(this,"Theme");C(this,"cache",new Map);C(this,"cacheDay");this.seed=e,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=a,this.januaryRedEnvelopes=l,this.OwnedAppliances=[],this.Cards=[],this.Theme=Re.Null,this.cacheDay=-1}getLayoutInfo(){const a=new he(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,F;switch(a){case 0:F=70,l=2;break;case 4:F=84,l=2;break;case 1:case 5:F=60,l=1;break;case 2:case 6:F=9*13,l=3;break;case 3:case 7:F=12*16,l=4;break;default:throw new Error}return[l,F]}handleNewCardSpawnEffects(e){e!==void 0&&(e.Name==="Turbo"&&(this.baseUpgradeChance=.25),e.ID===507410699&&(this.januaryRedEnvelopes=!0),e.UnlockGroup===de.PrimaryTheme&&(this.Theme=Re[e.Name]))}handleNewCardRerollEffects(e){e!==void 0&&(this.OwnedAppliances=this.OwnedAppliances.concat(e.IngredientProviders.flatMap(a=>Se.filter(l=>l.ID===a))))}addCard(e){e!==void 0&&(this.handleNewCardSpawnEffects(e),this.handleNewCardRerollEffects(e),this.Cards.push(e))}getPrngAdvancements(e,a){let l=0;for(let F=0;F<e.length;F++){const t=e[F];let n=t.blueprintCount;a%5===0&&(n+=3,F===0&&(n+=2)),l+=n*(vs-1+1),t.spawnInside||(l+=Ms(t.playerInside,this.numTiles)),l+=bs}return l}buildShopOptions(e,a,l){const F=l.some(h=>h.Name==="Couples");let t=[];for(const h of Se)if(!(!h.IsPurchasable&&!h.IsPurchasableAsUpgrade)){var n=new ms(h);const f=n.Appliance.Name;(n.Staple==se.NonStaple||n.Staple==se.WhenMissing)&&((n.Tags&ce.Basic)>ce.None?n.Staple=se.FixedStaple:n.StapleWhenMissing?(f!="Research Desk"&&f!="Blueprint Cabinet"&&f!="Plates"&&console.log(`Unexpected ${f} StapleWhenMissing Appliance`),e.some(i=>i.ID===n.Appliance.ID)?n.Staple=se.NonStaple:n.Staple=se.WhenMissing):F&&f==="Flower Pot"&&(n.Staple=se.BonusStaple));const u=n.Appliance;if(u.SellOnlyAsDuplicate)e.some(i=>i.ID===u.ID)||(n.IsRemoved=!0);else if(u.RequiresForShop.length>0){let i=!1;for(const m of u.RequiresForShop)e.some(k=>k.ID===m)&&(i=!0);n.IsRemoved=!i}else u.SellOnlyAsUnique&&(u.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${u.Name}, ${u.ID}`),e.some(i=>i.ID===u.ID)&&(n.IsRemoved=!0));Xe[f]&&l.every(i=>!i.isMain||i.Name==="Tacos")&&(n.IsRemoved=!0),n.Filter==Je.RefreshableProvider&&(e.some(i=>i.AllowRefreshes)||(n.IsRemoved=!0)),n.DecorationRequired!=Re.Null&&n.DecorationRequired!=a&&(n.IsRemoved=!0),u.RequiresProcessForShop.length>0&&(u.RequiresProcessForShop.some(i=>l.some(m=>m.RequiredProcesses.includes(i)))||(n.IsRemoved=!0)),t.push(n)}return t}initRandom(e){return Ze(823828,e,this.seed)}getAppliances(e,a){a!==this.cacheDay&&(this.cacheDay=a,this.cache.clear());const l=e.length===1,F=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards);let t=e[e.length-1].blueprintCount,n;if(a%5==0){l?t=10:t+=3,n=[];for(let u=0;u<t;u++)n[u]=ce.Decoration;if(l)for(const u of[1,2])n[n.length-u]=ce.SpecialEvent}else if(e.length>1){n=[];for(let u=0;u<t;u++)n[u]=Ye.DefaultShoppingTag}else{const u=Ye.DefaultShoppingTag,i=Math.max(1,t),m=Math.max(0,Math.min(F.filter(g=>g.Staple!==se.NonStaple&&!g.IsRemoved).length,Math.max(2,4-Math.floor(a/5)),i)),k=Math.max(0,i-m);t=i,n=[];for(let g=0;g<m;g++)n[g]=ce.Basic;for(let g=m;g<m+k;g++)n[g]=u}const h=this.initRandom(a).random;let o=this.getPrngAdvancements(e.slice(0,e.length-1),a);if(this.cache.has(o)&&this.cache.get(o).length>=t)return this.cache.get(o).slice(0,t);const f=o;for(;o--;)h.value;{const u=[...F],i=[],m=this.getUpgradeChance(a),k=[];for(let g=0;g<t;g++){const T=n[g],v=h.valueFloat<m;Ss(u,h);for(let j=0;j<u.length;j++){const H=u[j];if(H.IsRemoved||k.includes(H.Appliance)||!H.MatchesRequestTags(T)||!v&&H.Staple==se.NonStaple&&H.SellAsUpgrade)continue;T!=ce.Decoration&&k.push(H.Appliance),i[g]=H.Appliance;break}i[g]==null}return this.cache.set(f,i),i}}getUpgradeChance(e){let a=1-(1-Math.floor(e/5)*.1)*(1-this.baseUpgradeChance);return this.januaryRedEnvelopes&&(a=a+(1-a)*.2),a}}function Ms(s,e){return s?e-2:e-1}var Bs=`373996608,Ice Cream,1,,934171642,,-1533430406,False,False,5,1,1,1,0,0
...
`;const Pe=Bs.trim().split(/\r\n|\n/).filter(s=>s).map(s=>{var ye,ne;const[e,a,l,F,t,n,h,o,f,u,i,m,k,g,T]=s.split(","),b=Number(e),v=Number(l),j=F!=null&&F.length?F.split(":").map(E=>Number(E)):[],H=t.length?t.split(":").map(E=>Number(E)):[],K=n!=null&&n.length?(ye=n==null?void 0:n.split(":"))==null?void 0:ye.map(E=>Number(E)):[],S=h!=null&&h.length?(ne=h==null?void 0:h.split(":"))==null?void 0:ne.map(E=>Number(E)):[],Fe=o==="True",Z=f==="True",_=Number(u),Ae=Number(i),je=Number(m),xe=k==="1",fe=Number(g);return{ID:b,Name:a,UnlockGroup:v,Requires:j,BlockedBy:H,RequiredProcesses:K,IngredientProviders:S,isMain:Fe,isStarterOrSide:Z,DishType:_,CustomerMultiplier:Ae,DishValue:je,IsUnlockable:xe,MinimumFranchiseTier:fe,IsSpecificFranchiseTier:T==="1"}}),ws=[...[{ID:447437163,Name:"Country",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:x.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1},{ID:2002876295,Name:"City",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:x.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1},{ID:-1864906012,Name:"Alpine",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:x.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1},Pe.filter(s=>s.Name==="Community")[0],Pe.filter(s=>s.Name==="Couples")[0],{ID:1958825350,Name:"Turbo",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:x.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1},Pe.filter(s=>s.Name==="Christmas Rush")[0],{ID:507410699,Name:"January",UnlockGroup:de.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:x.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1}]].sort((s,e)=>s.Name<e.Name?-1:1);["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey","Fajitas","Sundaes"].map(s=>Pe.filter(e=>e.Name===s)[0]),Rs.trim().split(/\r\n|\n/).filter(s=>s).map(s=>{var K,S;const[e,a,l,F,t,n,h,o,f,u]=s.split(","),i=Number(e),m=Number(l),k=F!=null&&F.length?(K=F==null?void 0:F.split(":"))==null?void 0:K.map(Fe=>Number(Fe)):[],g=t!=null&&t.length?(S=t==null?void 0:t.split(":"))==null?void 0:S.map(Fe=>Number(Fe)):[],T=n==="True",b=h==="True",v=Number(o),j=Number(f),H=Number(u);return{ID:i,Name:a,UnlockGroup:m,Requires:[],BlockedBy:[],RequiredProcesses:k,IngredientProviders:g,isMain:T,isStarterOrSide:b,DishType:v,CustomerMultiplier:j,DishValue:H,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1}}).sort((s,e)=>s.Name<e.Name?-1:1);const Is=[7,8,8,8,8,10,10,8,9,9,9,10,9,10,10],Ns=[122,143,159,169,169,215,215,218,240,252,252,288,263,300,300],Ie={};function le(s){return Ie[s]===void 0&&(Ie[s]=Se.filter(e=>e.Name===s)[0]),Ie[s]===void 0&&console.error(`Could not find ${s} appliance`),Ie[s]}const As=[(s,e)=>s[0]-e[0],(s,e)=>s[1]-e[1]];function ve(s){let e=0;(s==null?void 0:s.deskTime)!==void 0&&(e+=s.deskTime);for(const a of Object.values(s.achieved))e+=s.cumulativeRerolls*2,e+=s.actionHistory.filter(l=>l==="spawn OI"||l==="spawn OO").length*3,e+=s.actionHistory.reduce((l,F)=>{var t;return F.includes("take ")?l+3+Number((t=F.match(/(\d+)/))==null?void 0:t[0]):l},0),e+=a.goalsPurchased+a.substitutesPurchased;return e}function qe(s,e){return(a,l)=>{const F=a.achieved[e],t=l.achieved[e],n=Math.min(F.goalsPurchased,s);let o=Math.min(t.goalsPurchased,s)-n;return o===0?F.goalsPurchased>=s||F.goalsPurchased+F.substitutesPurchased>=s&&t.goalsPurchased+t.substitutesPurchased>=s?F.goalsPurchased+F.substitutesPurchased-(t.goalsPurchased+t.substitutesPurchased):t.substitutesPurchased-F.substitutesPurchased:o}}const es={"Copying Desk":3,"Metal Table":4,"Power Sink":4,"Dish Washer":4,"Wash Basin":4,"Soaking Sink":4,"Heated Mixer":3,"Conveyor Mixer":3,"Rapid Mixer":3,"Danger Hob":2,"Safety Hob":2,"Grabber - Rotating":2,"Smart Grabber":2};function xs(s,e,a,l,F=!0,t=Ns,n=Is,h=()=>{}){var ns,rs,ts,is;let o={},f=[];const u=[],i=new Array(l.length).fill(0).map(()=>({})),m={};let k=0,g=0;const T={},b=e.some(p=>p.Name==="Turbo"),v=[];let j=[],H=0;const K={};for(const p of l){for(const d of p){const{goal:D,number:I,substitutes:A,skipMissing:P=!1}=d;for(const R of A)m[R]=D;K[D]?P||(K[D].number+=I):(K[D]={...d},P&&(K[D].number=0));for(let R=0;R<=H;R++){if(i[R]===void 0)debugger;i[R][D]?i[R][D].number+=I:i[R][D]={...d}}for(let R=H+1;R<i.length;R++){if(i[R]===void 0)debugger;i[R][D]||(i[R][D]={...d,number:0})}P||(g+=le(D).PurchaseCost*I*(b?.5:1))}try{u.push(JSON.parse(JSON.stringify(K)))}catch{console.log(i),console.log(i[0]);debugger}H++}const S=i[0],Fe=Object.values(S).sort((p,d)=>le(p.goal).PurchaseCost-le(d.goal).PurchaseCost).map(p=>p.goal);o=u.shift();for(const p of Object.values(S)){const{goal:d,number:D}=p;T[d]={...p,substitutesPurchased:0,goalsPurchased:0},p.goal!=="Starter Bin"&&(v.push(qe(D,d)),j.push(qe(D,d)))}const Z=new J([],[...v,(p,d)=>d.money-p.money,(p,d)=>ve(p)-ve(d),(p,d)=>p.actionHistory.length-d.actionHistory.length,(p,d)=>p.cumulativeRerolls-d.cumulativeRerolls,(p,d)=>(p.day+1)%5?p.upgradesInProgress-d.upgradesInProgress:0]),_=b?7:5,Ae=[{spawnInside:!0,blueprintCount:_},{spawnInside:!1,playerInside:!1,blueprintCount:_}];F||Ae.push({spawnInside:!1,playerInside:!0,blueprintCount:_});const je=[{spawnInside:!0,blueprintCount:_},{spawnInside:!1,playerInside:!0,blueprintCount:_},{spawnInside:!1,playerInside:!1,blueprintCount:_}];function xe(p,d,D){const I={...p};for(const A of Object.values(d)){const P=A.goal;I[P]={...I[P]},P==="Copying Desk"&&(I[P].goalsPurchased+=I[P].substitutesPurchased,I[P].substitutesPurchased=0),I[P].goalsPurchased+=A.goalsPurchased,D&&(I[P].substitutesPurchased+=A.substitutesPurchased)}return I}let fe=[];function Ve(p,d,D,I=!1){var U,M,w,$,Y,c,r,N,ae,pe,Q,O,me,Te,G,re,Ue,Oe,te,De;const A=d.fodderUsed,P=Object.values(d.achieved).some(y=>y.substitutesPurchased)&&!((U=d.achieved["Research Desk"])!=null&&U.goalsPurchased),R=d.actionHistory.at(-1)==="buy Blueprint Cabinet"&&((M=d.actionHistory.at(-2))!=null&&M.includes("reroll"))?1:0;e:for(const y of p){if(P&&!ls&&!((w=y.achieved["Research Desk"])!=null&&w.goalsPurchased))continue;let $e=1+(y.achieved["Copying Desk"].goalsPurchased?1:0);const os=y.achieved["Blueprint Cabinet"].goalsPurchased;let ie=os;if(ie-=f.length,ie-=y.upgradesInProgress,ie*=$e,ie<0||ie<A)continue;let us=y.cumulativeRerolls+d.cumulativeRerolls,Me=us*(us+1)/2*10+y.applianceCosts;const We=d.actionHistory.length?xe(y.achieved,d.achieved,!1):y.achieved,L=d.actionHistory.length?xe(y.achieved,d.achieved,!0):y.achieved,Be=Es(o,We);if(E<=0&&Be>0||d.cumulativeRerolls&&Me>q)continue;let be=0,Ce=0,cs=[],He=0,Ke=1;const _e=L["Blueprint Cabinet"].goalsPurchased-f.length-R,hs=(($=y.achieved["Discount Desk"])==null?void 0:$.goalsPurchased)??0+((Y=y.achieved["Discount Desk"])==null?void 0:Y.substitutesPurchased)??0?.5:1;{let W=q-Me;for(const X of Fe){const z=d.achieved[X];W-=z.goalsPurchased*le(z.goal).PurchaseCost*(b?.5:1)*hs;let ds=!1;(W<0||z.substitutesPurchased)&&(z.goal==="Copying Desk"&&Ce&&(Ce=0,He--),ds=!0,W<0&&(be+=z.goalsPurchased),be+=z.substitutesPurchased,z.substitutesPurchased&&(He++,es[z.goal]&&(Ke*=es[z.goal]))),(z.goal==="Metal Table"||z.goal==="Grabber - Rotating"||z.goal==="Portioner"||z.goal==="Grabber")&&z.goalsPurchased+z.substitutesPurchased&&L[X].goalsPurchased+L[X].substitutesPurchased<L[X].number&&(y.achieved["Copying Desk"].goalsPurchased||L["Copying Desk"].goalsPurchased&&W>60)&&(ds||Ce++,Ce++,cs.push(z.goal),He++)}if(be>_e)continue e}Me+=d.applianceCosts*hs;let ke=100,Ge=B>1?160:100,ze=50;switch(((c=L==null?void 0:L.Portioner)==null?void 0:c.goalsPurchased)??0){case 0:break;case 1:ke*=.75;break;case 2:default:switch(ke/=4,(((r=L["Grabber - Rotating"])==null?void 0:r.goalsPurchased)+((N=L.Grabber)==null?void 0:N.goalsPurchased)+((ae=y.achieved["Grabber - Rotating"])==null?void 0:ae.substitutesPurchased)+((pe=y.achieved.Grabber)==null?void 0:pe.substitutesPurchased))*((Q=y.achieved["Copying Desk"])==null?void 0:Q.goalsPurchased)){case 0:break;default:ke/=2}break}switch(((O=We["Danger Hob"])==null?void 0:O.goalsPurchased)+((me=We["Danger Hob"])==null?void 0:me.substitutesPurchased)&&(ke*=.75),((Te=L["Scrubbing Brush"])==null?void 0:Te.goalsPurchased)??0){case 0:break;case 1:default:ze/=3}switch(Math.max((((G=y.achieved["Power Sink"])==null?void 0:G.goalsPurchased)??0)+(((re=y.achieved["Power Sink"])==null?void 0:re.substitutesPurchased)??0),((Ue=L["Power Sink"])==null?void 0:Ue.goalsPurchased)??0)){case 0:break;case 1:default:ze/=2/.75}{let W=B<6?(((Oe=L["Table - Fancy Cloth"])==null?void 0:Oe.goalsPurchased)??0)+1:0;switch(B){case 1:case 2:case 3:break;case 4:W++;break;case 5:W+=2;break;case 6:default:W+=4;break}Ge/=W}B>=5&&(Ge/=2);const $s=y.deskTime+(Ke-1)*20+Math.max(0,A-os)*5*((te=y.achieved["Clipboard Stand"])!=null&&te.goalsPurchased?.5:1)+(He*Ke*5+(n[d.day]??n.at(-1)??0))*((De=L["Clipboard Stand"])!=null&&De.goalsPurchased?.5:1)+Math.max(ke+ze,Ge)+ke+ze+Ge,oe={...d,rerollConfigs:[...y.rerollConfigs,d.rerollConfigs],achieved:L,money:q-Me,actionHistory:[...y.actionHistory,...d.actionHistory],upgradesInProgress:be,cumulativeRerolls:y.cumulativeRerolls+d.cumulativeRerolls,applianceCosts:y.applianceCosts+d.applianceCosts,deskTime:$s};if(!(be>_e)){if(Ce&&(Ce===1||be+1<=_e))for(const W of cs)oe.upgradesInProgress+=Ce,L[W].goalsPurchased++,oe.actionHistory.push(`copy ${W}`),oe.applianceCosts+=30;if(oe.money>=0&&(!oe.upgradesInProgress||u.length)){if(Be<E&&(E=Be,console.log(`best so far missing ${Be} pieces `+Ne(oe,q))),Be<=0){if(Z.add(oe)){Fs();continue}}else if(E<=0)continue}if(ie>k&&(k=ie),I){const W=y.cumulativeRerolls;for(let X=0;X<=ie;X++)fe[X]===void 0&&(fe[X]=new J([],As)),fe[X].add([W,Me]);continue}D.add(oe)}}return E}const ye={...T};ye["Blueprint Cabinet"]={...ye["Blueprint Cabinet"],goalsPurchased:1};const ne=new J([{achieved:ye,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,rerollConfigs:[],upgradesInProgress:0,day:0,numFloor:0,money:0,fodderAvailable:0,deskTime:0}],[...v,(p,d)=>p.applianceCosts-d.applianceCosts,(p,d)=>p.cumulativeRerolls-d.cumulativeRerolls]);let E=1/0,B=0,q=0;const V=new Ds(s),Ee=["Research Desk","Plates"];let ls=!1,ge=[];{const p=["Booking Desk","Blueprint Cabinet"];Se.filter(d=>p.includes(d.Name)).forEach(d=>V.OwnedAppliances.push(d))}for(const p of e)V.addCard(p);function Us(p,d,D){let I=[{...p}],A=[],P=[];const R=JSON.parse(JSON.stringify(p.achieved));for(const U of d){let M=U.Name,w=R[M],$=!1;if(!w||w.goalsPurchased>=i[0][M].number){if(w=R[m[U.Name]],!w)continue;$=!0,M=m[U.Name]}if(!($&&w.goalsPurchased+w.substitutesPurchased>=i[0][M].number)&&!(w.goalsPurchased>=i[0][M].number)){M==="Table - Fancy Cloth"&&($=!1),$?w.substitutesPurchased++:w.goalsPurchased++;{const Y=c=>{const r={...c};r.achieved={...r.achieved},r.numFloor--,r.achieved[M]={...r.achieved[M],goalsPurchased:r.achieved[M].goalsPurchased+($?0:1),substitutesPurchased:r.achieved[M].substitutesPurchased+($?1:0)};const N=M==="Starter Bin"||M==="Table - Fancy Cloth"?le(U.Name).PurchaseCost:Math.max(le(U.Name).PurchaseCost,le(M).PurchaseCost);return r.applianceCosts+=N*(b?.5:1),r.actionHistory=[...r.actionHistory,`buy ${U.Name}`+($?` for ${M}`:"")],M==="Starter Bin"&&(r.fodderPurchases=[...r.fodderPurchases],r.fodderPurchases[1]++,r.achieved[M].substitutesPurchased--),r};if(M!=="Starter Bin"){const c=I.map(Y),r=A.map(Y),N=P.map(Y);I=c.concat(I),A=r.concat(A),P=N.concat(P),c.forEach(D)}else A=A.concat(P),P=(P.length?P:I).map(Y)}}}return I.concat(A).concat(P)}for(;E;){let p=ne.array;ne.clear();const d=new J([],[...j,(c,r)=>c.cumulativeRerolls-r.cumulativeRerolls,(c,r)=>c.applianceCosts-r.applianceCosts]);if(q+=t[B]??t.at(-1)??0,B++,B>14&&(b||!a.length)){debugger;break}if(B>1&&p.length===0){debugger;break}p.sort((c,r)=>ve(c)-ve(r)),console.log(`fastest so far: ${Ne(p[0],q)}`),p.every(c=>c.achieved["Copying Desk"].goalsPurchased)&&(f=f.map(c=>(q-=60/2,c-1)),f=f.filter(c=>c>0));let D=5,I=.5*60*1e3;const A=Math.min(D-1,1/0);if(q>=g){const c=Math.sqrt((q-g)/10*2);console.log(`Have ${q} on day ${B}, need ${g} to buy everything. Allows for ~${c} rerolls across all days`)}B%5||(D=1);let P;(b||B===5||!(B%3))&&(P=a.shift());const R=Pe.filter(c=>c.Name===P)[0];V.handleNewCardSpawnEffects(R);const U=V.getAppliances([{spawnInside:!0,blueprintCount:_}],B);V.handleNewCardRerollEffects(R);let M=[];if(Ee.length)for(let c=Ee.length-1;c>=0;c--){let r=U.length;for(;r--;){const N=U[r];if(N.Name===Ee[c]){if(console.log(`buying ${N.Name} on day ${B}`),q-p.reduce((pe,Q)=>Math.min(pe,Q.applianceCosts+10/2*(Q.cumulativeRerolls+1)*Q.cumulativeRerolls),1/0)<N.PurchaseCost*(b?.5:1)){console.log("not enough money-- skip for now");continue}ge.push(N),Ee.splice(c,1),q-=N.PurchaseCost*(b?.5:1),U.splice(r,1);break}}M=ge.map(N=>`Buy ${N.Name}`)}let w=new J([{day:B,rerollConfigs:[],achieved:{...T},numFloor:_,fodderAvailable:k,fodderUsed:0,money:q,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,fodderPurchases:[0,0]}],[(c,r)=>V.getPrngAdvancements(c.rerollConfigs,B)-V.getPrngAdvancements(r.rerollConfigs,B),(c,r)=>-V.getPrngAdvancements(c.rerollConfigs,B)+V.getPrngAdvancements(r.rerollConfigs,B),...j,(c,r)=>c.cumulativeRerolls-r.cumulativeRerolls,(c,r)=>c.applianceCosts-r.applianceCosts,(c,r)=>r.numFloor+r.fodderAvailable-c.numFloor+c.fodderAvailable,(c,r)=>c.numFloor-r.numFloor]);Ve(p,w.array[0],ne,!0);let $=1/0;const Y=fe.map(c=>c.array.reduce((r,[N,ae])=>Math.min(r,ae+w.array[0].rerollConfigs.length*(N+1)*10),1/0));e:for(;D--&&(ge.length&&((rs=(ns=w.array[0])==null?void 0:ns.rerollConfigs)==null?void 0:rs.length)===1&&(ge.some(r=>r.Name==="Research Desk")&&(ls=!0),V.OwnedAppliances.push(...ge),ge=[],M=[]),$=Date.now()+I,w.array[0]!==void 0);){console.log(`Seed ${s} Day ${B} Reroll ${w.array[0].rerollConfigs.length} expanding ${w.array.length} states`),console.log({minSpentMoneyByExtraBlueprints:Y});const c=w.array;if(!u.length&&E<=0){const r=c[0].rerollConfigs.length;if(r*((r+1)/2)*10+g>q){console.log("get me outta here!");break}}w.clear();for(const r of c){if(Date.now()>$){w.array.sort((me,Te)=>-1*(me.applianceCosts-Te.applianceCosts));continue e}if(r.numFloor+r.fodderAvailable===0||r.money<r.rerollConfigs.length*10)continue;let N=0;if(Y[0]>r.money)continue;for(let O=1;O<Y.length;O++)if(N++,Y[O]>r.money){N=O-1;break}let ae=A<r.rerollConfigs.length?r.numFloor:r.rerollConfigs.length?r.numFloor+Math.min(r.fodderAvailable,N-r.fodderUsed):_;{let O=r.actionHistory.length;for(;O--&&!r.actionHistory[O].includes("reroll");)if(r.actionHistory[O].includes("Starter Bin")){ae=r.numFloor;break}}const pe=A<r.rerollConfigs.length?r.numFloor:r.rerollConfigs.length?Math.max(1,r.numFloor):_;let Q;r.rerollConfigs.length===0?Q=je:A<r.rerollConfigs.length?Q=[r.rerollConfigs.at(-1)]:Q=Ae,V.getAppliances([...r.rerollConfigs,{spawnInside:!0,blueprintCount:ae}],r.day);for(const O of Q){const me=G=>{if(!w.add(G)||!d.add(G))return;G.fodderPurchases[0]+G.fodderPurchases[1]||Ve(p,G,ne)},Te=[pe];for(let G=ae;G>pe;G--)Te.push(G);for(const G of Te){const re=[...r.rerollConfigs,{...O,blueprintCount:G}],Oe=[...re.length===1?U:V.getAppliances(re,r.day)].sort((y,$e)=>y.PurchaseCost-$e.PurchaseCost),te=G-r.numFloor;if(te>r.fodderAvailable)debugger;const De={...r,fodderPurchases:[r.fodderPurchases[1],0],money:r.money-r.rerollConfigs.length*10,rerollConfigs:re,numFloor:re.length===1?G-ge.length:G,fodderAvailable:r.fodderAvailable-te,fodderUsed:r.fodderUsed+te,cumulativeRerolls:r.rerollConfigs.length?r.cumulativeRerolls+1:0,actionHistory:r.rerollConfigs.length?[...r.actionHistory,`${te?`take ${te} out, `:""}reroll ${O.spawnInside?"I":O.playerInside?"OI":"OO"}`]:[`day ${r.day} spawn`,`spawn ${O.spawnInside?"I":O.playerInside?"OI":"OO"}`,...M]};if(me(De),Us(De,Oe,me),Date.now()>$)break}}}}if(V.addCard(R),E<=0){if(!u.length){Z.array.sort((c,r)=>c.deskTime-r.deskTime),h((E<=0?`full build on ${s} by day ${B}: 
`:"")+Z.array.map(c=>Ne(c,q)).join(`
`));break}{const c=(((ts=u[0]["Blueprint Cabinet"])==null?void 0:ts.number)??0)-(((is=o["Blueprint Cabinet"])==null?void 0:is.number)??0);if(c+f.length>2)debugger;for(let r=0;r<c;r++)f.push(1)}for(const c of Object.values(o))c.number&&V.OwnedAppliances.push(le(c.goal));o=u.shift(),i.shift(),j=[];for(const{goal:c,number:r}of Object.values(i[0]))j.push(qe(r,c));E=1/0,fe=[],Fs(!0),ne.array=Z.array,Z.clear(),Z.objectiveFunctions}}return B;function Fs(p=!1){h(`tier ${l.length-u.length-(p?1:0)} build on ${s} by day ${B}${p?"":" (Partial)"}: 
`+Z.array.slice(0,100).map(d=>Ne(d,q)).join(`
`))}}function Es(s,e){let a=0;for(const l of Object.values(s)){let F=l.number;a+=Math.max(0,F-e[l.goal].goalsPurchased-e[l.goal].substitutesPurchased)}return a}function Ne(s,e){const a=s.cumulativeRerolls*(s.cumulativeRerolls+1)/2*10+s.applianceCosts;return`${s.day}: ${ve(s)} total rerolls: ${s.cumulativeRerolls}, appliance costs: ${s.applianceCosts} (money spent: ${a}/${e}), `+s.actionHistory.join(", ")}const Le={};function Os(s){const{starters:e,main:a,doubleOrderChance:l,desserts:F,sides:t,groupSizes:n}=s,h=[e,a,l,F,n].join("|");if(Le[h])return Le[h];let o=[0,0,0],f=[0,0,0,0],u=1-.75**t;if(e>0){o[0]=1;let g=1-.75**e;l===.5&&(g*=1.25,u*=1.25),f[0]=n.reduce((T,b)=>T+1+(b-1)*g,0)}const i=n.reduce((g,T)=>g+T);a&&(o[1]=1,f[1]=i),F>0&&(f[2]=i,a?(o[2]=1-.75**F,l===.5&&(o[2]*=1.25)):o[2]=1);let m=1;e>0&&(o[0]*=1+l,m*=1-l,f[0]*=o[0]),a&&(o[1]*=1+m*l,m*=1-l,f[1]*=o[1],f[3]=f[1]*u),F>0&&(o[2]*=1+m*l,m*=1-l,f[2]*=o[2]);const k=[o,f];return Le[h]=k,k}function Hs(s){const{starters:e,main:a,doubleOrderChance:l,desserts:F,sides:t,groupSizes:n}=s;let h=[0,0,0],o=[0,0,0,0],f=1-.75**e,u=1-.75**F,i=1-.75**t;l===.5&&(f*=1.25,u*=1.25,i*=1.25);const m=b=>{h[0]++,o[0]++;for(let v=0;v<b-1;v++)Math.random()<f&&o[0]++},k=b=>{h[1]++,o[1]+=b;for(let v=0;v<b;v++)Math.random()<i&&o[3]++},g=b=>{h[2]++,o[2]+=b};for(const b of n){let v=!1;e>0&&(m(b),!v&&Math.random()<l&&(v=!0,m(b))),k(b),!v&&Math.random()<l&&(v=!0,k(b)),F>0&&Math.random()<u&&(g(b),!v&&Math.random()<l&&(v=!0,g(b)))}return[h,o]}const Gs={"Diner (1)":1,"Small (2)":2,"Medium (2)":2,"Large (3)":3,"Huge (4)":4};class zs{constructor(e,a=[],l=[]){C(this,"seed");C(this,"mapSize");C(this,"frontDoor");C(this,"startingCards");C(this,"cards");C(this,"playerCount");C(this,"turbo");C(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=a,this.cards=l,this.playerCount=Gs[this.mapSize],this.turbo=this.startingCards.some(F=>{if(F===void 0){console.log({startingCards:a});debugger}return F.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let F=!1,t=!1,n=0,h=[],o=[],f=0,u=[],i=0,m=[];for(const S of a)switch(S.Name==="All You Can Eat"&&(F=!0),S.Name==="Double Helpings"&&(t=!0),S.DishType){case x.Dessert:f++,S.DishValue&&u.push(S.DishValue);break;case x.Starter:S.DishValue&&h.push(S.DishValue),n++;break;case x.Side:S.DishValue&&m.push(S.DishValue),i++;break;case x.Main:case x.Base:S.Name==="Tacos"?(o.push(2),o.push(3)):S.DishValue&&o.push(S.DishValue)}let k=t?.5:F?.25:0,g=[0,0,0,0];if(g[0]=we(h),g[1]=we(o),g[2]=we(u),g[3]=we(m),t)for(let S=0;S<3;S++)g[S]&&(g[S]+=3);const[T,b]=Os({starters:n,main:!!g[1],doubleOrderChance:k,desserts:f,sides:i,groupSizes:l});let v=0;for(let S=0;S<b.length;S++)v+=b[S]*g[S];const j=ss(this.playerCount),H=this.getBookingDeskCount(e),K=this.getBookingDeskMoney(e);return j*(v+H*K)}simulateMoney(e){if(e===0)return this.turbo?30:0;const a=this.getCardsByDay(e),l=this.getGroupSizes(e);let F=!1,t=!1,n=[[],[],[],[]];for(const T of a)switch(T.Name==="All You Can Eat"&&(F=!0),T.Name==="Double Helpings"&&(t=!0),T.DishType){case x.Dessert:T.DishValue&&n[2].push(T.DishValue);break;case x.Starter:T.DishValue&&n[0].push(T.DishValue);break;case x.Side:T.DishValue&&n[3].push(T.DishValue);break;case x.Main:case x.Base:T.Name==="Tacos"?(n[1].push(2),n[1].push(3)):T.DishValue&&n[1].push(T.DishValue)}let h=t?.5:F?.25:0,o=0;t&&(o+=3);const[f,u]=Hs({starters:n[0].length,main:!!n[1].length,doubleOrderChance:h,desserts:n[2].length,sides:n[3].length,groupSizes:l});let i=0;for(let T=0;T<u.length;T++){let b=u[T];for(;b--;)T<3&&(i+=o),i+=n[T][Math.floor(Math.random()*n[T].length)]}const m=ss(this.playerCount),k=this.getBookingDeskCount(e),g=this.getBookingDeskMoney(e);return m*(i+k*g)}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let a;this.turbo?a=e-1:(a=Math.max(0,Math.floor((e-1)/3)),e>5&&a++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,a)]}return this._cardsByDay[e]}getBookingDeskCount(e,a=1){const l=Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e));if(this.getCardsByDay(e).some(f=>f.Name==="Herd Mentality"))return Math.min(l,3)+1;const F=[],t=this.getCardsByDay(e);let n=1;(this.turbo||t.some(f=>f.Name==="Morning Rush"))&&(F.push(.2),n++),(this.turbo||t.some(f=>f.Name==="Lunch Rush"))&&(F.push(.5),n++),(this.turbo||t.some(f=>f.Name==="Dinner Rush"))&&(F.push(.8),n++);const h=a/this.getDayLength(e),o=.1/l;for(let f=1;f<l;f++){const u=f/l,i=u-o-h,m=u+o+h;let k=!1;for(const g of F)if(i<=g&&m>=g){k=!0;break}k||n++}return n}getNonRushGroupCount(e){const a=this.getExpectedCustomers(e),l=this.getCardsByDay(e).filter(n=>n.Name==="Closing Time?").length*.2,F=this.getExpectedGroupSize(e),t=a*(1+l)/F;return Math.ceil(t)}getCustomerCount(e){return this.getGroupSizes(e).reduce((a,l)=>a+l,0)}getGroupSizes(e){const a=Ze(1997821,e,this.seed).random,l=this.getNonRushGroupCount(e),F=this.getCardsByDay(e).some(m=>m.Name==="Herd Mentality");let t=l,n=[],[h,o]=this.getGroupSizeRange(e);{let m=t-1;for(;m--;)a.value}for(;t--;)n.push(a.range(h,o+1)),!F&&t!==l-1&&a.value;let f=this.turbo?3:this.getCardsByDay(e).filter(m=>m.Name.includes(" Rush")).length;const u=Math.ceil(Math.max(1,this.getExpectedCustomers(e)*.15));let i=f*u;for(;i--;)n.push(a.range(h,o+1));return n}getExpectedGroupSize(e){const a=this.getGroupSizeRange(e);return(a[0]+a[1])/2}getGroupSizeRange(e){let a=1,l=2;for(const F of this.getCardsByDay(e))switch(F.Name){case"Individual Dining":l--;break;case"Medium Groups":a++,l+=2;break;case"Large Groups":a+=2,l+=2;break;case"Flexible Dining":a--,l++;break;case"Community":const t=Math.floor((e-1)/3);a+=t,l+=t;break}return[a,l]}getExpectedCustomers(e){const a=this.getReductions(e),l=this.getDayLength(e),F=this.getPlayerModifier(),t=this.getCourseModifier(e),n=this.getDayRate(e),h=this.getCustomersPerHour(e),o=this.getAdvertisingModifier(e);return .85**a*(l/25*n*F)/t*h*o}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(l=>l.Name==="Advertising").length}getDayRate(e){let a=1;switch(e){case 1:a=1.25;break;case 2:a=1.5;break;default:a=1.5+.15*(e-3);break}return e>15&&(a+=(this.turbo?.1:0)*(e-15)**1.5),a}getCourseModifier(e){let a=1;const l=this.getCardsByDay(e);return l.some(F=>F.DishType===x.Dessert||F.Name==="Black Coffee"||F.Name==="Cakes")&&(a+=.25),l.some(F=>F.DishType===x.Starter)&&(a+=.25),a}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let a=1;return this.turbo&&(a=1.5,a*=1+e/10),a}getReductions(e){return this.getCardsByDay(e).reduce((l,F)=>l+F.CustomerMultiplier,0)}getMapSize(){const a=new he(this.seed,5078598).useSubcontext(0).random.range(0,8);let l;switch(a){case 0:l="Small (2)";break;case 4:l="Medium (2)";break;case 1:case 5:l="Diner (1)";break;case 2:case 6:l="Large (3)";break;case 3:case 7:l="Huge (4)";break;default:throw new Error}return l}getLayoutInfo(){const a=new he(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,F;switch(a){case 0:F=70,l=2;break;case 4:F=84,l=2;break;case 1:case 5:F=60,l=1;break;case 2:case 6:F=9*13,l=3;break;case 3:case 7:F=12*16,l=4;break;default:throw new Error}return[l,F]}getDoorInfo(){if(this.mapSize!=="Diner (1)")return-1;let e=new Qe(new he(this.seed,98234234).useSubcontext(0).random.value),a=23;for(;a--;)e.value;return e.range(0,4)}}function ss(s){switch(s){case 1:return 1.25;case 2:return 1.1;default:return 1}}function qs(s,e,a,l){let F=[],t=[];const n=s.cards.slice(e);let h=new zs(s.seed,a,n);h.playerCount=l;for(let o=1;o<=15;o++)F.push(h.guessMoney(o)),t.push(h.getBookingDeskCount(o));return F[0]+=h.guessMoney(0),{expectedMoneyByDay:F,expectedBookingDesksByDay:t}}var as=self;function Ls(s){as.postMessage(s)}const js=["Copying Desk","Blueprint Cabinet","Clipboard Stand","Research Desk"],Vs=[{goal:"Copying Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Blueprint Cabinet",number:8,substitutes:[],skipMissing:!0},{goal:"Clipboard Stand",number:1,substitutes:[],skipMissing:!0},{goal:"Research Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Starter Bin",number:999,substitutes:Se.filter(s=>!js.includes(s.Name)).map(s=>s.Name),skipMissing:!0}];as.onmessage=s=>{let{config:e,tiers:a,playerCount:l}=s.data;for(;!a.at(-1).length;)a.pop();const F=[...Vs],t=a.flatMap(i=>i.flatMap(m=>[m.goal,...m.substitutes])),n=F.length-1;F[n].substitutes=F[n].substitutes.filter(i=>!t.some(m=>i===m)),a[a.length-1].push(...F);const h=e.cards.filter(i=>ws.some(m=>m.Name===i.Name)).length+1,o=e.cards.slice(0,h);let{expectedMoneyByDay:f,expectedBookingDesksByDay:u}=qs(e,h,o,l);xs(e.seed,o,e.cards.slice(h).map(i=>i.Name),a,e.solo,f,u,Ls)}})();
