...
`;const Ps=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing","AllowRefreshes","PurchaseCost","Upgrades"],Ms=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean","boolean","number","number[]"],$e=ys.trim().split(`\r
`).map(s=>{const e=s.split(",");let l={};for(let a=0;a<e.length;a++){let r;switch(Ms[a]){case"number":r=Number(e[a]);break;case"boolean":r=e[a]==="True";break;case"number[]":e[a]===""?r=[]:r=e[a].split(":").map(F=>Number(F));break;default:r=e[a]}l[Ps[a]]=r}return l});class Ds{constructor(e){I(this,"Staple");I(this,"Tags");I(this,"StapleWhenMissing");I(this,"Appliance");I(this,"IsRemoved");I(this,"Filter");I(this,"DecorationRequired");I(this,"SellAsUpgrade");this.Appliance=e,this.Tags=e.ShoppingTags,this.DecorationRequired=e.ThemeRequired,this.SellAsUpgrade=e.IsPurchasableAsUpgrade,this.Filter=e.ShopRequirementFilter,this.StapleWhenMissing=e.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(e){return e&1?this.Staple!==0:e&this.Tags?this.Staple===0:!1}}var ce=(s=>(s[s.NonStaple=0]="NonStaple",s[s.FixedStaple=1]="FixedStaple",s[s.BonusStaple=2]="BonusStaple",s[s.WhenMissing=3]="WhenMissing",s))(ce||{}),Fe=(s=>(s[s.None=0]="None",s[s.Basic=1]="Basic",s[s.Decoration=2]="Decoration",s[s.Technology=4]="Technology",s[s.FrontOfHouse=8]="FrontOfHouse",s[s.Plumbing=16]="Plumbing",s[s.Cooking=32]="Cooking",s[s.Automation=64]="Automation",s[s.Christmas=128]="Christmas",s[s.Misc=256]="Misc",s[s.Office=512]="Office",s[s.BlueprintUpgrader=1024]="BlueprintUpgrader",s[s.BlueprintStore=2048]="BlueprintStore",s[s.Halloween=4096]="Halloween",s[s.SpecialEvent=8192]="SpecialEvent",s))(Fe||{});const xe={DefaultShoppingTag:892};var es=(s=>(s[s.None=0]="None",s[s.RefreshableProvider=1]="RefreshableProvider",s))(es||{}),We=(s=>(s[s.Null=0]="Null",s[s.Exclusive=1]="Exclusive",s[s.Affordable=2]="Affordable",s[s.Charming=4]="Charming",s[s.Formal=8]="Formal",s[s.Kitchen=16]="Kitchen",s))(We||{});const Ke=new Map,ss=new Map;for(const s of $e)Ke.set(s.ID,s),ss.set(s.Name,s);const ye=new Map,vs=new Map,Bs=new Map;{let s=!0;const e=$e.filter(a=>a.Upgrades.length);for(const a of e)for(const r of a.Upgrades)ye.has(r)||ye.set(r,new Set),(fs=ye.get(r))==null||fs.add(a.ID);for(;s;){s=!1;for(const[a,r]of ye){const F=r.size;for(const u of r)for(const c of ye.get(u)??[])r.add(c);F!==r.size&&(s=!0)}}for(const[a,r]of ye)r.delete(a),Bs.set(a,Array.from(r));const l=Array.from(ye.entries()).map(a=>{var r;return`${(r=Ke.get(a[0]))==null?void 0:r.Name}:${Array.from(a[1]).map(F=>{var u;return(u=Ke.get(F))==null?void 0:u.Name}).join(", ")}`});for(const a of ye)vs.set(a[0],Array.from(a[1]));console.log(l)}$e.filter(s=>s.Name==="Booking Desk"||s.Name==="Blueprint Cabinet").sort((s,e)=>s.Name<e.Name?1:-1);const Se=$e;var ws="38";const as=Number(ws);function Rs(s,e){return Math.floor(Math.random()*(e-s))+s}function Ye(s,e){let l=s.length;for(;l-- >1;){let a=e===void 0?Rs(0,l+1):e.range(0,l+1);[s[l],s[a]]=[s[a],s[l]]}return s}const Ns="12345678",Is="1c,1d,1e,1f,1g,1h,1i,1j,1k,1l,1m,1n,1o,1p,1q,1r,1s,1t,1u,1v,1w,1x,1y,1z,13,14,15,16,17,18,19,2c,2d,2e,2f,2g,2h,2i,2j,2k,2l,2m,2n,2o,2p,2q,2r,2s,2t,2u,2v,2w,2x,2y,2z,23,24,25,26,27,28,29,3c,3d,3e,3f,3g,3h,3i,3j,3k,3l,3m,3n,3o,3p,3q,3r,3s,3t,3u,3v,3w,3x,3y,3z,33,34,35,36,37,38,39,4c,4d,4e,4f,4g,4h,4i,4j,4k,4l,4m,4n,4o,4p,4q,4r,4s,4t,4u,4v,4w,4x,4y,4z,43,44,45,46,47,48,49,5c,5d,5e,5f,5g,5h,5i,5j,5k,5l,5m,5n,5o,5p,5q,5r,5s,5t,5u,5v,5w,5x,5y,5z,53,54,55,56,57,58,59,6c,6d,6e,6f,6g,6h,6i,6j,6k,6l,6m,6n,6o,6p,6q,6r,6s,6t,6u,6v,6w,6x,6y,6z,63,64,65,66,67,68,69,7c,7d,7e,7f,7g,7h,7i,7j,7k,7l,7m,7n,7o,7p,7q,7r,7s,7t,7u,7v,7w,7x,7y,7z,73,74,75,76,77,78,79,8c,8d,8e,8f,8g,8h,8i,8j,8k,8l,8m,8n,8o,8p,8q,8r,8s,8t,8u,8v,8w,8x,8y,8z,83,84,85,86,87,88,89".split(",");for(const s of Is);for(const s of Ns);function ke(s){return s.length?s.reduce((e,l)=>e+l,0)/s.length:0}class Re{constructor(e,l){I(this,"fixedSeed");I(this,"instance");I(this,"random");typeof e=="string"&&(e=As(e)),this.fixedSeed=e,this.instance=l,this.random=new Je(e+Math.imul(124192293,l))}useSubcontext(e){return new Re(this.fixedSeed,124192293*e+this.instance)}}class Je{constructor(e){I(this,"seed");const l=c=>Math.imul(1812433253,c)+1>>0,a=e>>0,r=l(a),F=l(r),u=l(F);this.seed=[a,r,F,u]}get value(){let e=this.seed.shift(),l=this.seed[2];return e^=e<<11,e^=e>>>8,l^=l>>>19,l=(l^e)>>0,this.seed.push(l),l}range(e,l){return(this.value>>>0)%(l-e)+e}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(e){return e[this.range(0,e.length)]}}function As(s){const l=new TextEncoder().encode(s);let a=5381,r=l.length;for(;r--;)a=(a<<5)+a+l[r];return a>>0}function ls(s,e,l){return new Re(l,s*1231231+e)}var Ne=(s=>(s[s.Generic=0]="Generic",s[s.Dish=1]="Dish",s[s.PrimaryTheme=3]="PrimaryTheme",s[s.SecondaryTheme=4]="SecondaryTheme",s[s.Franchise=5]="Franchise",s[s.Special=6]="Special",s))(Ne||{}),E=(s=>(s[s.Base=0]="Base",s[s.Main=1]="Main",s[s.Extra=2]="Extra",s[s.Side=3]="Side",s[s.Starter=4]="Starter",s[s.Dessert=5]="Dessert",s[s.Null=6]="Null",s))(E||{});const xs=["Auto Plater","Dish Rack","Plates","Dish Washer"],rs={};for(const s of xs)rs[s]=!0;const ts=Se.filter(s=>s.IsPurchasable||s.IsPurchasableAsUpgrade).length,Os=["Blueprint Cabinet","Booking Desk"].map(s=>Se.filter(e=>e.Name===s)[0]);class Es{constructor(e,l=0){I(this,"seed");I(this,"mapSize");I(this,"numTiles");I(this,"baseUpgradeChance");I(this,"OwnedAppliances");I(this,"Cards");I(this,"Theme");I(this,"extraSpawns");I(this,"cache",new Array(15).fill(0).map(()=>new Map));I(this,"cacheOverridePlated");I(this,"cacheOverrideProcesses");I(this,"baseSpawnCount");I(this,"newestCard");this.seed=e,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=l,this.OwnedAppliances=[...Os],this.Cards=[],this.Theme=We.Null,this.baseSpawnCount=5,this.extraSpawns=[]}clearCache(){}getLayoutInfo(){const l=new Re(this.seed,5078598).useSubcontext(0).random.range(0,8);let a,r;switch(l){case 0:r=70,a=2;break;case 4:r=84,a=2;break;case 1:case 5:r=60,a=1;break;case 2:case 6:r=9*13,a=3;break;case 3:case 7:r=12*16,a=4;break;default:throw new Error}return[a,r]}handleNewCardSpawnEffects(e){e!==void 0&&(e.Name==="Turbo"?(this.baseUpgradeChance=.25,this.baseSpawnCount=7):e.Name==="Christmas Rush"&&(this.extraSpawns=[ss.get("Conveyor")]),e.Name==="Lake"&&(this.baseUpgradeChance=.2),e.UnlockGroup===Ne.PrimaryTheme&&(this.Theme=We[e.Name]),this.newestCard=e)}handleNewestRerollEffects(){this.handleNewCardRerollEffects(this.newestCard)}handleNewCardRerollEffects(e){e!==void 0&&(this.OwnedAppliances=this.OwnedAppliances.concat(e.IngredientProviders.flatMap(l=>Se.filter(a=>a.ID===l))))}addCard(e){var l;e!==void 0&&(((l=this.newestCard)==null?void 0:l.ID)===e.ID&&(this.newestCard=void 0),this.handleNewCardSpawnEffects(e),this.handleNewCardRerollEffects(e),this.Cards.push(e))}_getNetPrngAdvancements(e,l,a){let r=0,F=e.blueprintCount;return l%5===0&&(F+=8-this.baseSpawnCount,a&&(F+=2)),r+=F*(ts-1+1),e.spawnInside||(r+=ns(e.playerInside,this.numTiles)),r+=as,r}getPrngAdvancements(e,l){let a=0;for(let r=0;r<e.length;r++){const F=e[r];let u=F.blueprintCount;l%5===0&&(u+=8-this.baseSpawnCount,r===0&&(u+=2)),a+=u*(ts-1+1),F.spawnInside||(a+=ns(F.playerInside,this.numTiles)),a+=as}return a}buildShopOptions(e,l,a,r,F){const u=a.some(i=>i.Name==="Couples");let c=[];for(const i of Se)if(!(!i.IsPurchasable&&!i.IsPurchasableAsUpgrade)){var t=new Ds(i);const k=t.Appliance.Name;(t.Staple==ce.NonStaple||t.Staple==ce.WhenMissing)&&((t.Tags&Fe.Basic)>Fe.None?t.Staple=ce.FixedStaple:t.StapleWhenMissing?(k!="Research Desk"&&k!="Blueprint Cabinet"&&k!="Plates"&&console.log(`Unexpected ${k} StapleWhenMissing Appliance`),e.some(n=>n.ID===t.Appliance.ID)?t.Staple=ce.NonStaple:t.Staple=ce.WhenMissing):u&&k==="Flower Pot"&&(t.Staple=ce.BonusStaple));const b=t.Appliance;e:{if(b.SellOnlyAsDuplicate){if(!e.some(n=>n.ID===b.ID)){t.IsRemoved=!0;break e}}else if(b.RequiresForShop.length>0){let n=!1;for(const o of b.RequiresForShop)e.some(g=>g.ID===o)&&(n=!0);if(!n){t.IsRemoved=!0;break e}}else if(b.SellOnlyAsUnique&&(b.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${b.Name}, ${b.ID}`),e.some(n=>n.ID===b.ID))){t.IsRemoved=!0;break e}if(rs[k]&&(r??a.every(n=>!n.isMain||n.Name==="Tacos"||n.Name==="Sandwiches"))){t.IsRemoved=!0;break e}if(t.Filter==es.RefreshableProvider&&!e.some(n=>n.AllowRefreshes)){t.IsRemoved=!0;break e}if(t.DecorationRequired!=We.Null&&t.DecorationRequired!=l){t.IsRemoved=!0;break e}if(b.RequiresProcessForShop.length>0&&(F?!b.RequiresProcessForShop.some(n=>F.includes(n)):!b.RequiresProcessForShop.some(n=>a.some(o=>o.RequiredProcesses.includes(n))))){t.IsRemoved=!0;break e}}c.push(t)}return c}initRandom(e){return ls(823828,e,this.seed)}getAppliances(e,l,a,r){var b;(a!==this.cacheOverridePlated||(r==null?void 0:r.length)!==((b=this.cacheOverrideProcesses)==null?void 0:b.length)||r!=null&&r.some((n,o)=>{var g;return n!==((g=this.cacheOverrideProcesses)==null?void 0:g[o])}))&&(this.cacheOverridePlated=a,this.cacheOverrideProcesses=r,this.cache.forEach(n=>n.clear()));const F=e.length===1,u=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards,a,r);let c=e[e.length-1].blueprintCount,t;if(l%5==0){F?c=10:c+=8-this.baseSpawnCount,t=[];for(let n=0;n<c;n++)t[n]=Fe.Decoration;if(F)for(const n of[1,2])t[t.length-n]=Fe.SpecialEvent}else if(e.length>1){t=[];for(let n=0;n<c;n++)t[n]=xe.DefaultShoppingTag}else{const n=xe.DefaultShoppingTag,o=Math.max(1,c),g=Math.max(0,Math.min(u.filter(d=>d.Staple!==ce.NonStaple&&!d.IsRemoved).length,Math.max(2,4-Math.floor(l/5)),o)),T=Math.max(0,o-g);c=o,t=[];for(let d=0;d<g;d++)t[d]=Fe.Basic;for(let d=g;d<g+T;d++)t[d]=n}const i=this.initRandom(l).random;let f=this.getPrngAdvancements(e.slice(0,e.length-1),l);if(this.cache[l].has(f)&&this.cache[l].get(f).length>=c)return this.cache[l].get(f).slice(0,c);const k=f;for(;f--;)i.value;{const n=[...u],o=[],g=this.getUpgradeChance(l),T=[];for(let d=0;d<c;d++){const U=t[d],_=i.valueFloat<g;Ye(n,i);for(let v=0;v<n.length;v++){const x=n[v];if(x.IsRemoved||T.includes(x.Appliance)||!x.MatchesRequestTags(U)||!_&&x.Staple==ce.NonStaple&&x.SellAsUpgrade)continue;U!=Fe.Decoration&&T.push(x.Appliance),o[d]=x.Appliance;break}o[d]==null}return e.length===1&&o.splice(0,0,...this.extraSpawns),this.cache[l].set(k,o),o}}_getAllAppliances(e,l,a,r){const F=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards,a,r);let u,c;if(l%5==0)u=[],c=Fe.Decoration;else if(e)c=xe.DefaultShoppingTag,u=[];else{const i=xe.DefaultShoppingTag,f=Math.max(0,Math.min(F.filter(k=>k.Staple!==ce.NonStaple&&!k.IsRemoved).length,Math.max(2,4-Math.floor(l/5))));u=[];for(let k=0;k<f;k++)u[k]=Fe.Basic;c=i}const t=this.initRandom(l).random;for(;e--;)t.value;{const i=[...F],f=[],k=this.getUpgradeChance(l),b=[];let n=-1;for(;;){n++;let o=u.shift();o===void 0&&(o=c);const T=t.valueFloat<k;Ye(i,t);for(let d=0;d<i.length;d++){const U=i[d];if(U.IsRemoved||b.includes(U.Appliance)||!U.MatchesRequestTags(o)||!T&&U.Staple==ce.NonStaple&&U.SellAsUpgrade)continue;o!=Fe.Decoration&&b.push(U.Appliance),f[n]=U.Appliance;break}if(f[n]==null)break}return f}}_getAppliances(e,l,a,r,F){var b;(r!==this.cacheOverridePlated||(F==null?void 0:F.length)!==((b=this.cacheOverrideProcesses)==null?void 0:b.length)||F!=null&&F.some((n,o)=>{var g;return n!==((g=this.cacheOverrideProcesses)==null?void 0:g[o])}))&&(this.cacheOverridePlated=r,this.cacheOverrideProcesses=F,this.cache.forEach(n=>n.clear()));const u=e===0,c=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards,r,F);let t=l.blueprintCount,i;if(a%5==0){u?t=10:t+=8-this.baseSpawnCount,i=[];for(let n=0;n<t;n++)i[n]=Fe.Decoration;if(u)for(const n of[1,2])i[i.length-n]=Fe.SpecialEvent}else if(e){i=[];for(let n=0;n<t;n++)i[n]=xe.DefaultShoppingTag}else{const n=xe.DefaultShoppingTag,o=Math.max(1,t),g=Math.max(0,Math.min(c.filter(d=>d.Staple!==ce.NonStaple&&!d.IsRemoved).length,Math.max(2,4-Math.floor(a/5)),o)),T=Math.max(0,o-g);t=o,i=[];for(let d=0;d<g;d++)i[d]=Fe.Basic;for(let d=g;d<g+T;d++)i[d]=n}const f=this.initRandom(a).random;if(this.cache[a].has(e)&&this.cache[a].get(e).length>=t+(e?0:this.extraSpawns.length))return this.cache[a].get(e).slice(0,t);const k=e;for(;e--;)f.value;{const n=[...c],o=[],g=this.getUpgradeChance(a),T=[];for(let d=0;d<t;d++){const U=i[d],_=f.valueFloat<g;Ye(n,f);for(let v=0;v<n.length;v++){const x=n[v];if(x.IsRemoved||T.includes(x.Appliance)||!x.MatchesRequestTags(U)||!_&&x.Staple==ce.NonStaple&&x.SellAsUpgrade)continue;U!=Fe.Decoration&&T.push(x.Appliance),o[d]=x.Appliance;break}o[d]==null}return e||o.splice(0,0,...this.extraSpawns),this.cache[a].set(k,o),o}}getUpgradeChance(e){return 1-(1-Math.floor(e/5)*.1)*(1-this.baseUpgradeChance)}}function ns(s,e){return s?e-2:e-1}var Hs=`373996608,Ice Cream,1,,934171642,,-1533430406,False,False,5,1,2\r
...
`,zs=`-959076098,Steak,1,1972879238:620897674,-484165118:380220741,True,False,0,0,5\r
1356267749,Salad,1,2087693779:620897674,1193867305:-712909563:380220741,True,False,0,-1,3\r
550743424,Pizza,1,2087693779:1972879238:-523839730:620897674,925796718:-1963699221:-117339838:-712909563:380220741,True,False,0,0,5\r
367917843,Dumplings,1,1972879238:-523839730:2087693779:620897674,925796718:-484165118:-452101383:380220741,True,False,0,2,8\r
16318784,Black Coffee,1,-1316622579,-1609758240,False,False,0,-2,1\r
...
-2075899,Breakfast,1,-523839730:1972879238:620897674,380220741:925796718,True,False,0,0,5\r
-1653221873,Stir Fry,1,2087693779:1972879238:620897674,-452101383:-1573812073:380220741:-1201769154:314862254,True,False,0,1,10\r
`;const Oe=Hs.trim().split(/\r?\n/).filter(s=>s).map(s=>{var Me,re;const[e,l,a,r,F,u,c,t,i,f,k,b]=s.split(","),n=Number(e),o=Number(a),g=r!=null&&r.length?r.split(":").map($=>Number($)):[],T=F.length?F.split(":").map($=>Number($)):[],d=u!=null&&u.length?(Me=u==null?void 0:u.split(":"))==null?void 0:Me.map($=>Number($)):[],U=c!=null&&c.length?(re=c==null?void 0:c.split(":"))==null?void 0:re.map($=>Number($)):[],te=t==="True",_=i==="True",v=Number(f),x=Number(k),ie=Number(b);return{ID:n,Name:l,UnlockGroup:o,Requires:g,BlockedBy:T,RequiredProcesses:d,IngredientProviders:U,isMain:te,isStarterOrSide:_,DishType:v,CustomerMultiplier:x,DishValue:ie}}),Fs=[...[{ID:447437163,Name:"Country",UnlockGroup:Ne.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:E.Null,CustomerMultiplier:0,DishValue:0},{ID:2002876295,Name:"City",UnlockGroup:Ne.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:E.Null,CustomerMultiplier:0,DishValue:0},{ID:-1864906012,Name:"Alpine",UnlockGroup:Ne.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:E.Null,CustomerMultiplier:0,DishValue:0},Oe.filter(s=>s.Name==="Community")[0],Oe.filter(s=>s.Name==="Couples")[0],{ID:1958825350,Name:"Turbo",UnlockGroup:Ne.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:E.Null,CustomerMultiplier:0,DishValue:0},Oe.filter(s=>s.Name==="Christmas Rush")[0],{ID:-1893039732,Name:"Lake",UnlockGroup:Ne.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:E.Null,CustomerMultiplier:0,DishValue:0}]].slice(3).sort((s,e)=>s.Name<e.Name?-1:1);["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey","Sundaes"].map(s=>Oe.filter(e=>e.Name===s)[0]);const qs=zs.trim().split(`\r
`).filter(s=>s).map(s=>{var _,v;const[e,l,a,r,F,u,c,t,i,f]=s.split(","),k=Number(e),b=Number(a),n=r!=null&&r.length?(_=r==null?void 0:r.split(":"))==null?void 0:_.map(x=>Number(x)):[],o=F!=null&&F.length?(v=F==null?void 0:F.split(":"))==null?void 0:v.map(x=>Number(x)):[],g=u==="True",T=c==="True",d=Number(t),U=Number(i),te=Number(f);return{ID:k,Name:l,UnlockGroup:b,Requires:[],BlockedBy:[],RequiredProcesses:n,IngredientProviders:o,isMain:g,isStarterOrSide:T,DishType:d,CustomerMultiplier:U,DishValue:te}}).sort((s,e)=>s.Name<e.Name?-1:1),fe={};for(const s of Oe)fe[s.Name]=s;for(const s of qs)fe[s.Name]=s;for(const s of Fs)fe[s.Name]=s;fe.Coffee=fe["Black Coffee"],fe.Community.AKA="Autumn",fe["Christmas Rush"].AKA="North Pole",fe.Couples.AKA="Romantic",fe["Cherry Pie"]=fe["Cherry Pies"],fe["Mushroom Pie"]=fe["Mushroom Pies"];const Us=[7,8,8,8,8,10,10,8,9,9,9,10,9,10,10],Ls=[122,143,159,169,169,215,215,218,240,252,252,288,263,300,300],qe={};function Pe(s){if(qe[s]===void 0)switch(qe[s]=Se.filter(e=>e.Name===s)[0],s){case"Display Stand":qe[s].PurchaseCost=120*2;break}if(qe[s]===void 0){console.error(`Could not find ${s} appliance`);debugger}return qe[s]}const Vs=[(s,e)=>s[0]-e[0],(s,e)=>s[1]-e[1]];function Gs(s){let e=0;return(s==null?void 0:s.deskTime)!==void 0&&(e+=s.deskTime),e+=s.actionHistory.length,e}function Qe(s,e){return(l,a)=>{const r=l.achieved[e],F=a.achieved[e],u=Math.min(r.goalsPurchased,s);let t=Math.min(F.goalsPurchased,s)-u;return t===0?r.goalsPurchased>=s||r.goalsPurchased+r.substitutesPurchased>=s&&F.goalsPurchased+F.substitutesPurchased>=s?r.goalsPurchased+r.substitutesPurchased-(F.goalsPurchased+F.substitutesPurchased):F.substitutesPurchased-r.substitutesPurchased:t}}const $s={Oven:0,"Brownie Tray":4,Workstation:2,"Sharp Knife":0,"Scrubbing Brush":0,Mince:15,"Cake Tin":15,"Discount Desk":1,"Copying Desk":1,"Metal Table":4,"Power Sink":0,"Dish Washer":4,"Wash Basin":4,"Soaking Sink":4,"Heated Mixer":3,"Conveyor Mixer":3,"Rapid Mixer":3,"Danger Hob":1,"Safety Hob":2,"Grabber - Rotating":2,Grabber:0,"Smart Grabber":3,Freezer:2,Bin:0,Conveyor:0},Ws=[6,6,7,4,6,6,7,8,11,8,7,11,10,7,11];function js(s,e,l,a,r=!0,F=Ls,u=Us,c=Ws,t=()=>{},i=15){var gs,ms,Ts,bs,Cs;let f={};const k=[],b=new Array(a.length).fill(0).map(()=>({})),n={};let o=0,g=0;const T={},d=e.some(y=>y.Name==="Turbo"),U=e.some(y=>y.Name==="Lake"),te=[(y,m)=>m.fps-y.fps,(y,m)=>m.upgradesInProgress.length-y.upgradesInProgress.length,(y,m)=>m.money-y.money,(y,m)=>y.cumulativeRerolls-m.cumulativeRerolls];let _=[],v=0;const x={};for(const y of a){for(const m of y){const{goal:H,number:N,substitutes:Q,skipMissing:W=!1}=m;for(const z of Q)n[z]||(n[z]=[]),n[z].push(H),z==="Flower Pot"&&console.log({substitutesToGoalMap:n});x[H]?W||(x[H].number+=N):(x[H]={...m},W&&(x[H].number=0));for(let z=0;z<=v;z++){if(b[z]===void 0)debugger;b[z][H]?b[z][H].number+=N:b[z][H]={...m}}for(let z=v+1;z<b.length;z++){if(b[z]===void 0)debugger;b[z][H]||(b[z][H]={...m,number:0})}W||(g+=N*Math.ceil(Pe(H).PurchaseCost*(d?.5:U?.75:1)))}try{k.push(JSON.parse(JSON.stringify(x)))}catch{console.log(b),console.log(b[0]);debugger}v++}const ie=b[0],Me=Object.values(ie).sort((y,m)=>Pe(y.goal).PurchaseCost-Pe(m.goal).PurchaseCost).map(y=>y.goal);f=k.shift();for(const y of Object.values(ie)){const{goal:m,number:H}=y;T[m]={...y,substitutesPurchased:0,goalsPurchased:0},y.goal!=="Starter Bin"&&(te.push(Qe(H,m)),_.push(Qe(H,m)))}const re=new de([],[...te,(y,m)=>m.money-y.money,(y,m)=>y.cumulativeRerolls-m.cumulativeRerolls]),$=d?7:5,B=[{spawnInside:!0,blueprintCount:$},{spawnInside:!1,playerInside:!1,blueprintCount:$}];r||B.push({spawnInside:!1,playerInside:!0,blueprintCount:$});const Y=[{spawnInside:!0,blueprintCount:$},{spawnInside:!1,playerInside:!0,blueprintCount:$},{spawnInside:!1,playerInside:!1,blueprintCount:$}];function Le(y,m,H){const N={...y};for(const Q of Object.values(m)){const W=Q.goal;N[W]={...N[W]},W==="Copying Desk"&&(N[W].goalsPurchased+=N[W].substitutesPurchased,N[W].substitutesPurchased=0),N[W].goalsPurchased+=Q.goalsPurchased,N[W].substitutesPurchased+=Q.substitutesPurchased}return N}let De=[];function je(y,m,H,N=!1){var W,z,me,oe,Te,Z;const Q=m.fodderUsed;e:for(const A of y){let se=1+(A.achieved["Copying Desk"].goalsPurchased?1:0);const C=A.upgradesInProgress.filter(p=>p.appliance==="").length;let S=C;if(S*=se,S<0)continue;const h=m.actionHistory.length?Le(A.achieved,m.achieved):A.achieved;let R=0,D=[...A.upgradesInProgress];if(S<Q)if((C+D.filter(p=>p.appliance==="Mince").length)*se>=Q){let p=0;for(;(C+p*2)*se<Q;)p++;let P=0;for(;p;)D[P].appliance==="Mince"&&(D[P]={appliance:"",cost:0,upgradeTurnTimer:0},D.push({appliance:"",cost:0,upgradeTurnTimer:0}),p--),P++}else continue;R=Math.max(0,Q-D.filter(p=>p.appliance==="").length);let j=(((W=A.achieved["Discount Desk"])==null?void 0:W.goalsPurchased)??0)+(((z=A.achieved["Discount Desk"])==null?void 0:z.substitutesPurchased)??0)-A.upgradesInProgress.filter(p=>p.appliance==="Discount Desk").length>0,O=0;R===0?O=8:D.length<=4?O=4:A.achieved["Copying Desk"].goalsPurchased>1?D.length<16?O=7:O=6:O=3;let w=0,V=0,J=0;D=D.flatMap(p=>{let P=[];return ds||A.achieved["Research Desk"].goalsPurchased?(P.push({...p,upgradeTurnTimer:p.upgradeTurnTimer-1,cost:j?Math.ceil(p.cost/2):p.cost}),O--):j?(P.push({...p,cost:Math.ceil(p.cost/2)}),O--):P.push(p),O<=0&&(j=!1),P}),R<A.achieved["Copying Desk"].goalsPurchased*8&&(D.sort((p,P)=>p.cost-P.cost),D=D.flatMap(p=>{let P=[p];return R<A.achieved["Copying Desk"].goalsPurchased*8&&(p.appliance==="Mince"?R<A.achieved["Copying Desk"].goalsPurchased*8&&(V+=p.cost,J++,R++,P.push({appliance:"",cost:0,upgradeTurnTimer:0})):p.appliance==="Cake Tin"?(V+=p.cost,w++,J++,R++,p.upgradeTurnTimer<=1&&(w++,J++)):p.appliance==="Freezer"&&(h.Freezer.goalsPurchased++,V+=p.cost,R++,J++)),P})),D=D.map(p=>p.upgradeTurnTimer>0?p:{appliance:"",cost:0,upgradeTurnTimer:0});let G=0;{let p=m.actionHistory.length,P=!1;for(;p--;)if(m.actionHistory[p]==="buy Blueprint Cabinet")G++;else if(m.actionHistory[p].includes(" for ")){P||(G=0);break}else m.actionHistory[p].includes("reroll")&&(P=!0)}for(let p=0;p<m.achieved["Blueprint Cabinet"].goalsPurchased-G;p++)D.push({appliance:"",cost:0,upgradeTurnTimer:0});let M=A.cumulativeRerolls+m.cumulativeRerolls;if(M>Ae)continue;let X=M*(M+1)/2*10+A.applianceCosts+V;const q=structuredClone(h);for(const p of D)p.appliance&&(q[p.appliance]=structuredClone(q[p.appliance]),q[p.appliance].goalsPurchased--);if(m.cumulativeRerolls&&X>ee)continue;let ue=[],ve=0,Be=1;const Ge=D.filter(p=>!p.appliance).length;{let p=ee-X;for(const P of Me){const K=m.achieved[P],ae=Math.ceil(Pe(K.goal).PurchaseCost*(d?.5:U?.75:1));if(p-=(K.goalsPurchased+K.substitutesPurchased)*ae,K.substitutesPurchased){let ne=$s[K.goal]??1;if(K.goal==="Grabber"&&m.actionHistory.some(le=>le.includes("Conveyor for Grabber"))&&(ne=1),K.goal!=="Freezer")if(K.goal==="Dish Washer"){const le=(me=m.actionHistory.filter(ze=>ze.includes(" for Dish Washer"))[0].match(/buy (.*) for Dish Washer/))==null?void 0:me[1];if(!le)throw"nope";ne=["Dish Washer","Wash Basin","Power Sink","Soaking Sink","Sink"].indexOf(le),ne===4&&(ne=3)}else K.goal==="Discount Desk"&&m.actionHistory.some(le=>le.includes("Blueprint Desk for Discount Desk"))&&(ne=1);if(ne)for(let le=0;le<K.substitutesPurchased;le++)p+=ae,ue.push({appliance:K.goal,cost:ae,upgradeTurnTimer:ne}),ve+=ne}}if(ue.length>Ge){let P=ue.length-Ge;const K=ue.filter(ae=>ae.appliance==="Mince").length;if(D.filter(ae=>ae.appliance==="Mince").length*2+K>=P-K){let ae=0;for(;P>0&&D[ae];)D[ae].appliance==="Mince"&&(D[ae]={appliance:"",cost:0,upgradeTurnTimer:0},D.push({appliance:"",cost:0,upgradeTurnTimer:0}),P-=2),ae++;if(P>0){let ne=ue.length-1;for(;P>0;)ue[ne].appliance==="Mince"&&(ue.splice(ne,1),D.push({appliance:"",cost:0,upgradeTurnTimer:0}),P-=2),ne--}}else continue e}for(const P of ue)P.appliance&&(q[P.appliance]=structuredClone(q[P.appliance]),q[P.appliance].goalsPurchased--)}{let p=0;for(const P of ue){for(;D[p].appliance;)p++;D[p]=P}for(let P=0;P<G;P++)D.push({appliance:"",cost:0,upgradeTurnTimer:0});D.sort((P,K)=>K.cost-P.cost)}let ge;try{if(ge=_s(f,{...A,day:L,achieved:q,upgradesInProgress:D,fps:A.fps+w+(((oe=m.achieved["Flower Pot"])==null?void 0:oe.goalsPurchased)??0)}),!N&&(L===3&&(!(q.Freezer.goalsPurchased+q.Freezer.substitutesPurchased)||!(q.Oven.goalsPurchased||q.Oven.substitutesPurchased))||L===1&&(!(q["Sharp Knife"].goalsPurchased||q["Sharp Knife"].substitutesPurchased)||!(q["Scrubbing Brush"].goalsPurchased||q["Scrubbing Brush"].substitutesPurchased))||Math.min(15,ge)>pe*2))continue}catch{debugger;continue}if(pe<=0&&ge>0)continue;X+=m.applianceCosts;let He=0;{let p="",P=A.actionHistory.length,K=!0;for(;P--;){const le=A.actionHistory[P].match(/^(?:spawn|reroll) (..?)/);if(!le){A.actionHistory[P].match(/^day ..? spawn/)&&(K=!0);continue}if(K){K=!1;continue}p=le[1][0]}let ae=0,ne=!0;for(let le=0;le<m.actionHistory.length;le++){He+=ae,ae=0;const ze=m.actionHistory[le].match(/^(?:spawn|reroll) (..?)/);if(!ze){const ks=m.actionHistory[le].match(/take (\d+) out/);ks&&(He+=parseInt(ks[1])/3+1);continue}He++;const ra=ze[1][0],Ss=ne?"":ze[1][1];ne=!1,p&&(p[0]!==ra&&(ae+=3),p[1]&&Ss&&p[1]!==Ss&&(ae+=10)),p=ze[1]}}let la=A.deskTime+(Be-1)*20+Math.max(0,Q-C)*5*((Te=A.achieved["Clipboard Stand"])!=null&&Te.goalsPurchased?.5:1)+(ve*Be*5+(u[m.day]??u.at(-1)??0))*((Z=h["Clipboard Stand"])!=null&&Z.goalsPurchased?.5:1)+He+m.cumulativeRerolls*2;const be={...m,rerollConfigs:[...A.rerollConfigs,m.rerollConfigs],achieved:h,money:ee-X,actionHistory:[...A.actionHistory,...m.actionHistory],upgradesInProgress:D,cumulativeRerolls:A.cumulativeRerolls+m.cumulativeRerolls,applianceCosts:A.applianceCosts+m.applianceCosts+V,deskTime:la,fps:A.fps+w};if(w&&be.actionHistory.push(`buy ${w} flower pot copies`),J>w&&be.actionHistory.push(`buy ${J-w} cab copies`),!(be.money<-be.upgradesInProgress.reduce((p,P)=>p+P.cost,0))){if(be.money>=0||be.money+be.upgradesInProgress.reduce((p,P)=>p+P.cost,0)>=0&&k.length){if(ge<pe&&(pe=ge,console.log(`best so far missing ${ge} pieces `+Ue(be,ee))),ge<=0){if(re.add(be)){if(ps(),re.array[0].deskTime<-1e4*60){console.log("uh, can I quit from this function?");break}continue}}else if(pe<=0)continue}if(N&&(L===1?S=0:se>1&&(S+=A.upgradesInProgress.filter(p=>p.appliance==="Mince").length*se)),S>o&&(o=S),N){const p=A.cumulativeRerolls;for(let P=0;P<=S;P++)De[P]===void 0&&(De[P]=new de([],Vs)),De[P].add([p,X]);continue}H.array.push(be)}}return pe}const Ve={...T};Ve["Blueprint Cabinet"]={...Ve["Blueprint Cabinet"],goalsPurchased:1};const Ee=new de([{achieved:Ve,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,rerollConfigs:[],upgradesInProgress:[{appliance:"",cost:0,upgradeTurnTimer:0}],day:0,numFloor:0,money:0,fodderAvailable:0,deskTime:0,fps:0}],[...te]);let pe=1/0,L=0,ee=0;const he=new Es(s),_e=[];let ds=!1,Ie=[];{const y=["Booking Desk","Blueprint Cabinet"];Se.filter(m=>y.includes(m.Name)).forEach(m=>he.OwnedAppliances.push(m))}for(const y of e)he.addCard(y);function sa(y,m,H,N,Q,W){var A;let z=[],me=[],oe=[];{const se={...y};y.fodderPurchases[0]?oe.push(se):z.push(se)}const Te=Le(y.achieved,Q),Z=["upgrade","base","fodder"];for(let se=0;se<m.length;se++){const C=se+1===m.length;C&&Z.includes("fodder")&&Z.pop();const S=m[se];let h=[...z],R=[...me,...oe],D=[];for(const j of Z){if(!S)continue;let O=S.Name,w=Te[O],V=!1;switch(j){case"base":if(w&&w.goalsPurchased+w.substitutesPurchased>=ie[O].number)continue;break;case"upgrade":const J=(A=n[S.Name])==null?void 0:A.filter(M=>M!=="Starter Bin"),G=J==null?void 0:J[Math.floor(Math.random()*J.length)];if(w=Te[G],!w||(V=!0,O=G,w.goalsPurchased+w.substitutesPurchased>=ie[O].number))continue;break;case"fodder":w=Te["Starter Bin"],O="Starter Bin",V=!0}if(w){S.ThemeRequired&&(V=!1),V?w.substitutesPurchased++:w.goalsPurchased++;{const J=G=>{if(!G)return;{let q=G.actionHistory.length;for(;q--;){const ue=G.actionHistory[q];if(ue.includes(`buy ${S.Name}`))return;if(ue.includes("reroll "))break}}if(!G.numFloor)return;const M={...G};if(M.achieved={...M.achieved},!M.numFloor){console.log(m);debugger}if(M.numFloor--,M.achieved[O])M.achieved[O]={...M.achieved[O],goalsPurchased:M.achieved[O].goalsPurchased+(V?0:1),substitutesPurchased:M.achieved[O].substitutesPurchased+(V?1:0)};else if(M.achieved[O]={...w,goalsPurchased:V?0:1,substitutesPurchased:V?1:0},Number.isNaN(M.achieved[O].goalsPurchased))debugger;const X=O==="Starter Bin"?Pe(S.Name).PurchaseCost:Math.max(Pe(S.Name).PurchaseCost,Pe(O).PurchaseCost);return V?M.applianceCosts+=Math.ceil(X*(d?.5:1)):M.applianceCosts+=Math.ceil(X*(d?.5:U?.75:1)),M.actionHistory=[...M.actionHistory,`buy ${S.Name}`+(V?` for ${O}`:"")],O==="Starter Bin"&&(M.fodderPurchases=[...M.fodderPurchases],M.fodderPurchases[1]++,M.achieved[O].substitutesPurchased--),M};if(j!=="fodder"){const G=z.map(J).filter(q=>q);G.forEach(H);const M=me.map(J).filter(q=>q);M.forEach(W);const X=C?[]:oe.map(J).filter(q=>q);X.forEach(W),h=h.concat(G),R=R.concat(M),D=D.concat(X)}else{const G=(se===0?z:oe).map(J).filter(M=>M);G.forEach(W),D=D.concat(G)}}}}z=h.filter(j=>j),me=R.filter(j=>j),oe=D.filter(j=>j)}return z.concat(me).concat(oe)}let Ae=-1;{let y=F.slice(0,i).reduce((m,H)=>m+H)-g;for(;y>0;)Ae++,y-=10*Ae;console.log({maxCumulativeRerolls:Ae,money:y,expectedMoneyByDay:F,gearMoney:g})}for(Ae=1/0,Number.isFinite(i)||(Ae=3);pe;){let y=Ee.array;const m=y.reduce((C,S)=>{if(!Object.keys(C).length||Math.random()<.3)for(const h in S.achieved){const R=S.achieved[h].goalsPurchased+S.achieved[h].substitutesPurchased;C[h]?R<C[h].goalsPurchased&&(C[h].goalsPurchased=R):C[h]={...S.achieved[h],goalsPurchased:R,substitutesPurchased:0}}return C},{});if(!y.length){t("No Solutions");debugger;return 0}Ee.clear();const H=new de([],[..._,(C,S)=>C.cumulativeRerolls-S.cumulativeRerolls,(C,S)=>C.applianceCosts-S.applianceCosts]);if(ee+=F[L]??F.at(-1)??0,L++,L>=i){aa(!0,{array:y});debugger;break}if(L>14&&(d||!l.length)){debugger;break}if(L>1&&y.length===0){debugger;break}y.sort((C,S)=>S.achieved["Cake Tin"].substitutesPurchased-C.achieved["Cake Tin"].substitutesPurchased||S.fps-C.fps||S.upgradesInProgress.length-C.upgradesInProgress.length||S.achieved.Mince.substitutesPurchased-C.achieved.Mince.substitutesPurchased),console.log(`fastest so far: ${Ue(y[0],ee)}`);let N=2;switch(L){case 1:N=5;break;case 2:N=5;break;case 3:N=1;break;case 4:N=7;break;case 6:default:N=Math.min(Ae+1,7);break}N=20,N+=1;let Q=.5*60*1e3;Q=2*60*1e3,Q=1*60*60*1e3;{let C=0;for(let S=1;S<=N;S++)C+=S;Q/=C}const W=Math.min(N-1,1/0);if(ee>=g){const C=Math.sqrt((ee-g)/10*2);console.log(`Have ${ee} on day ${L}, need ${g} to buy everything. Allows for ~${C} rerolls across all days`)}L%5||(N=1);let z;(d||L===5||!(L%3))&&(z=l.shift());const me=Oe.filter(C=>C.Name===z)[0];he.handleNewCardSpawnEffects(me);const oe=he.getAppliances([{spawnInside:!0,blueprintCount:$}],L);let Te=[];if(_e.length)for(let C=_e.length-1;C>=0;C--){let S=oe.length;for(;S--;){const h=oe[S];if(h.Name===_e[C]){if(console.log(`buying ${h.Name} on day ${L}`),ee-y.reduce((D,j)=>Math.min(D,j.applianceCosts+10/2*(j.cumulativeRerolls+1)*j.cumulativeRerolls),1/0)<h.PurchaseCost*(d?.5:U?.75:1)){console.log("not enough money-- skip for now");continue}Ie.push(h),_e.splice(C,1),ee-=h.PurchaseCost*(d?.5:U?.75:1),oe.splice(S,1);break}}Te=Ie.map(h=>`Buy ${h.Name}`)}let Z=new de([{day:L,rerollConfigs:[],achieved:{...T},numFloor:$,fodderAvailable:o,fodderUsed:0,money:ee,actionHistory:[],applianceCosts:0,cumulativeRerolls:0,fodderPurchases:[0,0]}],[(C,S)=>he.getPrngAdvancements(C.rerollConfigs,L)-he.getPrngAdvancements(S.rerollConfigs,L),(C,S)=>-he.getPrngAdvancements(C.rerollConfigs,L)+he.getPrngAdvancements(S.rerollConfigs,L),..._,(C,S)=>C.cumulativeRerolls-S.cumulativeRerolls,(C,S)=>C.applianceCosts-S.applianceCosts,(C,S)=>S.numFloor+S.fodderAvailable-C.numFloor+C.fodderAvailable,(C,S)=>C.numFloor-S.numFloor]);De=[],je(y,Z.array[0],Ee,!0);let A=1/0;const se=C=>De.map(S=>S.array.reduce((h,[R,D])=>Math.min(h,D+(R+1+R+C)/2*C*10),1/0));{const C=N;for(;se(N-1)[0]>ee;)N--;N!==C&&console.log(`clamped max rerolls from ${C} down to ${N}`)}e:for(;N--&&(Ie.length&&((ms=(gs=Z.array[0])==null?void 0:gs.rerollConfigs)==null?void 0:ms.length)===1&&(Ie.some(h=>h.Name==="Research Desk")&&(ds=!0),he.OwnedAppliances.push(...Ie),Ie=[],Te=[]),A=Date.now()+Q*(((bs=(Ts=Z.array[0])==null?void 0:Ts.rerollConfigs)==null?void 0:bs.length)??1),Z.array[0]!==void 0);){console.log(`Seed ${s} Day ${L} Reroll ${Z.array[0].rerollConfigs.length} expanding ${Z.array.length} states`);let C=Z.array;if(!k.length&&pe<=0){const h=C[0].rerollConfigs.length;if(h*((h+1)/2)*10+g>ee){console.log("get me outta here!");break}}Z.clear(),L>2?C.sort((h,R)=>R.achieved["Cake Tin"].substitutesPurchased-h.achieved["Cake Tin"].substitutesPurchased||os(h,R)||R.achieved.Freezer.substitutesPurchased-h.achieved.Freezer.substitutesPurchased||R.achieved.Mince.substitutesPurchased-h.achieved.Mince.substitutesPurchased||R.fodderUsed-h.fodderUsed||h.numFloor-R.numFloor||h.fodderPurchases[1]-R.fodderPurchases[1]):C.sort((h,R)=>R.achieved.Mince.substitutesPurchased-h.achieved.Mince.substitutesPurchased||os(h,R)||R.achieved["Cake Tin"].substitutesPurchased-h.achieved["Cake Tin"].substitutesPurchased||h.numFloor-R.numFloor||h.fodderPurchases[1]-R.fodderPurchases[1]);const S=se(C[0].rerollConfigs.length);console.log({minSpentMoneyByExtraBlueprints:S});for(const h of C){if(Date.now()>A){Z.array.sort((w,V)=>V.achieved["Cake Tin"].substitutesPurchased-w.achieved["Cake Tin"].substitutesPurchased||is(b[0],w.achieved)-is(b[0],V.achieved)||w.fodderUsed-V.fodderUsed||w.numFloor-V.numFloor||V.applianceCosts-w.applianceCosts);continue e}if(h.numFloor+h.fodderAvailable===0||h.money<h.rerollConfigs.length*10)continue;let R=0;if(S[0]>h.money)continue;for(let w=1;w<S.length;w++)if(R++,S[w]>h.money){R=w-1;break}let D=h.rerollConfigs.length?h.numFloor+Math.min(h.fodderAvailable,R-h.fodderUsed):$;h.fodderPurchases[1]&&(D=h.numFloor);const j=W<h.rerollConfigs.length?h.numFloor:h.rerollConfigs.length?Math.max(1,h.numFloor):$;let O;h.rerollConfigs.length===0?O=Y:W<h.rerollConfigs.length?O=[h.rerollConfigs.at(-1)]:O=B,he.getAppliances([...h.rerollConfigs,{spawnInside:!0,blueprintCount:D}],h.day);for(const w of O){const V=M=>{Z.add(M)&&H.add(M)},J=M=>{if(!Z.add(M)||!H.add(M))return;M.fodderPurchases[0]+M.fodderPurchases[1]||je(y,M,Ee)},G=[j];D>j&&G.push(D);for(let M=D-1;M>j;M--)G.push(M);for(const M of G){const X=[...h.rerollConfigs,{...w,blueprintCount:M}],q=X.length===1?oe:he.getAppliances(X,h.day),ue=[...q].sort((ge,He)=>ge.PurchaseCost-He.PurchaseCost),ve=M-h.numFloor;if(ve>h.fodderAvailable)debugger;const Be={...h,fodderPurchases:[h.fodderPurchases[1],0],money:h.money-h.rerollConfigs.length*10,rerollConfigs:X,numFloor:X.length===1?M-Ie.length:M,fodderAvailable:h.fodderAvailable-ve,fodderUsed:h.fodderUsed+ve,cumulativeRerolls:h.rerollConfigs.length?h.cumulativeRerolls+1:0,actionHistory:h.rerollConfigs.length?[...h.actionHistory,`${ve?`take ${ve} out, `:""}reroll ${w.spawnInside?"I":w.playerInside?"OI":"OO"}`]:[`day ${h.day} spawn`,`spawn ${w.spawnInside?"I":w.playerInside?"OI":"OO"}`,...Te]};Be.rerollConfigs.length===1&&Be.rerollConfigs[0].spawnInside===!0?J(Be):V(Be);let Ge=J;if((!w.spawnInside||M>j&&!ie[q.at(-1).Name]&&((Cs=n[q.at(-1).Name])!=null&&Cs.every(ge=>!ie[ge])))&&(Ge=V),sa(Be,ue,Ge,N,m,V),Date.now()>A)break}}}}if(he.addCard(me),pe<=0){if(!k.length){re.array.sort((C,S)=>S.fps-C.fps),t((pe<=0?`full build on ${s} by day ${L}: 
`:"")+re.array.map(C=>Ue(C,ee)).join(`
`));break}for(const C of Object.values(f))C.number&&he.OwnedAppliances.push(Pe(C.goal));f=k.shift(),b.shift(),_=[];for(const{goal:C,number:S}of Object.values(b[0]))_.push(Qe(S,C));pe=1/0,De=[],ps(!0);debugger;Ee.array=re.array,re.clear(),re.objectiveFunctions}}return L;function aa(y=!1,m=Ee){(Math.random()<.001||y)&&m.array.sort((H,N)=>N.fps-H.fps),t(`tier ${a.length-k.length-(y?1:0)} build on ${s} by day ${L}${y?"":" (Partial)"}: 
`+m.array.slice(0,100).map(H=>Ue(H,ee)).join(`
`))}function ps(y=!1){(Math.random()<.001||y)&&re.array.sort((m,H)=>H.fps-m.fps),t(`tier ${a.length-k.length-(y?1:0)} build on ${s} by day ${L}${y?"":" (Partial)"}: 
`+re.array.slice(0,100).map(m=>Ue(m,ee)).join(`
`))}}function _s(s,e){const l=e.achieved;let a=0;const r=e.upgradesInProgress.filter(c=>c.appliance==="Cake Tin").length,F=e.achieved["Copying Desk"].goalsPurchased+e.achieved["Copying Desk"].substitutesPurchased,u=[[33,!1]];for(const[c,t]of u){const i=Math.min(8*F,r),f=e.upgradesInProgress.length+e.upgradesInProgress.filter(b=>b.appliance==="Mince").length*2,k=Math.min(Math.ceil(Math.min(c,Math.max(0,(c-e.fps-(t?r:0))/(i+1-1/(f-r+1))))));a+=k}for(const c of Object.values(s)){const i=c.number-l[c.goal].goalsPurchased-l[c.goal].substitutesPurchased;a+=Math.max(0,i)}return a}function is(s,e){let l=0;for(const a of Object.values(s)){const F=a.number-e[a.goal].goalsPurchased-e[a.goal].substitutesPurchased;l+=Math.max(0,F)}return l}function Ue(s,e){const l=s.cumulativeRerolls*(s.cumulativeRerolls+1)/2*10+s.applianceCosts;return`${s.day}: ${Gs(s)} total rerolls: ${s.cumulativeRerolls}, appliance costs: ${s.applianceCosts} (money spent: ${l}/${e}), `+s.actionHistory.join(", ")+JSON.stringify(s.upgradesInProgress)}function os(s,e){let l=0;const a=s.rerollConfigs[0],r=e.rerollConfigs[0];return!a||a.playerInside===r.playerInside?0:(a.playerInside===!1&&l--,r.playerInside===!1&&l++,l)}const Ze={};function Xe(s){const{starters:e,main:l,doubleOrderChance:a,desserts:r,sides:F,groupSizes:u}=s,c=[e,l,a,r,F,[...u].sort((o,g)=>o-g)].join("|");if(Ze[c])return Ze[c];let t=[0,0,0],i=[0,0,0,0],f=1-.75**F;if(e>0){t[0]=1;let o=1-.75**e;a===.5&&(o*=1.25,f*=1.25),i[0]=u.reduce((g,T)=>g+1+(T-1)*o,0)}const k=u.reduce((o,g)=>o+g);l&&(t[1]=1,i[1]=k),r>0&&(i[2]=k,l?(t[2]=1-.75**r,a===.5&&(t[2]*=1.25)):t[2]=1);let b=1;e>0&&(t[0]*=1+a,b*=1-a,i[0]*=t[0]),l&&(t[1]*=1+b*a,b*=1-a,i[1]*=t[1],i[3]=i[1]*f),r>0&&(t[2]*=1+b*a,b*=1-a,i[2]*=t[2]);const n=[t.map(o=>o*u.length),i];return Ze[c]=n,n}function Ks(s){const{starters:e,main:l,doubleOrderChance:a,desserts:r,sides:F,groupSizes:u}=s;let c=[0,0,0],t=[0,0,0,0],i=1-.75**e,f=1-.75**r,k=1-.75**F;a===.5&&(i*=1.25,f*=1.25,k*=1.25);const b=T=>{c[0]++,t[0]++;for(let d=0;d<T-1;d++)Math.random()<i&&t[0]++},n=T=>{c[1]++,t[1]+=T;for(let d=0;d<T;d++)Math.random()<k&&t[3]++},o=T=>{c[2]++,t[2]+=T};for(const T of u){let d=!1;e>0&&(b(T),!d&&Math.random()<a&&(d=!0,b(T))),n(T),!d&&Math.random()<a&&(d=!0,n(T)),r>0&&Math.random()<f&&(o(T),!d&&Math.random()<a&&(d=!0,o(T)))}return[c,t]}const Ys={"Diner (1)":1,"Small (2)":2,"Medium (2)":2,"Large (3)":3,"Huge (4)":4},us={};["Morning Rush","Lunch Rush","Dinner Rush"].forEach(s=>us[s]=!0);class Js{constructor(e,l=[],a=[]){I(this,"seed");I(this,"mapSize");I(this,"frontDoor");I(this,"startingCards");I(this,"cards");I(this,"playerCount");I(this,"turbo");I(this,"_actionInfoCacheByCards",{});I(this,"_cardsByDay",[]);this.seed=e,this.mapSize=this.getMapSize(),this.frontDoor=this.getDoorInfo(),this.startingCards=l,this.cards=a,this.playerCount=Ys[this.mapSize],this.turbo=this.startingCards.some(r=>{if(r===void 0){console.log({startingCards:l});debugger}return r.Name==="Turbo"})}guessMoney(e){if(e===0)return this.turbo?30:0;const l=this.getCardsByDay(e),a=this.getGroupSizes(e);let r=!1,F=!1,u=0,c=[],t=[],i=0,f=[],k=0,b=[];for(const v of l)switch(v.Name==="All You Can Eat"&&(r=!0),v.Name==="Double Helpings"&&(F=!0),v.DishType){case E.Dessert:i++,v.DishValue&&f.push(v.DishValue);break;case E.Starter:v.DishValue&&c.push(v.DishValue),u++;break;case E.Side:v.DishValue&&b.push(v.DishValue),k++;break;case E.Main:case E.Base:if(v.Name==="Sundaes"){debugger;f.push(4,5,5,6);break}v.Name==="Tacos"?(t.push(2),t.push(3)):v.DishValue&&t.push(v.DishValue)}let n=F?.5:r?.25:0,o=[0,0,0,0];if(o[0]=ke(c),o[1]=ke(t),o[2]=ke(f),o[3]=ke(b),F)for(let v=0;v<3;v++)o[v]&&(o[v]+=3);const[g,T]=Xe({starters:u,main:!!o[1],doubleOrderChance:n,desserts:i,sides:k,groupSizes:a});let d=0;for(let v=0;v<T.length;v++)d+=T[v]*o[v];const U=cs(this.playerCount),te=this.getBookingDeskCount(e),_=this.getBookingDeskMoney(e);return Math.ceil(U*(d+te*_))}courseInfo(e){if(e===0)return[[0,0,0],[0,0,0,0]];const l=this.getCardsByDay(e),a=this.getGroupSizes(e);let r=!1,F=!1,u=0,c=[],t=[],i=0,f=[],k=0,b=[];for(const T of l)switch(T.Name==="All You Can Eat"&&(r=!0),T.Name==="Double Helpings"&&(F=!0),T.DishType){case E.Dessert:i++,T.DishValue&&f.push(T.DishValue);break;case E.Starter:T.DishValue&&c.push(T.DishValue),u++;break;case E.Side:T.DishValue&&b.push(T.DishValue),k++;break;case E.Main:case E.Base:if(!T.isMain){if(i++,T.Name==="Sundaes"){debugger;f.push(4,5,5,6);break}T.DishValue&&f.push(T.DishValue);break}T.Name==="Tacos"?(t.push(2),t.push(3)):T.DishValue&&t.push(T.DishValue)}let n=F?.5:r?.25:0,o=[0,0,0,0];if(o[0]=ke(c),o[1]=ke(t),o[2]=ke(f),o[3]=ke(b),F)for(let T=0;T<3;T++)o[T]&&(o[T]+=3);return Xe({starters:u,main:!!o[1],doubleOrderChance:n,desserts:i,sides:k,groupSizes:a})}actionInfo(e){if(e===0)return 0;const l=this.getCardsByDay(e),a=e.toString()+":"+l.map(B=>B.Name).sort().join(","),r=this._actionInfoCacheByCards[a];if(r)return r;let F=0;const u={Breakfast:6,Dumplings:11.25,"Stir Fry":26/2,Steak:7};let c=0;for(let B=0;B<l.length;B++)if(l[B].DishType!==E.Null){const Y=l[B].Name;c=u[Y]??20;break}let t=-1,i=[1,1,1],f=[[],[c],[],[]],k=0;const b=this.getGroupSizes(e);let n=!1,o=!1,g=0,T=[],d=[],U=0,te=[],_=0,v=[],x=!1,ie=!1;for(const B of l){switch(B.Name==="All You Can Eat"&&(n=!0),B.Name==="Double Helpings"&&(o=!0),B.Name){case"Picky Eaters":x=!0;break;case"Leisurely Eating":ie=!0,k+=2;break;case"Instant Service":for(let Y=0;Y<3;Y++)i[Y]--;break;case"Ice Cream":f[2].push(5.125);break;case"Cheese Board":f[2].push(10);break;case"Cherry Pies":f[2].push(11);break;case"Apple Pies":f[2].push(15);break;case"Pumpkin Pies":f[2].push(16);break;case"Carrot Soup":case"Meat Soup":f[0].push(7);break;case"Tomato Soup":case"Pumpkin Soup":i[0]=4,f[0].push(8);break;case"Broccoli Cheese Soup":f[0].push(5),i[0]=4;break;case"Pumpkin Seed":f[0].push(3*8);break;case"Bread":f[0].push(5*3);break;case"Mandarin Starter":f[0].push(7*3);break;case"Mashed Potato":case"Broccoli":case"Bamboo":f[3].push(2);break;case"Onion Rings":f[3].push(8);break;case"Corn on the Cob":f[3].push(6);break;case"Chips":f[3].push(7);break;case"Roast Potato":f[3].push(4);break}switch(B.DishType){case E.Dessert:U++,B.DishValue&&te.push(B.DishValue);break;case E.Starter:B.DishValue&&T.push(B.DishValue),g++;break;case E.Side:B.DishValue&&v.push(B.DishValue),_++;break;case E.Main:case E.Base:if(B.Name==="Sundaes"){debugger;te.push(4,5,5,6);break}B.Name==="Tacos"?(d.push(2),d.push(3)):B.DishValue&&d.push(B.DishValue);break;case E.Extra:B.Name==="Seaweed"?(f[1][0]+=1.75,t+=2):B.Name==="Dumpling - Soy Sauce"?f[1][0]+=.4:B.Name==="Breakfast Beans"?f[1][0]+=1+3/4:B.Name==="Breakfast Eggs"?f[1][0]+=6:B.Name==="Breakfast Extras"&&(t++,f[1][0]+=1.5*2),t++;break}}e>6&&(f[3]=[]),x&&(ie&&!n||(f[1][0]+=2,t++));let Me=o?.5:n?.25:0;F+=b.length*k;const[re,$]=Xe({starters:g,main:!0,doubleOrderChance:Me,desserts:U,sides:_,groupSizes:b});re.forEach((B,Y)=>F+=B*i[Y]);for(const B of f)for(let Y=0;Y<B.length;Y++)t>0&&(B[Y]+=t),t+=1;return $.forEach((B,Y)=>{var Le;if((Le=f[Y])!=null&&Le.length){if(!Y){const De=Math.ceil(B/f[Y].length/3);F+=De*f[Y].reduce((je,Ve)=>je+Ve,0);return}F+=B*ke(f[Y])}}),this._actionInfoCacheByCards[a]=F,F}simulateMoney(e){if(e===0)return this.turbo?30:0;const l=this.getCardsByDay(e),a=this.getGroupSizes(e);let r=!1,F=!1,u=[[],[],[],[]];for(const g of l){if(g.Name==="All You Can Eat"&&(r=!0),g.Name==="Double Helpings"&&(F=!0),g.Name==="Sundaes")debugger;switch(g.DishType){case E.Main:case E.Base:if(g.Name==="Sundaes"){debugger;u[1].push(4,5,5,6);break}g.Name==="Tacos"?u[1].push(2.5):g.DishValue&&u[1].push(g.DishValue);break;case E.Dessert:g.DishValue&&u[2].push(g.DishValue);break;case E.Starter:g.DishValue&&u[0].push(g.DishValue);break;case E.Side:g.DishValue&&u[3].push(g.DishValue);break}}let c=F?.5:r?.25:0,t=0;F&&(t+=3);const[i,f]=Ks({starters:u[0].length,main:!!u[1].length,doubleOrderChance:c,desserts:u[2].length,sides:u[3].length,groupSizes:a});let k=0;for(let g=0;g<f.length;g++){let T=f[g];for(;T--;){g<3&&(k+=t);let d=u[g][Math.floor(Math.random()*u[g].length)];d%1&&(Math.random()<d%1?d=Math.ceil(d):d=Math.floor(d)),k+=d}}const b=cs(this.playerCount),n=this.getBookingDeskCount(e),o=this.getBookingDeskMoney(e);return Math.ceil(b*(k+n*o))}getBookingDeskMoney(e){return Math.ceil((e+1)/2)+2}clearCardsCache(){this._cardsByDay=[]}getCardsByDay(e){if(this._cardsByDay[e]===void 0){let l;this.turbo?l=e-1:(l=Math.max(0,Math.floor((e-1)/3)),e>5&&l++),this._cardsByDay[e]=[...this.startingCards,...this.cards.slice(0,l)]}return this._cardsByDay[e]}getBookingDeskCount(e,l=1){const a=Math.ceil(this.getExpectedCustomers(e)/this.getExpectedGroupSize(e));if(this.getCardsByDay(e).some(i=>i.Name==="Herd Mentality"))return Math.min(a,3)+1;const r=[],F=this.getCardsByDay(e);let u=1;(this.turbo||F.some(i=>i.Name==="Morning Rush"))&&r.push(.2),(this.turbo||F.some(i=>i.Name==="Lunch Rush"))&&r.push(.5),(this.turbo||F.some(i=>i.Name==="Dinner Rush"))&&r.push(.8);const c=l/this.getDayLength(e),t=.1/a;u+=a-1;for(let i=1;i<a;i++){const f=i/a,k=f-t-c,b=f+t+c;for(let n=r.length-1;n>=0;n--){const o=r[n];k<=o&&o<=b&&r.splice(n,1)}}return u+=r.length,u}getNonRushGroupCount(e){const l=this.getExpectedCustomers(e),a=this.getCardsByDay(e).filter(u=>u.Name==="Closing Time?").length*.2,r=this.getExpectedGroupSize(e),F=l*(1+a)/r;return Math.ceil(F)}getCustomerCount(e){return this.getGroupSizes(e).reduce((l,a)=>l+a,0)}getGroupSizes(e,l=0){const a=this.seed?ls(1997821,e,this.seed).random:new Je(Math.floor(Math.random()*4294967295)),r=this.getNonRushGroupCount(e),F=this.getCardsByDay(e).some(n=>n.Name==="Herd Mentality");let u=r,c=[],[t,i]=this.getGroupSizeRange(e);!this.seed||this.seed==="_min"?i=t:this.seed==="_max"&&(t=i);{let n=u-1;for(;n--;)a.value}for(;u--;)c.push(a.range(t,i+1)),!F&&u!==r-1&&a.value;let f=this.turbo?3:this.getCardsByDay(e).filter(n=>us[n.Name]).length,k;switch(l){case 0:k=Math.ceil(Math.max(1,r*.15));break;case 1:k=Math.ceil(Math.max(1,this.getExpectedCustomers(e)*.15));break;case 2:k=Math.ceil(Math.max(1,r*.15*1.5))}let b=f*k;for(;b--;)c.push(a.range(t,i+1));if(!this.seed||this.seed[0]==="_"){let n=t;for(let o=0;o<c.length;o++)c[o]=n,n++,n>i&&(n=t)}return c}getExpectedGroupSize(e){const l=this.getGroupSizeRange(e);return(l[0]+l[1])/2}getGroupSizeRange(e){let l=1,a=2;for(const r of this.getCardsByDay(e))switch(r.Name){case"Individual Dining":a--;break;case"Medium Groups":l++,a+=2;break;case"Large Groups":l+=2,a+=2;break;case"Flexible Dining":l--,a++;break;case"Community":const F=Math.floor((e-1)/3);l+=F,a+=F;break}return[l,a]}getExpectedCustomers(e){const l=this.getReductions(e),a=this.getDayLength(e),r=this.getPlayerModifier(),F=this.getCourseModifier(e),u=this.getDayRate(e),c=this.getCustomersPerHour(e),t=this.getAdvertisingModifier(e);return .85**l*(a/25*u*r)/F*c*t}getAdvertisingModifier(e){return 1+.25*this.getCardsByDay(e).filter(a=>a.Name==="Advertising").length}getDayRate(e){let l=1;switch(e){case 1:l=1.25;break;case 2:l=1.5;break;default:l=1.5+.15*(e-3);break}return e>15&&(l+=.15*(e-15)**1.5),l}getCourseModifier(e){let l=1;const a=this.getCardsByDay(e);return a.some(r=>r.DishType===E.Dessert||r.Name==="Black Coffee"||r.Name==="Cakes"||r.Name==="Sundaes")&&(l+=.25),a.some(r=>r.DishType===E.Starter)&&(l+=.25),l}getPlayerModifier(){let e;switch(this.playerCount){case 0:e=1;break;case 1:e=.8;break;case 2:e=1;break;case 3:e=1.25;break;default:e=1.5;break}return e}getDayLength(e){return 100+Math.floor(e/3)*25}getCustomersPerHour(e){let l=1;return this.turbo&&(l=1.5,l*=1+e/10),l}getReductions(e){return this.getCardsByDay(e).reduce((a,r)=>a+r.CustomerMultiplier,0)}getMapSize(){const l=new Re(this.seed,5078598).useSubcontext(0).random.range(0,8);let a;switch(l){case 0:a="Small (2)";break;case 4:a="Medium (2)";break;case 1:case 5:a="Diner (1)";break;case 2:case 6:a="Large (3)";break;case 3:case 7:a="Huge (4)";break;default:throw new Error}return a}getLayoutInfo(){const l=new Re(this.seed,5078598).useSubcontext(0).random.range(0,8);let a,r;switch(l){case 0:r=70,a=2;break;case 4:r=84,a=2;break;case 1:case 5:r=60,a=1;break;case 2:case 6:r=9*13,a=3;break;case 3:case 7:r=12*16,a=4;break;default:throw new Error}return[a,r]}getDoorInfo(){if(this.mapSize!=="Diner (1)")return-1;let e=new Je(new Re(this.seed,98234234).useSubcontext(0).random.value),l=23;for(;l--;)e.value;return e.range(0,4)}}function cs(s){switch(s){case 1:return 1.25;case 2:return 1.1;default:return 1}}function Qs(s,e,l,a){let r=[],F=[],u=[];const c=s.cards.slice(e);let t=new Js(s.seed,l,c);t.playerCount=a;for(let i=1;i<=15;i++)u.push(t.getCustomerCount(i)),r.push(t.guessMoney(i)),F.push(t.getBookingDeskCount(i));return r[0]+=t.guessMoney(0),{expectedMoneyByDay:r,expectedBookingDesksByDay:F,expectedCustomersByDay:u}}var hs=self;function Zs(s){hs.postMessage(s)}const Xs=[],ea=[{goal:"Copying Desk",number:1,substitutes:[],skipMissing:!0},{goal:"Clipboard Stand",number:1,substitutes:[],skipMissing:!0},{goal:"Research Desk",number:0,substitutes:[],skipMissing:!0},{goal:"Cake Tin",number:20,substitutes:[],skipMissing:!0},{goal:"Mince",number:8,substitutes:[],skipMissing:!0},{goal:"Blueprint Cabinet",number:0,substitutes:[],skipMissing:!0},{goal:"Starter Bin",number:999,substitutes:Se.filter(s=>!s.ThemeRequired&&!Xs.includes(s.Name)).map(s=>s.Name),skipMissing:!0}];hs.onmessage=s=>{let{config:e,tiers:l,playerCount:a,maxDay:r=15}=s.data;for(const n of l)for(const o of n){const g=Se.filter(T=>T.Name===o.goal)[0];g.ThemeRequired&&(o.substitutes=Se.filter(T=>T.ThemeRequired===g.ThemeRequired).map(T=>T.Name))}for(;!l.at(-1).length;)l.pop();const F=[...ea],u=l.flatMap(n=>n.flatMap(o=>[o.goal,...o.substitutes])),c=F.length-1;F[c].substitutes=F[c].substitutes.filter(n=>!u.some(o=>n===o)),l[l.length-1].push(...F);const t=e.cards.filter(n=>Fs.some(o=>o.Name===n.Name)).length+1,i=e.cards.slice(0,t);let{expectedMoneyByDay:f,expectedBookingDesksByDay:k,expectedCustomersByDay:b}=Qs(e,t,i,a);js(e.seed,i,e.cards.slice(t).map(n=>n.Name),l,e.solo,f,k,b,Zs,r)}})();
