var M=Object.defineProperty;var A=(e,a,F)=>a in e?M(e,a,{enumerable:!0,configurable:!0,writable:!0,value:F}):e[a]=F;var t=(e,a,F)=>A(e,typeof a!="symbol"?a+"":a,F);import{S as D}from"./utils-tfuuBPsB.js";import{F as I,e as w,d as y}from"./prng-Dkxo81-X.js";const N=`505496455,False,True,Heated Mixer,False,False,,2087693779:-523839730:1972879238,64,0,0,False,False,60
...
`,E=["ID","IsPurchasable","IsPurchasableAsUpgrade","Name","SellOnlyAsDuplicate","SellOnlyAsUnique","RequiresForShop","RequiresProcessForShop","ShoppingTags","ThemeRequired","ShopRequirementFilter","StapleWhenMissing","AllowRefreshes","PurchaseCost"],L=["number","boolean","boolean","string","boolean","boolean","number[]","number[]","number","number","number","boolean","boolean","number"],C=N.trim().split(`\r
`).map(e=>{const a=e.split(",");let F={};for(let l=0;l<a.length;l++){let u;switch(L[l]){case"number":u=Number(a[l]);break;case"boolean":u=a[l]==="True";break;case"number[]":a[l]===""?u=[]:u=a[l].split(":").map(i=>Number(i));break;default:u=a[l]}F[E[l]]=u}return F});class O{constructor(a){t(this,"Staple");t(this,"Tags");t(this,"StapleWhenMissing");t(this,"Appliance");t(this,"IsRemoved");t(this,"Filter");t(this,"DecorationRequired");t(this,"SellAsUpgrade");this.Appliance=a,this.Tags=a.ShoppingTags,this.DecorationRequired=a.ThemeRequired,this.SellAsUpgrade=a.IsPurchasableAsUpgrade,this.Filter=a.ShopRequirementFilter,this.StapleWhenMissing=a.StapleWhenMissing,this.Staple=0,this.IsRemoved=!1}MatchesRequestTags(a){return a&1?this.Staple!==0:a&this.Tags?this.Staple===0:!1}}var h=(e=>(e[e.NonStaple=0]="NonStaple",e[e.FixedStaple=1]="FixedStaple",e[e.BonusStaple=2]="BonusStaple",e[e.WhenMissing=3]="WhenMissing",e))(h||{}),m=(e=>(e[e.None=0]="None",e[e.Basic=1]="Basic",e[e.Decoration=2]="Decoration",e[e.Technology=4]="Technology",e[e.FrontOfHouse=8]="FrontOfHouse",e[e.Plumbing=16]="Plumbing",e[e.Cooking=32]="Cooking",e[e.Automation=64]="Automation",e[e.Christmas=128]="Christmas",e[e.Misc=256]="Misc",e[e.Office=512]="Office",e[e.BlueprintUpgrader=1024]="BlueprintUpgrader",e[e.BlueprintStore=2048]="BlueprintStore",e[e.Halloween=4096]="Halloween",e[e.SpecialEvent=8192]="SpecialEvent",e))(m||{});const R={DefaultShoppingTag:892};var B=(e=>(e[e.None=0]="None",e[e.RefreshableProvider=1]="RefreshableProvider",e))(B||{}),p=(e=>(e[e.Null=0]="Null",e[e.Exclusive=1]="Exclusive",e[e.Affordable=2]="Affordable",e[e.Charming=4]="Charming",e[e.Formal=8]="Formal",e[e.Kitchen=16]="Kitchen",e))(p||{});const x="39",U=Number(x),W=["Sink","Plates","Dish Rack","Dish Washer","Power Sink","Soaking Sink","Auto Plater"],k={};for(const e of W)k[e]=!0;const q=C.filter(e=>e.IsPurchasable||e.IsPurchasableAsUpgrade).length;class Q{constructor(a,F=0,l=!1){t(this,"seed");t(this,"mapSize");t(this,"numTiles");t(this,"baseUpgradeChance");t(this,"januaryRedEnvelopes");t(this,"OwnedAppliances");t(this,"Cards");t(this,"Theme");t(this,"cache",new Map);t(this,"cacheDay");this.seed=a,[this.mapSize,this.numTiles]=this.getLayoutInfo(),this.baseUpgradeChance=F,this.januaryRedEnvelopes=l,this.OwnedAppliances=[],this.Cards=[],this.Theme=p.Null,this.cacheDay=-1}getLayoutInfo(){const F=new I(this.seed,5078598).useSubcontext(0).random.range(0,8);let l,u;switch(F){case 0:u=70,l=2;break;case 4:u=84,l=2;break;case 1:case 5:u=60,l=1;break;case 2:case 6:u=9*13,l=3;break;case 3:case 7:u=12*16,l=4;break;default:throw new Error}return[l,u]}handleNewCardSpawnEffects(a){a!==void 0&&(a.Name==="Turbo"&&(this.baseUpgradeChance=.25),a.ID===507410699&&(this.januaryRedEnvelopes=!0),a.UnlockGroup===w.PrimaryTheme&&(this.Theme=p[a.Name]))}handleNewCardRerollEffects(a){a!==void 0&&(this.OwnedAppliances=this.OwnedAppliances.concat(a.IngredientProviders.flatMap(F=>C.filter(l=>l.ID===F))))}addCard(a){a!==void 0&&(this.handleNewCardSpawnEffects(a),this.handleNewCardRerollEffects(a),this.Cards.push(a))}getPrngAdvancements(a,F){let l=0;for(let u=0;u<a.length;u++){const i=a[u];let s=i.blueprintCount;F%5===0&&(s+=3,u===0&&(s+=2)),l+=s*(q-1+1),i.spawnInside||(l+=H(i.playerInside,this.numTiles)),l+=U}return l}buildShopOptions(a,F,l){const u=l.some(c=>c.Name==="Couples");let i=[];for(const c of C)if(!(!c.IsPurchasable&&!c.IsPurchasableAsUpgrade)){var s=new O(c);const d=s.Appliance.Name;(s.Staple==h.NonStaple||s.Staple==h.WhenMissing)&&((s.Tags&m.Basic)>m.None?s.Staple=h.FixedStaple:s.StapleWhenMissing?(d!="Research Desk"&&d!="Blueprint Cabinet"&&d!="Plates"&&console.log(`Unexpected ${d} StapleWhenMissing Appliance`),a.some(r=>r.ID===s.Appliance.ID)?s.Staple=h.NonStaple:s.Staple=h.WhenMissing):u&&d==="Flower Pot"&&(s.Staple=h.BonusStaple));const n=s.Appliance;if(n.SellOnlyAsDuplicate)a.some(r=>r.ID===n.ID)||(s.IsRemoved=!0);else if(n.RequiresForShop.length>0){let r=!1;for(const T of n.RequiresForShop)a.some(b=>b.ID===T)&&(r=!0);s.IsRemoved=!r}else n.SellOnlyAsUnique&&(n.Name!="Booking Desk"&&console.log(`SellOnlyAsUnique: ${n.Name}, ${n.ID}`),a.some(r=>r.ID===n.ID)&&(s.IsRemoved=!0));k[d]&&l.every(r=>!r.isMain||r.Name==="Tacos")&&(s.IsRemoved=!0),s.Filter==B.RefreshableProvider&&(a.some(r=>r.AllowRefreshes)||(s.IsRemoved=!0)),s.DecorationRequired!=p.Null&&s.DecorationRequired!=F&&(s.IsRemoved=!0),n.RequiresProcessForShop.length>0&&(n.RequiresProcessForShop.some(r=>l.some(T=>T.RequiredProcesses.includes(r)))||(s.IsRemoved=!0)),i.push(s)}return i}initRandom(a){return y(823828,a,this.seed)}getAppliances(a,F){F!==this.cacheDay&&(this.cacheDay=F,this.cache.clear());const l=a.length===1,u=this.buildShopOptions(this.OwnedAppliances,this.Theme,this.Cards);let i=a[a.length-1].blueprintCount,s;if(F%5==0){l?i=10:i+=3,s=[];for(let n=0;n<i;n++)s[n]=m.Decoration;if(l)for(const n of[1,2])s[s.length-n]=m.SpecialEvent}else if(a.length>1){s=[];for(let n=0;n<i;n++)s[n]=R.DefaultShoppingTag}else{const n=R.DefaultShoppingTag,r=Math.max(1,i),T=Math.max(0,Math.min(u.filter(o=>o.Staple!==h.NonStaple&&!o.IsRemoved).length,Math.max(2,4-Math.floor(F/5)),r)),b=Math.max(0,r-T);i=r,s=[];for(let o=0;o<T;o++)s[o]=m.Basic;for(let o=T;o<T+b;o++)s[o]=n}const c=this.initRandom(F).random;let S=this.getPrngAdvancements(a.slice(0,a.length-1),F);if(this.cache.has(S)&&this.cache.get(S).length>=i)return this.cache.get(S).slice(0,i);const d=S;for(;S--;)c.value;{const n=[...u],r=[],T=this.getUpgradeChance(F),b=[];for(let o=0;o<i;o++){const P=s[o],v=c.valueFloat<T;D(n,c);for(let g=0;g<n.length;g++){const f=n[g];if(f.IsRemoved||b.includes(f.Appliance)||!f.MatchesRequestTags(P)||!v&&f.Staple==h.NonStaple&&f.SellAsUpgrade)continue;P!=m.Decoration&&b.push(f.Appliance),r[o]=f.Appliance;break}r[o]==null}return this.cache.set(d,r),r}}getUpgradeChance(a){let F=1-(1-Math.floor(a/5)*.1)*(1-this.baseUpgradeChance);return this.januaryRedEnvelopes&&(F=F+(1-F)*.2),F}}function H(e,a){return e?a-2:a-1}export{C as A,Q as S};
