var O=Object.defineProperty;var q=(e,a,s)=>a in e?O(e,a,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[a]=s;var S=(e,a,s)=>q(e,typeof a!="symbol"?a+"":a,s);var u=(e=>(e[e.Generic=0]="Generic",e[e.Dish=1]="Dish",e[e.PrimaryTheme=3]="PrimaryTheme",e[e.SecondaryTheme=4]="SecondaryTheme",e[e.Franchise=5]="Franchise",e[e.Special=6]="Special",e))(u||{}),t=(e=>(e[e.Base=0]="Base",e[e.Main=1]="Main",e[e.Extra=2]="Extra",e[e.Side=3]="Side",e[e.Starter=4]="Starter",e[e.Dessert=5]="Dessert",e[e.Null=6]="Null",e))(t||{});const A=`373996608,Ice Cream,1,,934171642,,-1533430406,False,False,5,1,1,1,0,0
...
`,G=`-959076098,Steak,1,1972879238,-484165118:380220741,True,False,0,0,3
...
`,T=A.trim().split(/\r\n|\n/).filter(e=>e).map(e=>{var N,R;const[a,s,n,l,F,r,i,p,d,f,g,C,k,y,B]=e.split(","),I=Number(a),b=Number(n),D=l!=null&&l.length?l.split(":").map(o=>Number(o)):[],M=F.length?F.split(":").map(o=>Number(o)):[],m=r!=null&&r.length?(N=r==null?void 0:r.split(":"))==null?void 0:N.map(o=>Number(o)):[],h=i!=null&&i.length?(R=i==null?void 0:i.split(":"))==null?void 0:R.map(o=>Number(o)):[],c=p==="True",w=d==="True",E=Number(f),v=Number(g),x=Number(C),V=k==="1",H=Number(y);return{ID:I,Name:s,UnlockGroup:b,Requires:D,BlockedBy:M,RequiredProcesses:m,IngredientProviders:h,isMain:c,isStarterOrSide:w,DishType:E,CustomerMultiplier:v,DishValue:x,IsUnlockable:V,MinimumFranchiseTier:H,IsSpecificFranchiseTier:B==="1"}});function Q(e,a=!0){const s=a&&e.some(n=>n.Name==="Community");return T.filter(n=>{if(e.some(l=>l.ID===n.ID)||n.BlockedBy.some(l=>e.some(F=>F.ID===l))||n.Requires.some(l=>!e.some(F=>F.ID===l))||!n.IsUnlockable)return!1;if(n.IsSpecificFranchiseTier){if(n.MinimumFranchiseTier!==0)return!1}else if(n.MinimumFranchiseTier>0)return!1;if(n.isStarterOrSide)if(e.some(l=>l.isMain)){if(e.length&&e[0].DishType===t.Dessert)debugger}else return!1;return!(!s&&n.DishType===t.Base)}).sort((n,l)=>n.ID-l.ID)}const j=[{ID:447437163,Name:"Country",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:t.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1},{ID:2002876295,Name:"City",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:t.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1},{ID:-1864906012,Name:"Alpine",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:t.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1},T.filter(e=>e.Name==="Community")[0],T.filter(e=>e.Name==="Couples")[0],{ID:1958825350,Name:"Turbo",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:t.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1},T.filter(e=>e.Name==="Christmas Rush")[0],{ID:507410699,Name:"January",UnlockGroup:u.Special,Requires:[],BlockedBy:[],RequiredProcesses:[],IngredientProviders:[],isMain:!1,isStarterOrSide:!1,DishType:t.Null,CustomerMultiplier:0,DishValue:0,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1}],J=[...j].sort((e,a)=>e.Name<a.Name?-1:1),K=["Breakfast","Burgers","Hot Dogs","Fish","Pies","Salad","Stir Fry","Pizza","Turkey","Fajitas","Sundaes"].map(e=>T.filter(a=>a.Name===e)[0]),Y=G.trim().split(/\r\n|\n/).filter(e=>e).map(e=>{var m,h;const[a,s,n,l,F,r,i,p,d,f]=e.split(","),g=Number(a),C=Number(n),k=l!=null&&l.length?(m=l==null?void 0:l.split(":"))==null?void 0:m.map(c=>Number(c)):[],y=F!=null&&F.length?(h=F==null?void 0:F.split(":"))==null?void 0:h.map(c=>Number(c)):[],B=r==="True",I=i==="True",b=Number(p),D=Number(d),M=Number(f);return{ID:g,Name:s,UnlockGroup:C,Requires:[],BlockedBy:[],RequiredProcesses:k,IngredientProviders:y,isMain:B,isStarterOrSide:I,DishType:b,CustomerMultiplier:D,DishValue:M,IsUnlockable:!0,MinimumFranchiseTier:0,IsSpecificFranchiseTier:!1}}).sort((e,a)=>e.Name<a.Name?-1:1);class P{constructor(a,s){S(this,"fixedSeed");S(this,"instance");S(this,"random");typeof a=="string"&&(a=U(a)),this.fixedSeed=a,this.instance=s,this.random=new z(a+Math.imul(124192293,s))}useSubcontext(a){return new P(this.fixedSeed,124192293*a+this.instance)}}class z{constructor(a){S(this,"seed");const s=i=>Math.imul(1812433253,i)+1>>0,n=a>>0,l=s(n),F=s(l),r=s(F);this.seed=[n,l,F,r]}get value(){let a=this.seed.shift(),s=this.seed[2];return a^=a<<11,a^=a>>>8,s^=s>>>19,s=(s^a)>>0,this.seed.push(s),s}range(a,s){return(this.value>>>0)%(s-a)+a}get valueFloat(){return(this.value<<9>>>0)/4294967295}select(a){return a[this.range(0,a.length)]}}function U(e){const s=new TextEncoder().encode(e);let n=5381,l=s.length;for(;l--;)n=(n<<5)+n+s[l];return n>>0}function Z(e,a,s){return new P(s,e*1231231+a)}export{t as D,P as F,J as R,Y as S,T as U,j as a,K as b,z as c,Z as d,u as e,Q as g};
